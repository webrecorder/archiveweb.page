...
function*(e,t){if(void 0!==e){let i=0;for(const a of e)yield t(a,i++)}}(e.resources,(e=>N`<li>
    ...
    `}renderUploadStatus(){switch(this.status){case"done":return N`<p class="has-text-weight-bold has-text-primary">Upload Finished</p>`;case"failed":return N`<p class="has-text-weight-bold has-text-danger">Sorry, Upload Failed, or, the Browsertrix credentials may be incorrect.</p>;
        ...
        `;case"deleted":return N`<p class="has-text-weight-bold has-text-primary">Upload to Browsertrix Cloud has been deleted.</p>
