 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class se extends oe{}se.directiveName="unsafeSVG",se.resultType=2;const le=ae(se),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return R}});var de=__webpack_require__(9886),he=__webpack_require__(4841),pe=__webpack_require__.n(he);const fe="./w/api",ue=r(de.Z);function be(e){return[ue,e]}const me=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,ge="1.7.3";function ve(e){" "==e.key&&(e.preventDefault(),e.target.click())}class we extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    :host {
    ...
    `}render(){if(!this.svg)return P``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),P`<svg style="${ce(e)}"><g>${le(this.svg)}</g></svg>`}}customElements.define("fa-icon",we),customElements.define("wr-anim-logo",class extends we{constructor(){super(),this.svg=pe()}static get styles(){return o`
    #wrlogo #stop5687 {
    ...
    `}get mainLogo(){return pe()}renderNavBrand(){return P`
  ...
  `)}render(){return P`
            ...
            <label class="file-label">
              ...
              <span class="file-cta" @click="${this.onChooseNativeFile}">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${Pe()} aria-hidden="true"></fa-icon>
                </span>
    ...
    `}renderCollInfo(e){return P`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return P`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Ge extends X{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return be(Ge.compStyles)}static get compStyles(){return o`
    .columns {
      width: 100%;
    }
    .column {
  ...
  `}renderSummaryView(){const e=this.coll;return P`
    ...
    .embed-globe {
      ...
      border-style: solid;
      line-height: 0.5em;
    }`}render(){let{numValid:e,numInvalid:t,domain:i,certFingerprint:a,datapackageHash:r,publicKey:o,software:n}=this.collInfo.verify||{};e=e||0,t=t||0;const s=this.collInfo.sourceUrl,l=a?`https://search.censys.io/certificates/${a}`:"",c=Ve(this.ts).toLocaleString();return P`
    ...
    `}render(){if(!this.inited)return P``;const e=!!this.tabData.url,t=e&&this.showSidebar;if(!e&&this.tabData&&this.tabData.view){const e={title:this.tabLabels[this.tabData.view],replayTitle:!1};this.dispatchEvent(new CustomEvent("update-title",{bubbles:!0,composed:!0,detail:e}))}return this.collInfo&&!this.collInfo.coll?P`
      ...
      </nav>`}renderLocationBar(){if("replayonly"===this.embed||"replay-with-info"==this.embed)return"";const e=Ve(this.ts).toLocaleString(),t=!!this.tabData.url,i=t&&this.favIconUrl;return P`
  ...
  `}renderLists(){return P`
    ...
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?P`<fa-icon class="editIcon" .svg="${ji()}"></fa-icon>`:P``}
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${Te()(this.toDeletePage.size)}</b>)</p>`:P`
    ...
    ${Ge.compStyles}
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1))}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed;return P`
      <div class="columns">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            ...
            <button @click="${this.onShowImport}" class="button is-small" title="Import Archive...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${Pe()}"></fa-icon>
              </span>
            </button>
      ...
      `}renderIPFSSharing(){const e=this.coll;return P`
    <div class="column">
    ...
    </wr-rec-coll-info>`}render(){return P`
    ${super.render()}
    ${this.renderDeleteConfirm()}
    `}renderDeleteConfirm(){return this.deleteConfirm?P`
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      ${Ee.appStyles}
    `)}get mainLogo(){return va()}renderNavEnd(){return P`
    ...
    </a>`}renderNavBrand(){return P`
      <span id="home" class="logo-text has-text-weight-bold is-size-6 has-allcaps wide-only">
      <span class="" style="color: #8878c3">archive</span>
      <span class="has-text-link">web.page</span>
      <span class="is-sr-only">Home</span>
    </span>`}renderHomeIndex(){return P`
    ...
    ${super.render()}`}renderColl(){return P`
    <wr-rec-coll 
    .editable="${!0}"
    ...
    @show-start=${this.onShowStart}
    @show-import=${this.onShowImport}
    @about-show=${()=>this.showAbout=!0}></wr-rec-coll>`}renderCollList(e=""){return P`
    <div class="dropdown-row">
      <span>${e}&nbsp;</span>
      <div class="select is-small">
        <select @change="${this.onSelectColl}">
        ${this.colls&&this.colls.map((e=>P`
          <option value="${e.id}"
    ...
    </wr-modal>`}renderNewCollModal(){return P`
    ...
    </wr-modal`}renderImportModal(){return P`
    ...
    </wr-modal`}renderDownloadModal(){return P`
                ...
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${this.getDeployType()} v${ar}</div>
                    </div>
