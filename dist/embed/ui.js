 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class se extends oe{}se.directiveName="unsafeSVG",se.resultType=2;const le=ae(se),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return T}});var de=__webpack_require__(8426),he=__webpack_require__(9678),pe=__webpack_require__.n(he);const fe="./w/api",ue=r(de.Z);function be(e){return[ue,e]}const me=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,ge="1.7.11";function ve(e){" "==e.key&&(e.preventDefault(),e.target.click())}class we extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    :host {
  ...
  `}renderLists(){return U`
    ...
    ${this.errorMessage}
    `}onLoad(e){if(this.isCrossOrigin)return;const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get(this.mainElementName))return;const a=i.createElement("script");a.src=ea,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",ia)}();var aa=__webpack_require__(8200),ra=__webpack_require__.n(aa),oa=__webpack_require__(7589),na=__webpack_require__.n(oa),sa=__webpack_require__(8135),la=__webpack_require__.n(sa),ca=__webpack_require__(5732),da=__webpack_require__.n(ca),ha=__webpack_require__(8600),pa=__webpack_require__.n(ha),fa=__webpack_require__(252),ua=__webpack_require__.n(fa);class ba extends Kt{constructor(){super(),this._sizeUpdater=null,this.totalSize=0}static get properties(){return{...Kt.properties,totalSize:{type:Number},ipfsDaemonUrl:{type:String},ipfsMessage:{type:String}}}static get styles(){return be(ba.compStyles)}static get compStyles(){return o`
    .rec-button {
      display: flex;
      flex-direction: row;
      margin: 0 1px;
                ...
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${this.getDeployType()} v${fr}</div>
                    </div>
