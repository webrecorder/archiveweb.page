 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var b;u.finalized=!0,u.elementProperties=new Map,u.elementStyles=[],u.shadowRootOptions={mode:"open"},null==d||d({ReactiveElement:u}),(null!==(n=globalThis.reactiveElementVersions)&&void 0!==n?n:globalThis.reactiveElementVersions=[]).push("1.1.1");const m=globalThis.trustedTypes,g=m?m.createPolicy("lit-html",{createHTML:e=>e}):void 0,v=`lit$${(Math.random()+"").slice(9)}$`,w="?"+v,x=`<${w}>`,k=document,y=(e="")=>k.createComment(e),$=e=>null===e||"object"!=typeof e&&"function"!=typeof e,_=Array.isArray,S=e=>{var t;return _(e)||"function"==typeof(null===(t=e)||void 0===t?void 0:t[Symbol.iterator])},z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,C=/-->/g,A=/>/g,I=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,D=/'/g,L=/"/g,E=/^(?:script|style|textarea)$/i,P=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),U=P(1),T=(P(2),Symbol.for("lit-noChange")),R=Symbol.for("lit-nothing"),M=new WeakMap,q=k.createTreeWalker(k,129,null,!1),N=(e,t)=>{const i=e.length-1,a=[];let r,o=2===t?"<svg>":"",s=z;for(let t=0;t<i;t++){const i=e[t];let n,l,c=-1,d=0;for(;d<i.length&&(s.lastIndex=d,l=s.exec(i),null!==l);)d=s.lastIndex,s===z?"!--"===l[1]?s=C:void 0!==l[1]?s=A:void 0!==l[2]?(E.test(l[2])&&(r=RegExp("</"+l[2],"g")),s=I):void 0!==l[3]&&(s=I):s===I?">"===l[0]?(s=null!=r?r:z,c=-1):void 0===l[1]?c=-2:(c=s.lastIndex-l[2].length,n=l[1],s=void 0===l[3]?I:'"'===l[3]?L:D):s===L||s===D?s=I:s===C||s===A?s=z:(s=I,r=void 0);const h=s===I&&e[t+1].startsWith("/>")?" ":"";o+=s===z?i+x:c>=0?(a.push(n),i.slice(0,c)+"$lit$"+i.slice(c)+v+h):i+v+(-2===c?(a.push(void 0),t):h)}const n=o+(e[i]||"<?>")+(2===t?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==g?g.createHTML(n):n,a]};class B{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let r=0,o=0;const s=e.length-1,n=this.parts,[l,c]=N(e,t);if(this.el=B.createElement(l,i),q.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(a=q.nextNode())&&n.length<s;){if(1===a.nodeType){if(a.hasAttributes()){const e=[];for(const t of a.getAttributeNames())if(t.endsWith("$lit$")||t.startsWith(v)){const i=c[o++];if(e.push(t),void 0!==i){const e=a.getAttribute(i.toLowerCase()+"$lit$").split(v),t=/([.?@])?(.*)/.exec(i);n.push({type:1,index:r,name:t[2],strings:e,ctor:"."===t[1]?W:"?"===t[1]?V:"@"===t[1]?K:F})}else n.push({type:6,index:r})}for(const t of e)a.removeAttribute(t)}if(E.test(a.tagName)){const e=a.textContent.split(v),t=e.length-1;if(t>0){a.textContent=m?m.emptyScript:"";for(let i=0;i<t;i++)a.append(e[i],y()),q.nextNode(),n.push({type:2,index:++r});a.append(e[t],y())}}}else if(8===a.nodeType)if(a.data===w)n.push({type:2,index:r});else{let e=-1;for(;-1!==(e=a.data.indexOf(v,e+1));)n.push({type:7,index:r}),e+=v.length-1}r++}}static createElement(e,t){const i=k.createElement("template");return i.innerHTML=e,i}}function O(e,t,i=e,a){var r,o,s,n;if(t===T)return t;let l=void 0!==a?null===(r=i._$Cl)||void 0===r?void 0:r[a]:i._$Cu;const c=$(t)?void 0:t._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===c?l=void 0:(l=new c(e),l._$AT(e,i,a)),void 0!==a?(null!==(s=(n=i)._$Cl)&&void 0!==s?s:n._$Cl=[])[a]=l:i._$Cu=l),void 0!==l&&(t=O(e,l._$AS(e,t.values),l,a)),t}class H{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:i},parts:a}=this._$AD,r=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:k).importNode(i,!0);q.currentNode=r;let o=q.nextNode(),s=0,n=0,l=a[0];for(;void 0!==l;){if(s===l.index){let t;2===l.type?t=new j(o,o.nextSibling,this,e):1===l.type?t=new l.ctor(o,l.name,l.strings,this,e):6===l.type&&(t=new Z(o,this,e)),this.v.push(t),l=a[++n]}s!==(null==l?void 0:l.index)&&(o=q.nextNode(),s++)}return r}m(e){let t=0;for(const i of this.v)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class j{constructor(e,t,i,a){var r;this.type=2,this._$AH=R,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cg=null===(r=null==a?void 0:a.isConnected)||void 0===r||r}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=O(this,e,t),$(e)?e===R||null==e||""===e?(this._$AH!==R&&this._$AR(),this._$AH=R):e!==this._$AH&&e!==T&&this.$(e):void 0!==e._$litType$?this.T(e):void 0!==e.nodeType?this.S(e):S(e)?this.A(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}S(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==R&&$(this._$AH)?this._$AA.nextSibling.data=e:this.S(k.createTextNode(e)),this._$AH=e}T(e){var t;const{values:i,_$litType$:a}=e,r="number"==typeof a?this._$AC(e):(void 0===a.el&&(a.el=B.createElement(a.h,this.options)),a);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===r)this._$AH.m(i);else{const e=new H(r,this),t=e.p(this.options);e.m(i),this.S(t),this._$AH=e}}_$AC(e){let t=M.get(e.strings);return void 0===t&&M.set(e.strings,t=new B(e)),t}A(e){_(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const r of e)a===t.length?t.push(i=new j(this.M(y()),this.M(y()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$Cg=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class F{constructor(e,t,i,a,r){this.type=1,this._$AH=R,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=R}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,a){const r=this.strings;let o=!1;if(void 0===r)e=O(this,e,t,0),o=!$(e)||e!==this._$AH&&e!==T,o&&(this._$AH=e);else{const a=e;let s,n;for(e=r[0],s=0;s<r.length-1;s++)n=O(this,a[i+s],t,s),n===T&&(n=this._$AH[s]),o||(o=!$(n)||n!==this._$AH[s]),n===R?e=R:e!==R&&(e+=(null!=n?n:"")+r[s+1]),this._$AH[s]=n}o&&!a&&this.k(e)}k(e){e===R?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class W extends F{constructor(){super(...arguments),this.type=3}k(e){this.element[this.name]=e===R?void 0:e}}const G=m?m.emptyScript:"";class V extends F{constructor(){super(...arguments),this.type=4}k(e){e&&e!==R?this.element.setAttribute(this.name,G):this.element.removeAttribute(this.name)}}class K extends F{constructor(e,t,i,a,r){super(e,t,i,a,r),this.type=5}_$AI(e,t=this){var i;if((e=null!==(i=O(this,e,t,0))&&void 0!==i?i:R)===T)return;const a=this._$AH,r=e===R&&a!==R||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,o=e!==R&&(a===R||r);r&&this.element.removeEventListener(this.name,this,a),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==i?i:this.element,e):this._$AH.handleEvent(e)}}class Z{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){O(this,e)}}const Y=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var J,Q;null==Y||Y(B,j),(null!==(b=globalThis.litHtmlVersions)&&void 0!==b?b:globalThis.litHtmlVersions=[]).push("2.1.1");class X extends u{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=((e,t,i)=>{var a,r;const o=null!==(a=null==i?void 0:i.renderBefore)&&void 0!==a?a:t;let s=o._$litPart$;if(void 0===s){const e=null!==(r=null==i?void 0:i.renderBefore)&&void 0!==r?r:null;o._$litPart$=s=new j(t.insertBefore(y(),e),e,void 0,null!=i?i:{})}return s._$AI(e),s})(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this._$Dt)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._$Dt)||void 0===e||e.setConnected(!1)}render(){return T}}X.finalized=!0,X._$litElement$=!0,null===(J=globalThis.litElementHydrateSupport)||void 0===J||J.call(globalThis,{LitElement:X});const ee=globalThis.litElementPolyfillSupport;null==ee||ee({LitElement:X});(null!==(Q=globalThis.litElementVersions)&&void 0!==Q?Q:globalThis.litElementVersions=[]).push("3.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ne extends oe{}ne.directiveName="unsafeSVG",ne.resultType=2;const le=ae(ne),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return T}});var de=__webpack_require__(8426),he=__webpack_require__(9678),pe=__webpack_require__.n(he);const fe="./w/api",ue=r(de.Z);function be(e){return[ue,e]}const me=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,ge="1.7.11";function ve(e){" "==e.key&&(e.preventDefault(),e.target.click())}class we extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    :host {
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        ...
        <button @click=${()=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?He():Be()}></span>
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?se(Ei(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return U`
    ...
    `}renderContent(){switch(this.state){case"googledrive":return U`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return U`
      ...
      ${Fi.sidebarStyles(r`:host(.sidebar)`)}
    ...
    ${this.errorMessage}
    `}onLoad(e){if(this.isCrossOrigin)return;const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get(this.mainElementName))return;const a=i.createElement("script");a.src=ea,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",ia)}();var aa=__webpack_require__(8200),ra=__webpack_require__.n(aa),oa=__webpack_require__(7589),sa=__webpack_require__.n(oa),na=__webpack_require__(8135),la=__webpack_require__.n(na),ca=__webpack_require__(5732),da=__webpack_require__.n(ca),ha=__webpack_require__(8600),pa=__webpack_require__.n(ha),fa=__webpack_require__(252),ua=__webpack_require__.n(fa);class ba extends Kt{constructor(){super(),this._sizeUpdater=null,this.totalSize=0}static get properties(){return{...Kt.properties,totalSize:{type:Number},ipfsDaemonUrl:{type:String},ipfsMessage:{type:String}}}static get styles(){return be(ba.compStyles)}static get compStyles(){return o`
    .rec-button {
      display: flex;
      flex-direction: row;
      margin: 0 1px;
    ...
    `}updated(e){e.has("embed")&&this.embed&&!this._sizeUpdater&&(this._sizeUpdater=this.runSizeUpdater()),super.updated(e)}async runSizeUpdater(){try{for(;this.embed;){if(this.coll){const e=await fetch(`./w/api/c/${this.coll}`),t=await e.json();this.totalSize=t.size||0}await new Promise((e=>setTimeout(e,3e3)))}}finally{this._sizeUpdater=null}}renderExtraToolbar(e=!1){return this.embed?e?U`
        <a href="${fe}/c/${this.coll}/dl?format=wacz&pages=all" role="button" class="dropdown-item" @keyup="${ve}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${da()}"></fa-icon>
          </span>
          <span>Download Archive</span>
        </a>
        <hr class="dropdown-divider">
        ...
        <span class="rec-button" title="Recording">
          ...
          <span class="size-label">${pa()(this.totalSize)}</span>
        </span>
        `:e?"":U`
    <a href="#" role="button"
    ...
    <div class="info-bg">
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){if(this.embed)return;const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}customElements.define("wr-rec-coll",ba);var ma=__webpack_require__(1734),ga=__webpack_require__.n(ma),va=__webpack_require__(4771),wa=__webpack_require__.n(va),xa=__webpack_require__(2222),ka=__webpack_require__.n(xa),ya=__webpack_require__(5361),$a=__webpack_require__.n(ya),_a=__webpack_require__(7848),Sa=__webpack_require__.n(_a);class za extends Ge{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgress=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgress:{type:Number},ipfsDaemonUrl:{type:String},ipfsMessage:{type:String}}}static get styles(){return be(za.compStyles)}static get compStyles(){return o`
    :host {
      overflow: visible;
    }
    ...
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1))}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed;return U`
      <div class="columns">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <a href="${fe}/c/${this.coll.id}/dl?format=wacz&pages=all" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${da()}"></fa-icon>
              </span>
            </a>
        ...
        ${e.loadUrl}
        <a @click="${t=>this.onCopy(t,e.loadUrl)}" class="copy"><fa-icon .svg="${ga()}"/></a>
        </div>`:""}
      </div>
              ...
              <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
                <div class="dropdown-content">
                  ...
                  <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                    <span class="icon is-small">
                      <fa-icon size="0.8em" .svg="${ka()}"></fa-icon>
                    </span>
                    Copy IPFS URL
                  </a>
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${pa()(this.deleteConfirm.size)}</b>)</p>
    ...
    </wr-modal>`:null}onIpfsShare(e){e.detail.pending?this.ipfsSharePending++:this.ipfsSharePending--}onDeleteColl(e){if(e.preventDefault(),e.stopPropagation(),!this.sortedColls)return;const t=Number(e.currentTarget.getAttribute("data-coll-index"));this.deleteConfirm=this.sortedColls[t]}async doDelete(){if(!this.deleteConfirm)return;this._deleting[this.deleteConfirm.sourceUrl]=!0,this.requestUpdate();const e=this.renderRoot.querySelector(`wr-rec-coll-info[data-coll="${this.deleteConfirm.id}"]`);e&&await e.doDelete(),this.deleteConfirm=null}renderEmpty(){return U`No Archives. Click "Create New" above to create a new archive and start recording!`}});var Ca=__webpack_require__(6672),Aa=__webpack_require__.n(Ca);ia.setDefaultReplayFile("replay.html");class Ia extends ia{constructor(){super(),this.replaybase="./replay/",this.replayfile="record.html",this.mainElementName="archive-web-page-app",this.appName="Embedded ArchiveWeb.page",this.embed="default",this.noWebWorker=!0,this.proxyPrefix="https://wabac-cors-proxy.webrecorder.workers.dev/proxy/",this.archivePrefix="";const e=new URL(window.location);e.hash="",this.logo=Aa(),this.customConfig={prefix:this.proxyPrefix,isLive:!1,archivePrefix:this.archivePrefix,baseUrl:e.href,baseUrlHashReplay:!1,recording:!0,noPostToGet:!0},this.downloaded=null,this.source="proxy://"+this.proxyPrefix}static get properties(){return{...ia.properties,archivePrefix:{type:String},proxyPrefix:{type:String}}}updated(e){e.has("proxyPrefix")&&(this.customConfig.proxyPrefix=this.proxyPrefix),e.has("archivePrefix")&&(this.customConfig.archivePrefix=this.archivePrefix,this.customConfig.isLive=!this.archivePrefix),super.updated(e)}handleMessage(e){this.downloaded&&"object"==typeof e.data&&"downloadedBlob"===e.data.msg_type&&(this.downloaded(e.data.url),this.downloaded=null)}doDownload(){const e=this.renderRoot.querySelector("iframe");if(!e)return;const t=new Promise((e=>{this.downloaded=e}));return e.contentWindow.postMessage({msg_type:"downloadToBlob"}),t}}!async function(){customElements.define("record-web-page",Ia)}();const Da="https://w3s.link/";function La(e){const{hostname:t,protocol:i,pathname:a}=new URL(e),r=i.slice(0,-1);if(!t){const[e,...t]=a.slice(2).split("/");return{type:r,cid:e,path:"/"+t.join("/")}}return{type:r,cid:t,path:a}}async function Ea(e){return qa(e)?e:Na(e)?Ta(e):e}async function Pa(e){return new Response(e).blob()}async function*Ua(e){const t=await e.getReader();try{for(;;){const{done:e,value:i}=await t.read();if(e)return;yield i}}finally{t.releaseLock()}}function Ta(e){let t=e;t.next||(t=e[Symbol.asyncIterator]());const i=new TextEncoder;return new ReadableStream({async pull(e){const{value:a,done:r}=await t.next();if(r)await e.close();else{let t=a;"string"==typeof t&&(t=i.encode(t)),await e.enqueue(t)}}})}async function Ra(e){if(!e.ok){const t=await e.text(),i=e.status;throw new Error(`HTTP Error ${i}: ${t}`)}}async function Ma({url:e,file:t,fileName:i="",parameterName:a="file",fetch:r=globalThis.fetch,signal:o}){const s=new FormData,n=new Headers;Ba(e,n);const l=await async function(e){if(qa(e))return await Pa(e);if(Na(e)){const t=Ta(e);return await Pa(t)}return e instanceof Blob?e:new Blob([e])}(t);i?s.append(a,l,i):s.append(a,l);const c=await r(e,{method:"POST",body:s,headers:n,signal:o});return await Ra(c),c}function qa(e){return"function"==typeof e.getReader}function Na(e){return e[Symbol.asyncIterator]}function Ba(e,t){if(e.password)if(e.username){const i=`Basic ${btoa(`${unescape(e.username)}:${unescape(e.password)}`)}`;t.append("Authorization",unescape(i)),e.username="",e.password=""}else{const i=`Bearer ${e.password}`;t.append("Authorization",unescape(i)),e.password=""}}async function Oa({url:e,fetch:t=globalThis.fetch,signal:i}){const a=await t(e,{method:"HEAD",signal:i});await Ra(a);const r=a.headers.get("x-ipfs-datasize")||a.headers.get("Content-Length");return parseInt(r,10)}async function*Ha({url:e,start:t,end:i,format:a,signal:r,fetch:o=globalThis.fetch}){const s=new Headers;Number.isInteger(t)&&(Number.isInteger(i)?s.set("Range",`bytes=${t}-${i}`):s.set("Range",`bytes=${t}-`));const n=new URL(e);a&&(s.set("Accept",`application/vnd.ipld.${a}`),s.set("cache-control","no-cache"));const l=await o(n.href,{headers:s,signal:r});await Ra(l),yield*Ua(l.body)}async function*ja({url:e,start:t,end:i,format:a,signal:r,gatewayURL:o=Fa()}){const s=function(e,t=Fa()){const{cid:i,path:a,type:r}=La(e);return new URL(`/${r}/${i}${a}`,t)}(e,o);yield*Ha({url:s,start:t,end:i,format:a,signal:r})}function Fa(){if(!globalThis.location)return Da;const{pathname:e,hostname:t,protocol:i}=globalThis.location;if(e.startsWith("/ipfs/")||e.startsWith("/ipns/"))return`${i}//${t}/`;const[a,...r]=t.split(".");return 59===a.length&&r.length>=2?`${i}//${r.join(".")}/`:Da}let Wa=!1;const Ga=[5001,45001,45002,45003,45004,45005],Va="https://api.web3.storage/",Ka="https://api.estuary.tech/",Za="http://localhost:5001/",Ya="agregore",Ja="daemon",Qa="web3.storage",Xa="estuary",er="readonly",tr=[Ya,Ja,Qa,Xa,er];class ir{get type(){return"invalid"}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){throw new Error("Not Implemented")}async getSize(e,t=null){throw new Error("Not Implemented")}async uploadCAR(e,t=null){throw new Error("Not Implemented")}async uploadFile(e,t,i=null){throw new Error("Not Implemented")}async clear(e,t=null){throw new Error("Not Implemented")}}async function ar({daemonURL:e,web3StorageToken:t,web3StorageURL:i=Va,estuaryToken:a,estuaryURL:r=Ka,publicGatewayURL:o=Fa(),readonly:s=!0,timeout:n=1e3,fetch:l=globalThis.fetch}={}){const c=[],d=[];if(d.push(async function(e=globalThis.fetch){try{return await e("ipfs://localhost/"),!0}catch(e){return Wa&&console.warn("Unable to detect Agregore",e),!1}}(l).then((e=>e&&c.push({type:Ya,fetch:l})))),d.push(async function(){const e=Ga.map((e=>`http://localhost:${e}`));try{const i=await Promise.any(e.map((e=>pr(e).then((t=>{if(t)return e;throw new Error("Not found")})))));return!!i&&(hr&&!dr&&(t=i,dr=!0,globalThis.chrome.webRequest.onBeforeSendHeaders.addListener((e=>{const{requestHeaders:i}=e;for(const e of i)if("origin"===e.name.toLowerCase())return e.value=t,{requestHeaders:i};return e.requestHeaders.push({name:"Origin",value:t}),{requestHeaders:i}}),{urls:[t+"/*"]},["blocking","requestHeaders","extraHeaders"])),i)}catch{return!1}var t}().then((e=>e&&c.push({type:Ja,url:e,fetch:l})))),e&&d.push(pr(e,n,l).then((t=>t&&c.push({type:Ja,url:e,fetch:l})))),a){const e=r,t=a;c.push({type:Xa,url:e,authorization:t,fetch:l,publicGatewayURL:o})}if(t){const e=i,a=t;c.push({type:Qa,url:e,authorization:a,fetch:l,publicGatewayURL:o})}return s&&o&&c.push({type:er,fetch:l,publicGatewayURL:o}),await Promise.allSettled(d),c}async function rr({chooseOrder:e=tr,...t}={}){const i=function(e,t=tr){const i=e.filter((({type:e})=>t.includes(e))).sort((({type:e},{type:i})=>t.indexOf(e)-t.indexOf(i)))[0];if(!i)throw new Error("Unable to find valid type");return i}(await ar(t),e);return async function(e){const{type:t}=e;let i=null;if(t===Ya)i=new nr(e.fetch||globalThis.fetch);else if(t===Ja)i=new cr(e.url);else if(t===Qa)i=new lr(e.authorization,e.url,e.publicGatewayURL);else if(t===Xa)i=new sr(e.authorization,e.url,e.publicGatewayURL);else{if(t!==er)throw new TypeError(`Unknown API type: ${t}.`);i=new or(e.publicGatewayURL)}return i}(i)}class or extends ir{constructor(e=Fa()){super(),this.gatewayURL=e}get type(){return er}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){yield*ja({url:e,start:t,end:i,format:r,gatewayURL:this.gatewayURL,signal:a})}async getSize(e,t=null){const{cid:i,path:a,type:r}=La(e);return Oa({url:new URL(`/${r}/${i}${a}`,this.gatewayURL),signal:t})}}class sr extends or{constructor(e,t=Ka,i=Fa()){super(i),this.authorization=e,this.url=t}get type(){return Xa}async uploadCAR(e,t=null){throw new Error("Not Implemented")}async uploadFile(e,t,i=null){const a=new URL("/content/add",this.url);a.password=this.authorization;const r=await Ma({url:a,file:e,fileName:t,parameterName:"data",signal:i}),{cid:o}=await r.json();return`ipfs://${o}/`}}class nr extends ir{constructor(e=globalThis.fetch){super(),this.fetch=e}get type(){return Ya}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){const{fetch:o}=this;yield*Ha({url:e,start:t,end:i,format:r,fetch:o,signal:a})}async getSize(e,t=null){const{fetch:i}=this;return Oa({url:e,fetch:i,signal:t})}async uploadCAR(e,t=null){const i=await Ea(e),{fetch:a}=this,r=await a("ipfs://localhost",{method:"POST",headers:{"Content-Type":"application/vnd.ipld.car"},signal:t,body:i});await Ra(r);return(await r.text()).split("\n")}async uploadFile(e,t=null){const i=await Ea(e),{fetch:a}=this,r=await a("ipfs://localhost",{method:"POST",headers:{"Content-Type":"application/octet-stream"},signal:t,body:i});return await Ra(r),r.headers.get("Location")}}class lr extends or{constructor(e,t=Va,i=Fa()){super(i),this.authorization=e,this.url=t}get type(){return Qa}async uploadCAR(e,t=null){const i=new URL("/car",this.url);i.password=this.authorization;const a=await async function({url:e,fileIterator:t,signal:i}){const a=new Headers;a.set("Content-Type","application/octet-stream"),Ba(e,a);const r=await Ea(t),o=await fetch(e,{method:"POST",signal:i,body:r,headers:a,duplex:"half"});return await Ra(o),o}({url:i,fileIterator:e,signal:t});return(await a.text()).split("\n").filter((e=>e)).map((e=>{const{cid:t}=JSON.parse(e);return`ipfs://${t}/`}))}async uploadFile(e,{fileName:t="",signal:i=null}={}){const a=new URL("/upload",this.url);a.password=this.authorization;const r=await Ma({url:a,file:e,fileName:t,signal:i}),{cid:o}=await r.json();return`ipfs://${o}/`}}class cr extends ir{constructor(e=Za){super(),this.url=e}get type(){return Ja}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){const{cid:o,path:s,type:n}=La(e),l=new URL(`/api/v0/cat?arg=/${n}/${o}${s}`,this.url);if(t&&l.searchParams.set("offset",t),i&&l.searchParams.set("length",i-(t||0)+1),r)throw new Error("Format is unsupported on Kubo Daemons for now");const c=await fetch(l,{method:"POST",signal:a});await Ra(c),yield*Ua(c.body)}async getSize(e,t=null){try{const{cid:i,path:a,type:r}=La(e),o=`/api/v0/file/ls?arg=/${r}/${i}${a}&size=true`,s=new URL(o,this.url),n=await fetch(s,{method:"POST",signal:t});await Ra(n);const{Objects:l}=await n.json(),[{Size:c}]=Object.values(l);return c}catch(i){return Wa&&console.warn(i),this._getSizeWithDag(e,t)}}async _getSizeWithDag(e,t=null){const{cid:i,path:a,type:r}=La(e),o=new URL(`/api/v0/dag/stat?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Ra(s);const{Size:n}=await s.json();return parseInt(n,10)}async _pin(e,t=null){const{cid:i,path:a,type:r}=La(e),o=new URL(`/api/v0/pin/add?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Ra(s)}async _unpin(e,t=null){const{cid:i,path:a,type:r}=La(e),o=new URL(`/api/v0/pin/rm?arg=/${r}/${i}${a}`,this.url),s=await fetch(o,{method:"POST",signal:t});await Ra(s)}async clear(e,t=null){return this._unpin(e,t)}async uploadCAR(e,t=null){const i=new URL("/api/v0/dag/import?allow-big-block=true&pin-roots=true",this.url),a=await Ma({url:i,file:e,signal:t});return(await a.text()).split("\n").filter((e=>e)).map((e=>{const{Root:t}=JSON.parse(e);return`ipfs://${t.Cid["/"]}/`}))}async uploadFile(e,t="",i=null){const a=new URL("/api/v0/add?pin=true&cid-version=1&inline=false&raw-leaves=true",this.url),r=e.name&&e instanceof Blob;(t||r)&&a.searchParams.set("wrap-with-directory","true");const o=await Ma({url:a,file:e,fileName:t,signal:i}),s=await o.text(),[n]=s.split("\n"),{Hash:l}=JSON.parse(n),c=`ipfs://${l}/`;return await this._pin(c,i),c}}let dr=!1;const hr=!!(globalThis&&globalThis.chrome&&globalThis.chrome.webRequest&&globalThis.chrome.webRequest.onBeforeSendHeaders&&globalThis.chrome.webRequest.onBeforeSendHeaders.addListener);async function pr(e=Za,t=1e3,i=globalThis.fetch){try{const a=new AbortController,{signal:r}=a;setTimeout((()=>a.abort()),t);const o=await i(new URL("/api/v0/version",e),{method:"POST",signal:r});return!!o.ok||405===o.status}catch(t){return Wa&&console.warn("Unable to detect Kubo Daemon",t,e),!1}}function fr(e,t){return self.chrome&&self.chrome.storage?new Promise((i=>{const a={};a[e]=t,self.chrome.storage.local.set(a,(()=>i()))})):self.localStorage?Promise.resolve(localStorage.setItem(e,t)):Promise.reject()}function ur(e){return self.chrome&&self.chrome.storage?new Promise((t=>{self.chrome.storage.local.get(e,(i=>{t(i[e])}))})):self.localStorage?Promise.resolve(localStorage.getItem(e)):Promise.reject()}const br="0.9.6";class mr extends Ee{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[],this.autorun=!1,ur("autorunBehaviors").then((e=>this.autorun="1"===e)),window.archivewebpage&&window.archivewebpage.setDownloadCallback((e=>this.onDownloadProgress(e)))}get appName(){return"ArchiveWeb.page"}static get properties(){return{...Ee.properties,showStartRecord:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String},recordUrl:{type:String},autorun:{type:Boolean},showNew:{type:String},showImport:{type:Boolean},isImportExisting:{type:Boolean},loadedCollId:{type:String},showDownloadProgress:{type:Boolean},download:{type:Object},ipfsDaemonUrl:{type:String}}}initRoute(){const e=new URLSearchParams(window.location.search);e.has("config")?(super.initRoute(),this.handleMessages()):(this.inited=!0,this.sourceUrl=e.get("source")||""),this.checkIPFS()}handleMessages(){window.addEventListener("message",(async e=>{if(this.embed&&this.loadedCollId&&"object"==typeof e.data&&"downloadToBlob"===e.data.msg_type){const t=await fetch(`./w/api/c/${this.loadedCollId}/dl?format=wacz&pages=all`),i=await t.blob();e.source.postMessage({msg_type:"downloadedBlob",coll:this.loadedCollId,url:URL.createObjectURL(i)})}}))}onStartLoad(e){this.embed||(this.showImport=!1,this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail,this.isImportExisting&&this.selCollId&&(this.loadInfo.importCollId=this.selCollId))}onCollLoaded(e){if(this.loadInfo&&this.loadInfo.importCollId&&navigator.serviceWorker.controller){const e={msg_type:"reload",full:!0,name:this.loadInfo.importCollId};navigator.serviceWorker.controller.postMessage(e)}this.embed&&(this.loadedCollId=e.detail.collInfo&&e.detail.collInfo.coll),super.onCollLoaded(e),!e.detail.alreadyLoaded&&e.detail.sourceUrl&&e.detail.sourceUrl!==this.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl)}getLoadInfo(e){if(this.disableCSP(),this.loadInfo)return this.loadInfo;return{customColl:e.startsWith("local://")?e.slice("local://".length):e}}async disableCSP(){if(this.embed||!self.chrome||!self.chrome.runtime)return;const e=navigator.userAgent.match(/Chrome\/([\d]+)/);if(!e||Number(e[1])<94)return;console.log("attempt to disable CSP to ensure replay works");let t=await new Promise((e=>{chrome.tabs.getCurrent((t=>e(t.id)))}));chrome.runtime.sendMessage({msg:"disableCSP",tabId:t})}static get styles(){return be(mr.appStyles)}static get appStyles(){return be(o`
      :host {
        font-size: initial;
        overflow: auto;
      }
      ...
      ${Ee.appStyles}
    `)}get mainLogo(){return Aa()}renderNavEnd(){return U`
    <a href="https://archiveweb.page/guide" target="_blank" class="navbar-item is-size-6">
    <fa-icon .svg="${ra()}" aria-hidden="true"></fa-icon><span>&nbsp;User Guide</span>
    ...
    <wr-modal .noBgClose=${!0} style="--modal-width: 740px" @modal-closed="${()=>this.showDownloadProgress=!1}" title="Download Progress">
      <div class="dl-progress">
        ...
        <div>Size Downloaded: <b>${pa()(this.download.currSize)}</b></div>
            ...
            <section class="modal-card-body">
              <div class="container">
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      <fa-icon class="logo" size="48px" .svg="${Aa()}"></fa-icon>
                      <div style="font-size: smaller; margin-bottom: 1em">${this.getDeployType()} v${br}</div>
                    </div>
