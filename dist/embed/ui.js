...
class ue extends he{}ue.directiveName="unsafeSVG",ue.resultType=2;const fe=ce(ue),be="important",me=ce(class extends de{constructor(e){var t;if(super(e),e.type!==ne||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];if(null!=a){this.ht.add(e);const t="string"==typeof a&&a.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?a.slice(0,-11):a,t?be:""):i[e]=a}}return M}});var ge=__webpack_require__(4536),ve=__webpack_require__(7948),we=__webpack_require__.n(ve);const xe="./w/api",ke=o(ge.A);function ye(e){return[ke,e]}const $e=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,Se="1.8.17";function _e(e){" "==e.key&&(e.preventDefault(),e.target.click())}class ze extends oe{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return s`
    ...
    `}render(){if(!this.svg)return N``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),N`<svg style="${me(e)}">
      <g>${fe(this.svg)}</g>
    </svg>`}}customElements.define("fa-icon",ze),customElements.define("wr-anim-logo",class extends ze{constructor(){super(),this.svg=we()}static get styles(){return s`
      #wrlogo #stop5687 {
    ...
    `}}),customElements.define("wr-modal",class extends oe{constructor(){super(),this.title="",this.bgClass="",this.noBgClose=!1}static get properties(){return{title:{type:String},bgClass:{type:String},noBgClose:{type:Boolean}}}static get styles(){return ye(s`
      .modal-background {
    ...
    `)}render(){return N` <div class="modal is-active">
      <div
    ...
    `}get mainLogo(){return we()}renderNavBrand(){return N` <span
      id="home"
      ...
      <nav class="navbar has-background-info" aria-label="main">
              ...
              `:N`
                ...
                ${this.collTitle?N`
                      ...
                      <span class="no-wrap is-size-6"
                        >&nbsp;&nbsp;/&nbsp;
                        ${this.pageReplay?N`<i>${this.pageTitle}</i>`:this.pageTitle}
                      </span>
                    `:""}
              `}
          <a
        ...
        ${this.sourceUrl?N``:N` <div
            ...
            >
              ...
              ${this.embed?N``:N` <div class="navbar-end">${this.renderNavEnd()}</div>`}
            </div>`}
      </nav>
      <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return N` <a href="/docs" target="_blank" class="navbar-item is-size-6">
    ...
    ></wr-coll>`}renderHomeIndex(){return N` <wr-coll-index>
      ${$e?"":N`
      ...
      ></wr-chooser>
    </wr-coll-index>`}render(){return this.inited?this.embed&&this.swErrorMsg?this.swErrorMsg:N`
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${$e?"App":""} v${Se}</div>
                    </div>
    ...
    `}renderHeader(){return N`<h2 class="panel-heading panel-color">
      <span>${this.headerName}</span>
    </h2>`}renderSearchHeader(){return""}render(){const e=this.childElementCount>0;return N`
      ...
      <section class="section no-top-padding">
        ...
        <button @click=${()=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?Ze():Ve()}></span>
        ...
        <div class="panel">
          ...
          ${this.colls.length?N`
                ...
                <div class="coll-list">
                  ${this.sortedColls&&this.sortedColls.map(((e,t)=>N`
                      <div class="coll-block panel-block">
                        ${this.renderCollInfo(e)}
                        ${this._deleting[e.sourceUrl]?N` <span
              ...
              `:N`
                <div class="panel-block extra-padding">
                  ${null===this.sortedColls?N`<i>Loading Archives...</i>`:this.renderEmpty()}
                </div>
              `}
        </div>
      </section>
    `}renderCollInfo(e){return N`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return N`<i
      >No Archives so far! Archives loaded in the section above will appear
      here.</i
    >`}}class Xe extends oe{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return ye(Xe.compStyles)}static get compStyles(){return s`
      .columns {
        width: 100%;
      }
      .column {
    ...
    `}renderSource(e){return N`
      <div class="column is-4">
        <span class="source-text"
          ><p class="minihead">Source</p>
          ${e.sourceUrl&&(e.sourceUrl.startsWith("http://")||e.sourceUrl.startsWith("https://"))?N` <a href="${e.sourceUrl}">${e.sourceUrl}&nbsp;</a>`:N` ${e.sourceUrl}&nbsp;`}
        </span>

        <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy">
          <fa-icon .svg="${We()}"></fa-icon>
        </a>
        ${e.sourceUrl&&e.sourceUrl.startsWith("googledrive://")?N` <p><i>(${e.filename})</i></p>`:""}
      </div>
      ...
      <div class="column is-2">
        ...
        ${je()(Number(e.totalSize||e.size||0))}
      </div>
    `}renderSummaryView(){const e=this.coll;return N` <div class="columns">
      ...
      ${this.renderSource(e)}
    </div>`}renderDetailed(){const e=this.coll;let{numValid:t,numInvalid:i,domain:a,certFingerprint:r,datapackageHash:o,publicKey:s,software:n}=this.coll.verify||{};t=t||0,i=i||0;const l=r?`https://crt.sh/?q=${r}`:"";return N` <div class="columns">
      <div class="column col-title is-4">
        <span class="subtitle has-text-weight-bold">
          ${e.name||e.title||e.filename}
        </span>
      </div>
      ${e.desc?N` <div class="column">
            <p class="minihead">Description</p>
            ${e.desc}
          </div>`:N``}
      ${e.description?N`<div class="column">
            <p class="minihead">Description</p>
            ${e.description}
          </div>`:N``}
      <!--  Only show filename if coll.resources doesn't exist -->
      ${e.resources?N`<div class="column">
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function*(e,t){if(void 0!==e){let i=0;for(const a of e)yield t(a,i++)}}(e.resources,(e=>N`<li>
                    <a href="${e.path}">${e.name+"\n"}</a>
                  </li>`))}
            </ol>
          </div>`:N`<div class="column">
    ...
    </div>`}render(){return this.detailed?this.renderDetailed():this.renderSummaryView()}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}onPurge(e){const t={reload:e};this.dispatchEvent(new CustomEvent("coll-purge",{detail:t}))}}function et(e){if(!e)return"";e.length<14&&(e+="00000101000000".substr(e.length));const t=e.substring(0,4)+"-"+e.substring(4,6)+"-"+e.substring(6,8)+"T"+e.substring(8,10)+":"+e.substring(10,12)+":"+e.substring(12,14)+"-00:00";return new Date(t)}function tt(e){let t=null;try{t=new Date(e.ts||e.date)}catch(e){}const i=t&&!isNaN(t)?it(t.toISOString()):"";return{date:t,timestamp:i}}function it(e){return e.replace(/[-:T]/g,"").slice(0,14)}function at(e,t,i){const a=new URLSearchParams;return a.set("view",e),a.set("url",t),a.set("ts",i),"#"+a.toString()}async function rt(e){try{new URL(e)}catch(t){e=new URL(e,document.baseURI).href}const t=await async function(e,t){const i=(new TextEncoder).encode(e),a=await crypto.subtle.digest(t,i),r=Array.from(new Uint8Array(a)).map((e=>e.toString(16).padStart(2,"0"))).join("");return r}(e,"SHA-256");return{url:e,coll:"id-"+t.slice(0,12)}}customElements.define("wr-coll-info",Xe),customElements.define("wr-coll-index",Qe);var ot=__webpack_require__(4e3),st=__webpack_require__.n(ot),nt=__webpack_require__(2427),lt=__webpack_require__.n(nt),ct=__webpack_require__(4562),dt=__webpack_require__.n(ct),ht=__webpack_require__(494),pt=__webpack_require__.n(ht),ut=__webpack_require__(886),ft=__webpack_require__.n(ut),bt=__webpack_require__(1940),mt=__webpack_require__.n(bt),gt=__webpack_require__(2724),vt=__webpack_require__.n(gt),wt=__webpack_require__(9397),xt=__webpack_require__.n(wt),kt=__webpack_require__(5017),yt=__webpack_require__.n(kt),$t=__webpack_require__(96),St=__webpack_require__.n($t),_t=__webpack_require__(5139),zt=__webpack_require__.n(_t),Ct=__webpack_require__(3898),It=__webpack_require__.n(Ct),At=__webpack_require__(8657),Ut=__webpack_require__.n(At),Pt=__webpack_require__(6736),Lt=__webpack_require__.n(Pt),Dt=__webpack_require__(1453),Et=__webpack_require__.n(Dt),Tt=__webpack_require__(3954),Rt=__webpack_require__.n(Tt),Ot=__webpack_require__(2785),qt=__webpack_require__.n(Ot);class Nt extends oe{constructor(){super(),this.collInfo=null,this.appLogo=null,this.ts=null,this.url=null,this.active=!1}get renderRoot(){return this}static get properties(){return{collInfo:{type:Object},appLogo:{type:Object},url:{type:String},ts:{type:String},active:{type:Boolean}}}static get embedStyles(){return s`
      rwp-embed-receipt {
        display: flex;
        flex-direction: column;
      }
    ...
    `}render(){let{numValid:e,numInvalid:t,domain:i,certFingerprint:a,datapackageHash:r,publicKey:o,software:s}=this.collInfo.verify||{};e=e||0,t=t||0;const n=this.collInfo.sourceUrl,l=a?`https://crt.sh/?q=${a}`:"",c=et(this.ts).toLocaleString();return N`
          ...
          <div class="dropdown-content embed-info-drop">
            ...
            <div class="embed-info-drop-statscontainer mb-4">
              ...
              ${i?N`
                  ...
                  `:s?N` <h3 class="mt-2">Created With:</h3>
                    <p>${s}</p>`:""}
              ${!i&&o?N` <h3 class="mt-2">Observer Public Key:</h3>
                    <p class="show-key">${o}</p>`:""}
              <h3 class="mt-2">Validation:</h3>
              ${e>0||t>0?N` <p>
                    ${e} hashes
                    verified${t?N`, ${t} invalid`:""}
                  </p>`:N` <p>Not Available</p> `}
              <h3 class="mt-2">Package Hash:</h3>
              <p class="show-hash">${r}</p>
              <h3 class="mt-2">Size</h3>
              <p>${je()(Number(this.collInfo.size||0))}</p>
            </div>
            ${n?N``:""}
            <p
    ...
    `}onEmbedDrop(e){e.stopPropagation(),this.active=!this.active}}customElements.define("rwp-embed-receipt",Nt);var Mt="undefined"!=typeof window?window:null,Ft=null===Mt,Bt=Ft?void 0:Mt.document,jt="horizontal",Ht=function(){return!1},Wt=Ft?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=Bt.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",Gt=function(e){return"string"==typeof e||e instanceof String},Vt=function(e){if(Gt(e)){var t=Bt.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},Kt=function(e,t,i){var a=e[t];return void 0!==a?a:i},Zt=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},Jt=function(e,t){var i=Bt.createElement("div");return i.className="gutter gutter-"+t,i},Yt=function(e,t,i){var a={};return Gt(t)?a[e]=t:a[e]=Wt+"("+t+"% - "+i+"px)",a},Qt=function(e,t){var i;return(i={})[e]=t+"px",i};const Xt=function(e,t){if(void 0===t&&(t={}),Ft)return{};var i,a,r,o,s,n,l=e;Array.from&&(l=Array.from(l));var c=Vt(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,p=Kt(t,"sizes")||l.map((function(){return 100/l.length})),u=Kt(t,"minSize",100),f=Array.isArray(u)?u:l.map((function(){return u})),b=Kt(t,"maxSize",1/0),m=Array.isArray(b)?b:l.map((function(){return b})),g=Kt(t,"expandToMin",!1),v=Kt(t,"gutterSize",10),w=Kt(t,"gutterAlign","center"),x=Kt(t,"snapOffset",30),k=Array.isArray(x)?x:l.map((function(){return x})),y=Kt(t,"dragInterval",1),$=Kt(t,"direction",jt),S=Kt(t,"cursor",$===jt?"col-resize":"row-resize"),_=Kt(t,"gutter",Jt),z=Kt(t,"elementStyle",Yt),C=Kt(t,"gutterStyle",Qt);function I(e,t,a,r){var o=z(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function A(){return n.map((function(e){return e.size}))}function U(e){return"touches"in e?e.touches[0][a]:e[a]}function P(e){var t=n[this.a],i=n[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,I(t.element,t.size,this._b,t.i),I(i.element,i.size,this._c,i.i)}function L(e){var i,a=n[this.a],r=n[this.b];this.dragging&&(i=U(e)-this.start+(this._b-this.dragOffset),y>1&&(i=Math.round(i/y)*y),i<=a.minSize+a.snapOffset+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+r.snapOffset+this._c)&&(i=this.size-(r.minSize+this._c)),i>=a.maxSize-a.snapOffset+this._b?i=a.maxSize+this._b:i<=this.size-(r.maxSize-r.snapOffset+this._c)&&(i=this.size-(r.maxSize+this._c)),P.call(this,i),Kt(t,"onDrag",Ht)(A()))}function D(){var e=n[this.a].element,t=n[this.b].element,a=e.getBoundingClientRect(),s=t.getBoundingClientRect();this.size=a[i]+s[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function E(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[s];return 0===i?null:i-=$===jt?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(f.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var s=t*r/100,n=Zt(v,0===o,o===e.length-1,w),l=f[o]+n;return s<l?(i+=l-s,a.push(0),l):(a.push(s-l),s)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var s=Math.min(i,a[r]-i);i-=s,o=e-s}return o/t*100}))}function T(){var e=this,i=n[e.a].element,a=n[e.b].element;e.dragging&&Kt(t,"onDragEnd",Ht)(A()),e.dragging=!1,Mt.removeEventListener("mouseup",e.stop),Mt.removeEventListener("touchend",e.stop),Mt.removeEventListener("touchcancel",e.stop),Mt.removeEventListener("mousemove",e.move),Mt.removeEventListener("touchmove",e.move),e.stop=null,e.move=null,i.removeEventListener("selectstart",Ht),i.removeEventListener("dragstart",Ht),a.removeEventListener("selectstart",Ht),a.removeEventListener("dragstart",Ht),i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",a.style.userSelect="",a.style.webkitUserSelect="",a.style.MozUserSelect="",a.style.pointerEvents="",e.gutter.style.cursor="",e.parent.style.cursor="",Bt.body.style.cursor=""}function R(e){if(!("button"in e)||0===e.button){var i=this,a=n[i.a].element,r=n[i.b].element;i.dragging||Kt(t,"onDragStart",Ht)(A()),e.preventDefault(),i.dragging=!0,i.move=L.bind(i),i.stop=T.bind(i),Mt.addEventListener("mouseup",i.stop),Mt.addEventListener("touchend",i.stop),Mt.addEventListener("touchcancel",i.stop),Mt.addEventListener("mousemove",i.move),Mt.addEventListener("touchmove",i.move),a.addEventListener("selectstart",Ht),a.addEventListener("dragstart",Ht),r.addEventListener("selectstart",Ht),r.addEventListener("dragstart",Ht),a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",r.style.userSelect="none",r.style.webkitUserSelect="none",r.style.MozUserSelect="none",r.style.pointerEvents="none",i.gutter.style.cursor=S,i.parent.style.cursor=S,Bt.body.style.cursor=S,D.call(i),i.dragOffset=U(e)-i.end}}$===jt?(i="width",a="clientX",r="left",o="right",s="clientWidth"):"vertical"===$&&(i="height",a="clientY",r="top",o="bottom",s="clientHeight"),p=E(p);var O=[];function q(e){var t=e.i===O.length,i=t?O[e.i-1]:O[e.i];D.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;P.call(i,a)}return n=l.map((function(e,t){var a,r={element:Vt(e),size:p[t],minSize:f[t],maxSize:m[t],snapOffset:k[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:$,parent:c})._b=Zt(v,t-1==0,!1,w),a._c=Zt(v,!1,t===l.length-1,w),"row-reverse"===h||"column-reverse"===h)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var s=_(t,$,r.element);!function(e,t,a){var r=C(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(s,v,t),a._a=R.bind(a),s.addEventListener("mousedown",a._a),s.addEventListener("touchstart",a._a),c.insertBefore(s,r.element),a.gutter=s}return I(r.element,r.size,Zt(v,0===t,t===l.length-1,w),t),t>0&&O.push(a),r})),n.forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(g?q(e):e.minSize=t)})),{setSizes:function(e){var t=E(e);t.forEach((function(e,i){if(i>0){var a=O[i-1],r=n[a.a],o=n[a.b];r.size=t[i-1],o.size=e,I(r.element,r.size,a._b,r.i),I(o.element,o.size,a._c,o.i)}}))},getSizes:A,collapse:function(e){q(n[e])},destroy:function(e,t){O.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=z(i,a.a.size,a._b);Object.keys(r).forEach((function(e){n[a.a].element.style[e]="",n[a.b].element.style[e]=""}))}}))},parent:c,pairs:O}},ei="search://";class ti extends oe{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources","info"],this.tabLabels={pages:"Pages",story:"Story",resources:"URLs",info:"Archive Info"},this.menuActive=!1,this.embedDropdownActive=!1,this.hasStory=!1,this.editable=!1,this.browsable=!0,this.clearable=!0,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl="",this.autoUpdateInterval=10,this._autoUpdater=null,this.appName="ReplayWeb.page",this.appVersion=Se,this.appLogo=we()}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},embedDropdownActive:{type:Boolean},editable:{type:Boolean},browsable:{type:Boolean},clearable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String},appName:{type:String},appVersion:{type:String},appLogo:{type:String},autoUpdateInterval:{type:Number},swName:{type:String}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",(e=>this.onHashChange(e))),this.addEventListener("fullscreenchange",(()=>{this.isFullscreen=!!document.fullscreenElement})),this.embed&&this.loadInfo&&this.loadInfo.hideOffscreen&&(this.observer=new IntersectionObserver((e=>{this.isVisible=e[0].isIntersecting})),this.observer.observe(this))}async runUpdateLoop(){try{for(;this.editable&&this.autoUpdateInterval&&(!this.collInfo||!this.collInfo.pages||this.collInfo.pages.length<100);)await new Promise((e=>setTimeout(e,1e3*this.autoUpdateInterval))),await this.doUpdateInfo(!0)}finally{this._autoUpdater=null}}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&this.editable&&this.autoUpdateInterval&&!this._autoUpdater&&(this._autoUpdater=this.runUpdateLoop()),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach((e=>!this.tabData[e]&&delete this.tabData[e]));const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url=ei+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=Xt([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(e=!1){if(e&&this.tabData.url&&!this.showSidebar)return;let t=this.loadInfo&&this.loadInfo.customColl;if(!t){t=(await rt(this.sourceUrl)).coll}this.coll=t;const i="./w/api/c/"+t,a="./w/"+t,r=await fetch(i+"?all=1");if(200!=r.status)return void(this.collInfo={});const o=await r.json();if(this.collInfo={apiPrefix:i,replayPrefix:a,coll:t,...o},this.loadInfo&&this.loadInfo.extraConfig&&this.loadInfo.extraConfig.headers){const e=this.loadInfo.extraConfig.headers;await fetch(`${i}/updateAuth`,{method:"POST",body:JSON.stringify({headers:e})})}this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"!==this.embed&&"replay-with-info"!==this.embed||(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,e.detail.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl),this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(){const e=window.location.hash;if(e&&e!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(e.slice(1)).entries()),this._locationHash=e),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.editable||this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=tt(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.detail.reload?this.onRefresh(null,!0):e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return ye(ti.compStyles)}static get compStyles(){return s`
      :host {
        display: flex;
        flex-direction: column;
        height: 100%;
      ...
      @media screen and (max-width: ${$e?s`1163px`:s`1053px`}) {
        .tab-label {
          display: none;
        }
      ...
      ${ti.replayBarStyles}
    `}static get replayBarStyles(){return s`
      .breadbar {
        display: flex;
        align-items: center;
        height: 35px;
    ...
    `}render(){if(!this.inited)return N``;const e=!!this.tabData.url,t=e&&this.showSidebar;if(!e&&this.tabData&&this.tabData.view){const e={title:this.tabLabels[this.tabData.view],replayTitle:!1};this.dispatchEvent(new CustomEvent("update-title",{bubbles:!0,composed:!0,detail:e}))}return this.collInfo&&!this.collInfo.coll?N` <wr-loader
        .loadInfo="${this.loadInfo}"
        embed="${this.embed}"
        swName="${this.swName}"
        .coll="${this.coll}"
      ...
      `:N``}renderTabHeader(e){return N` <nav
      class="main tabs is-centered ${e?"sidebar":""}"
      aria-label="tabs"
    >
      <ul>
        ${e?N` <li class="sidebar-nav left">
              <a
                role="button"
                href="#"
        ...
        ${e?N` <li class="sidebar-nav right">
              <a
                role="button"
                href="#"
    ...
    </nav>`}renderLocationBar(){if("replayonly"===this.embed||"replay-with-info"==this.embed)return"";const e=et(this.ts).toLocaleString(),t=!!this.tabData.url,i=t&&this.favIconUrl;return N` <a
        class="skip-link"
        ...
        <div class="field has-addons">
          ...
          <form @submit="${this.onSubmit}">
            ...
            >
              ...
              />
              ${t?N`<p id="datetime" class="control is-hidden-mobile">
                    ${e}
                  </p>`:N``}
              ${i?N` <span class="favicon icon is-small is-left">
          ...
          >
            ...
            <div class="dropdown-menu" id="menu-dropdown">
              <div class="dropdown-content">
                ...
                ${this.clearable?N` <hr class="dropdown-divider is-hidden-desktop" />
                      <a
                        href="#"
                        role="button"
                        class="dropdown-item"
                ...
                ${!this.editable&&this.sourceUrl.startsWith("http://")||this.sourceUrl.startsWith("https://")?N` <hr class="dropdown-divider" />
                      <a
                        href="${this.sourceUrl}"
                        role="button"
                        class="dropdown-item"
                ...
                ${e?N` <hr class="dropdown-divider is-hidden-desktop" />
      ...
      <p id="skip-replay-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderVerifyInfo(){return"replay-with-info"!==this.embed?"":N`<rwp-embed-receipt
      .collInfo=${this.collInfo}
      url=${this.url}
      ts=${this.ts}
      .appLogo=${this.appLogo}
    >
    </rwp-embed-receipt>`}dragStart(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollInfo(){return N` <div class="info-bg">
      <wr-coll-info
        class="is-list"
        .coll="${this.collInfo}"
        ?detailed="${!0}"
      ...
      ></wr-coll-info>
    </div>`}renderExtraToolbar(){return""}renderCollTabs(e){const t=this.hasStory&&"story"===this.tabData.view,i="pages"===this.tabData.view,a="resources"===this.tabData.view,r="info"===this.tabData.view;return N`
      ${r?this.renderCollInfo():N``}
      ${t?N` <wr-coll-story
            .collInfo="${this.collInfo}"
            .active="${t}"
    ...
    `}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-replay-target").focus()}onKeyDown(e){"Esc"!==e.key&&"Escape"!==e.key||(e.preventDefault(),e.currentTarget.value=this.url)}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",(()=>{this.menuActive=!1}),{once:!0})}onFullscreenToggle(e){e.preventDefault(),this.menuActive=!1,this.isFullscreen?document.exitFullscreen():this.requestFullscreen()}onGoBack(e){e.preventDefault(),this.menuActive=!1,window.history.back()}onGoForward(e){e.preventDefault(),this.menuActive=!1,window.history.forward()}onShowPages(e){e.preventDefault(),this.showSidebar||document.documentElement.clientWidth>=769?this.showSidebar=!this.showSidebar:(this.showSidebar=!1,this.updateTabData({url:"",ts:""}))}onFullPageView(e){e.preventDefault(),this.updateTabData({url:"",ts:""})}onHideSidebar(e){e.preventDefault(),this.showSidebar=!1}async onFavIcons(e){for(const t of e.detail.icons){const e=await fetch(t.href);if(200===e.status){const i=e.headers.get("Content-Type");if(i&&!i.startsWith("text/"))return void(this.favIconUrl=t.href)}}this.favIconUrl=""}onPurgeCache(e){e.preventDefault();const t=!e.detail||void 0===e.detail.reload||e.detail.reload;this.deleteFully(t)}async deleteFully(e=!1){const t=this.collInfo.apiPrefix+(e?"?reload=1":""),i=await fetch(t,{method:"DELETE"});200!==i.status&&console.warn("purge failed: "+i.status),e||this.embed?window.location.reload():window.location.search=""}onSubmit(e){e.preventDefault();const t=this.renderRoot.querySelector("input");return t.value?this.navigateTo(t.value):t.value=this.url,!1}onLostFocus(e){e.currentTarget.value||(e.currentTarget.value=this.url)}navigateTo(e){let t;if(e.startsWith("http://")||e.startsWith("https://")){if(t={url:e},e===this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");return void(e&&e.refresh())}}else t=e.startsWith(ei)?this._stringToParams(e):{query:e,view:"pages"};this.updateTabData(t)}_stringToParams(e){const t=new URLSearchParams(e.slice(ei.length)),i={url:"",ts:""};for(const e of["query","view","currList","currMime","urlSearchType"])t.has(e)&&(i[e]=t.get(e));return i}_paramsToString(e){const t=new URLSearchParams;for(const i of["query","view","currList","currMime","urlSearchType"])i in e&&t.set(i,e[i]);return t.toString()}onRefresh(e,t=!1){if(e&&e.preventDefault(),this.menuActive=!1,this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.refresh()}else t||window.location.reload()}onAbout(){this.dispatchEvent(new CustomEvent("about-show"))}}function ii(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}customElements.define("wr-coll",ti);let ai={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const ri=/[&<>"']/,oi=new RegExp(ri.source,"g"),si=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,ni=new RegExp(si.source,"g"),li={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ci=e=>li[e];function di(e,t){if(t){if(ri.test(e))return e.replace(oi,ci)}else if(si.test(e))return e.replace(ni,ci);return e}const hi=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function pi(e){return e.replace(hi,((e,t)=>"colon"===(t=t.toLowerCase())?":":"#"===t.charAt(0)?"x"===t.charAt(1)?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const ui=/(^|[^\[])\^/g;function fi(e,t){e="string"==typeof e?e:e.source,t=t||"";const i={replace:(t,a)=>(a=(a=a.source||a).replace(ui,"$1"),e=e.replace(t,a),i),getRegex:()=>new RegExp(e,t)};return i}const bi=/[^\w:]/g,mi=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function gi(e,t,i){if(e){let e;try{e=decodeURIComponent(pi(i)).replace(bi,"").toLowerCase()}catch(e){return null}if(0===e.indexOf("javascript:")||0===e.indexOf("vbscript:")||0===e.indexOf("data:"))return null}t&&!mi.test(i)&&(i=function(e,t){vi[" "+e]||(wi.test(e)?vi[" "+e]=e+"/":vi[" "+e]=Si(e,"/",!0));const i=-1===(e=vi[" "+e]).indexOf(":");return"//"===t.substring(0,2)?i?t:e.replace(xi,"$1")+t:"/"===t.charAt(0)?i?t:e.replace(ki,"$1")+t:e+t}(t,i));try{i=encodeURI(i).replace(/%25/g,"%")}catch(e){return null}return i}const vi={},wi=/^[^:]+:\/*[^/]*$/,xi=/^([^:]+:)[\s\S]*$/,ki=/^([^:]+:\/*[^/]*)[\s\S]*$/;const yi={exec:function(){}};function $i(e,t){const i=e.replace(/\|/g,((e,t,i)=>{let a=!1,r=t;for(;--r>=0&&"\\"===i[r];)a=!a;return a?"|":" |"})).split(/ \|/);let a=0;if(i[0].trim()||i.shift(),i.length>0&&!i[i.length-1].trim()&&i.pop(),i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;a<i.length;a++)i[a]=i[a].trim().replace(/\\\|/g,"|");return i}function Si(e,t,i){const a=e.length;if(0===a)return"";let r=0;for(;r<a;){const o=e.charAt(a-r-1);if(o!==t||i){if(o===t||!i)break;r++}else r++}return e.slice(0,a-r)}function _i(e,t){if(t<1)return"";let i="";for(;t>1;)1&t&&(i+=e),t>>=1,e+=e;return i+e}function zi(e,t,i,a){const r=t.href,o=t.title?di(t.title):null,s=e[1].replace(/\\([\[\]])/g,"$1");if("!"!==e[0].charAt(0)){a.state.inLink=!0;const e={type:"link",raw:i,href:r,title:o,text:s,tokens:a.inlineTokens(s)};return a.state.inLink=!1,e}return{type:"image",raw:i,href:r,title:o,text:di(s)}}class Ci{constructor(e){this.options=e||ai}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:Si(e,"\n")}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const e=t[0],i=function(e,t){const i=e.match(/^(\s+)(?:```)/);if(null===i)return t;const a=i[1];return t.split("\n").map((e=>{const t=e.match(/^\s+/);if(null===t)return e;const[i]=t;return i.length>=a.length?e.slice(a.length):e})).join("\n")}(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:i}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(/#$/.test(e)){const t=Si(e,"#");this.options.pedantic?e=t.trim():t&&!/ $/.test(t)||(e=t.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:t[0]}}blockquote(e){const t=this.rules.block.blockquote.exec(e);if(t){const e=t[0].replace(/^ *>[ \t]?/gm,""),i=this.lexer.state.top;this.lexer.state.top=!0;const a=this.lexer.blockTokens(e);return this.lexer.state.top=i,{type:"blockquote",raw:t[0],tokens:a,text:e}}}list(e){let t=this.rules.block.list.exec(e);if(t){let i,a,r,o,s,n,l,c,d,h,p,u,f=t[1].trim();const b=f.length>1,m={type:"list",raw:"",ordered:b,start:b?+f.slice(0,-1):"",loose:!1,items:[]};f=b?`\\d{1,9}\\${f.slice(-1)}`:`\\${f}`,this.options.pedantic&&(f=b?f:"[*+-]");const g=new RegExp(`^( {0,3}${f})((?:[\t ][^\\n]*)?(?:\\n|$))`);for(;e&&(u=!1,t=g.exec(e))&&!this.rules.block.hr.test(e);){if(i=t[0],e=e.substring(i.length),c=t[2].split("\n",1)[0].replace(/^\t+/,(e=>" ".repeat(3*e.length))),d=e.split("\n",1)[0],this.options.pedantic?(o=2,p=c.trimLeft()):(o=t[2].search(/[^ ]/),o=o>4?1:o,p=c.slice(o),o+=t[1].length),n=!1,!c&&/^ *$/.test(d)&&(i+=d+"\n",e=e.substring(d.length+1),u=!0),!u){const t=new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ \t][^\\n]*)?(?:\\n|$))`),a=new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),r=new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),s=new RegExp(`^ {0,${Math.min(3,o-1)}}#`);for(;e&&(h=e.split("\n",1)[0],d=h,this.options.pedantic&&(d=d.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!r.test(d))&&!s.test(d)&&!t.test(d)&&!a.test(e);){if(d.search(/[^ ]/)>=o||!d.trim())p+="\n"+d.slice(o);else{if(n)break;if(c.search(/[^ ]/)>=4)break;if(r.test(c))break;if(s.test(c))break;if(a.test(c))break;p+="\n"+d}n||d.trim()||(n=!0),i+=h+"\n",e=e.substring(h.length+1),c=d.slice(o)}}m.loose||(l?m.loose=!0:/\n *\n *$/.test(i)&&(l=!0)),this.options.gfm&&(a=/^\[[ xX]\] /.exec(p),a&&(r="[ ] "!==a[0],p=p.replace(/^\[[ xX]\] +/,""))),m.items.push({type:"list_item",raw:i,task:!!a,checked:r,loose:!1,text:p}),m.raw+=i}m.items[m.items.length-1].raw=i.trimRight(),m.items[m.items.length-1].text=p.trimRight(),m.raw=m.raw.trimRight();const v=m.items.length;for(s=0;s<v;s++)if(this.lexer.state.top=!1,m.items[s].tokens=this.lexer.blockTokens(m.items[s].text,[]),!m.loose){const e=m.items[s].tokens.filter((e=>"space"===e.type)),t=e.length>0&&e.some((e=>/\n.*\n/.test(e.raw)));m.loose=t}if(m.loose)for(s=0;s<v;s++)m.items[s].loose=!0;return m}}html(e){const t=this.rules.block.html.exec(e);if(t){const e={type:"html",raw:t[0],pre:!this.options.sanitizer&&("pre"===t[1]||"script"===t[1]||"style"===t[1]),text:t[0]};if(this.options.sanitize){const i=this.options.sanitizer?this.options.sanitizer(t[0]):di(t[0]);e.type="paragraph",e.text=i,e.tokens=this.lexer.inline(i)}return e}}def(e){const t=this.rules.block.def.exec(e);if(t){const e=t[1].toLowerCase().replace(/\s+/g," "),i=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",a=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline._escapes,"$1"):t[3];return{type:"def",tag:e,raw:t[0],href:i,title:a}}}table(e){const t=this.rules.block.table.exec(e);if(t){const e={type:"table",header:$i(t[1]).map((e=>({text:e}))),align:t[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split("\n"):[]};if(e.header.length===e.align.length){e.raw=t[0];let i,a,r,o,s=e.align.length;for(i=0;i<s;i++)/^ *-+: *$/.test(e.align[i])?e.align[i]="right":/^ *:-+: *$/.test(e.align[i])?e.align[i]="center":/^ *:-+ *$/.test(e.align[i])?e.align[i]="left":e.align[i]=null;for(s=e.rows.length,i=0;i<s;i++)e.rows[i]=$i(e.rows[i],e.header.length).map((e=>({text:e})));for(s=e.header.length,a=0;a<s;a++)e.header[a].tokens=this.lexer.inline(e.header[a].text);for(s=e.rows.length,a=0;a<s;a++)for(o=e.rows[a],r=0;r<o.length;r++)o[r].tokens=this.lexer.inline(o[r].text);return e}}}lheading(e){const t=this.rules.block.lheading.exec(e);if(t)return{type:"heading",raw:t[0],depth:"="===t[2].charAt(0)?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){const t=this.rules.block.paragraph.exec(e);if(t){const e="\n"===t[1].charAt(t[1].length-1)?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){const t=this.rules.block.text.exec(e);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){const t=this.rules.inline.escape.exec(e);if(t)return{type:"escape",raw:t[0],text:di(t[1])}}tag(e){const t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:this.options.sanitize?"text":"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,text:this.options.sanitize?this.options.sanitizer?this.options.sanitizer(t[0]):di(t[0]):t[0]}}link(e){const t=this.rules.inline.link.exec(e);if(t){const e=t[2].trim();if(!this.options.pedantic&&/^</.test(e)){if(!/>$/.test(e))return;const t=Si(e.slice(0,-1),"\\");if((e.length-t.length)%2==0)return}else{const e=function(e,t){if(-1===e.indexOf(t[1]))return-1;const i=e.length;let a=0,r=0;for(;r<i;r++)if("\\"===e[r])r++;else if(e[r]===t[0])a++;else if(e[r]===t[1]&&(a--,a<0))return r;return-1}(t[2],"()");if(e>-1){const i=(0===t[0].indexOf("!")?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,i).trim(),t[3]=""}}let i=t[2],a="";if(this.options.pedantic){const e=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i);e&&(i=e[1],a=e[3])}else a=t[3]?t[3].slice(1,-1):"";return i=i.trim(),/^</.test(i)&&(i=this.options.pedantic&&!/>$/.test(e)?i.slice(1):i.slice(1,-1)),zi(t,{href:i?i.replace(this.rules.inline._escapes,"$1"):i,title:a?a.replace(this.rules.inline._escapes,"$1"):a},t[0],this.lexer)}}reflink(e,t){let i;if((i=this.rules.inline.reflink.exec(e))||(i=this.rules.inline.nolink.exec(e))){let e=(i[2]||i[1]).replace(/\s+/g," ");if(e=t[e.toLowerCase()],!e){const e=i[0].charAt(0);return{type:"text",raw:e,text:e}}return zi(i,e,i[0],this.lexer)}}emStrong(e,t,i=""){let a=this.rules.inline.emStrong.lDelim.exec(e);if(!a)return;if(a[3]&&i.match(/[\p{L}\p{N}]/u))return;const r=a[1]||a[2]||"";if(!r||r&&(""===i||this.rules.inline.punctuation.exec(i))){const i=a[0].length-1;let r,o,s=i,n=0;const l="*"===a[0][0]?this.rules.inline.emStrong.rDelimAst:this.rules.inline.emStrong.rDelimUnd;for(l.lastIndex=0,t=t.slice(-1*e.length+i);null!=(a=l.exec(t));){if(r=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!r)continue;if(o=r.length,a[3]||a[4]){s+=o;continue}if((a[5]||a[6])&&i%3&&!((i+o)%3)){n+=o;continue}if(s-=o,s>0)continue;o=Math.min(o,o+s+n);const t=e.slice(0,i+a.index+(a[0].length-r.length)+o);if(Math.min(i,o)%2){const e=t.slice(1,-1);return{type:"em",raw:t,text:e,tokens:this.lexer.inlineTokens(e)}}const l=t.slice(2,-2);return{type:"strong",raw:t,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){const t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(/\n/g," ");const i=/[^ ]/.test(e),a=/^ /.test(e)&&/ $/.test(e);return i&&a&&(e=e.substring(1,e.length-1)),e=di(e,!0),{type:"codespan",raw:t[0],text:e}}}br(e){const t=this.rules.inline.br.exec(e);if(t)return{type:"br",raw:t[0]}}del(e){const t=this.rules.inline.del.exec(e);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e,t){const i=this.rules.inline.autolink.exec(e);if(i){let e,a;return"@"===i[2]?(e=di(this.options.mangle?t(i[1]):i[1]),a="mailto:"+e):(e=di(i[1]),a=e),{type:"link",raw:i[0],text:e,href:a,tokens:[{type:"text",raw:e,text:e}]}}}url(e,t){let i;if(i=this.rules.inline.url.exec(e)){let e,a;if("@"===i[2])e=di(this.options.mangle?t(i[0]):i[0]),a="mailto:"+e;else{let t;do{t=i[0],i[0]=this.rules.inline._backpedal.exec(i[0])[0]}while(t!==i[0]);e=di(i[0]),a="www."===i[1]?"http://"+i[0]:i[0]}return{type:"link",raw:i[0],text:e,href:a,tokens:[{type:"text",raw:e,text:e}]}}}inlineText(e,t){const i=this.rules.inline.text.exec(e);if(i){let e;return e=this.lexer.state.inRawBlock?this.options.sanitize?this.options.sanitizer?this.options.sanitizer(i[0]):di(i[0]):i[0]:di(this.options.smartypants?t(i[0]):i[0]),{type:"text",raw:i[0],text:e}}}}const Ii={newline:/^(?: *(?:\n|$))+/,code:/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,fences:/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,hr:/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,heading:/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,blockquote:/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/,list:/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/,html:"^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))",def:/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/,table:yi,lheading:/^((?:.|\n(?!\n))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,_paragraph:/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,text:/^[^\n]+/,_label:/(?!\s*\])(?:\\.|[^\[\]\\])+/,_title:/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/};Ii.def=fi(Ii.def).replace("label",Ii._label).replace("title",Ii._title).getRegex(),Ii.bullet=/(?:[*+-]|\d{1,9}[.)])/,Ii.listItemStart=fi(/^( *)(bull) */).replace("bull",Ii.bullet).getRegex(),Ii.list=fi(Ii.list).replace(/bull/g,Ii.bullet).replace("hr","\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def","\\n+(?="+Ii.def.source+")").getRegex(),Ii._tag="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ii._comment=/<!--(?!-?>)[\s\S]*?(?:-->|$)/,Ii.html=fi(Ii.html,"i").replace("comment",Ii._comment).replace("tag",Ii._tag).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ii.paragraph=fi(Ii._paragraph).replace("hr",Ii.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ii._tag).getRegex(),Ii.blockquote=fi(Ii.blockquote).replace("paragraph",Ii.paragraph).getRegex(),Ii.normal={...Ii},Ii.gfm={...Ii.normal,table:"^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)"},Ii.gfm.table=fi(Ii.gfm.table).replace("hr",Ii.hr).replace("heading"," {0,3}#{1,6} ").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ii._tag).getRegex(),Ii.gfm.paragraph=fi(Ii._paragraph).replace("hr",Ii.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("table",Ii.gfm.table).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ii._tag).getRegex(),Ii.pedantic={...Ii.normal,html:fi("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment",Ii._comment).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:yi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:fi(Ii.normal._paragraph).replace("hr",Ii.hr).replace("heading"," *#{1,6} *[^\n]").replace("lheading",Ii.lheading).replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").getRegex()};const Ai={escape:/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:yi,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",link:/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(ref)\]/,nolink:/^!?\[(ref)\](?:\[\])?/,reflinkSearch:"reflink|nolink(?!\\()",emStrong:{lDelim:/^(?:\*+(?:([punct_])|[^\s*]))|^_+(?:([punct*])|([^\s_]))/,rDelimAst:/^(?:[^_*\\]|\\.)*?\_\_(?:[^_*\\]|\\.)*?\*(?:[^_*\\]|\\.)*?(?=\_\_)|(?:[^*\\]|\\.)+(?=[^*])|[punct_](\*+)(?=[\s]|$)|(?:[^punct*_\s\\]|\\.)(\*+)(?=[punct_\s]|$)|[punct_\s](\*+)(?=[^punct*_\s])|[\s](\*+)(?=[punct_])|[punct_](\*+)(?=[punct_])|(?:[^punct*_\s\\]|\\.)(\*+)(?=[^punct*_\s])/,rDelimUnd:/^(?:[^_*\\]|\\.)*?\*\*(?:[^_*\\]|\\.)*?\_(?:[^_*\\]|\\.)*?(?=\*\*)|(?:[^_\\]|\\.)+(?=[^_])|[punct*](\_+)(?=[\s]|$)|(?:[^punct*_\s\\]|\\.)(\_+)(?=[punct*\s]|$)|[punct*\s](\_+)(?=[^punct*_\s])|[\s](\_+)(?=[punct*])|[punct*](\_+)(?=[punct*])/},code:/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br:/^( {2,}|\\)\n(?!\s*$)/,del:yi,text:/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,punctuation:/^([\spunctuation])/};function Ui(e){return e.replace(/---/g,"—").replace(/--/g,"–").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1‘").replace(/'/g,"’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1“").replace(/"/g,"”").replace(/\.{3}/g,"…")}function Pi(e){let t,i,a="";const r=e.length;for(t=0;t<r;t++)i=e.charCodeAt(t),Math.random()>.5&&(i="x"+i.toString(16)),a+="&#"+i+";";return a}Ai._punctuation="!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",Ai.punctuation=fi(Ai.punctuation).replace(/punctuation/g,Ai._punctuation).getRegex(),Ai.blockSkip=/\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,Ai.escapedEmSt=/(?:^|[^\\])(?:\\\\)*\\[*_]/g,Ai._comment=fi(Ii._comment).replace("(?:--\x3e|$)","--\x3e").getRegex(),Ai.emStrong.lDelim=fi(Ai.emStrong.lDelim).replace(/punct/g,Ai._punctuation).getRegex(),Ai.emStrong.rDelimAst=fi(Ai.emStrong.rDelimAst,"g").replace(/punct/g,Ai._punctuation).getRegex(),Ai.emStrong.rDelimUnd=fi(Ai.emStrong.rDelimUnd,"g").replace(/punct/g,Ai._punctuation).getRegex(),Ai._escapes=/\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,Ai._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,Ai._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,Ai.autolink=fi(Ai.autolink).replace("scheme",Ai._scheme).replace("email",Ai._email).getRegex(),Ai._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,Ai.tag=fi(Ai.tag).replace("comment",Ai._comment).replace("attribute",Ai._attribute).getRegex(),Ai._label=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Ai._href=/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,Ai._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,Ai.link=fi(Ai.link).replace("label",Ai._label).replace("href",Ai._href).replace("title",Ai._title).getRegex(),Ai.reflink=fi(Ai.reflink).replace("label",Ai._label).replace("ref",Ii._label).getRegex(),Ai.nolink=fi(Ai.nolink).replace("ref",Ii._label).getRegex(),Ai.reflinkSearch=fi(Ai.reflinkSearch,"g").replace("reflink",Ai.reflink).replace("nolink",Ai.nolink).getRegex(),Ai.normal={...Ai},Ai.pedantic={...Ai.normal,strong:{start:/^__|\*\*/,middle:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,endAst:/\*\*(?!\*)/g,endUnd:/__(?!_)/g},em:{start:/^_|\*/,middle:/^()\*(?=\S)([\s\S]*?\S)\*(?!\*)|^_(?=\S)([\s\S]*?\S)_(?!_)/,endAst:/\*(?!\*)/g,endUnd:/_(?!_)/g},link:fi(/^!?\[(label)\]\((.*?)\)/).replace("label",Ai._label).getRegex(),reflink:fi(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ai._label).getRegex()},Ai.gfm={...Ai.normal,escape:fi(Ai.escape).replace("])","~|])").getRegex(),_extended_email:/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,url:/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Ai.gfm.url=fi(Ai.gfm.url,"i").replace("email",Ai.gfm._extended_email).getRegex(),Ai.breaks={...Ai.gfm,br:fi(Ai.br).replace("{2,}","*").getRegex(),text:fi(Ai.gfm.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()};class Li{constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||ai,this.options.tokenizer=this.options.tokenizer||new Ci,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const t={block:Ii.normal,inline:Ai.normal};this.options.pedantic?(t.block=Ii.pedantic,t.inline=Ai.pedantic):this.options.gfm&&(t.block=Ii.gfm,this.options.breaks?t.inline=Ai.breaks:t.inline=Ai.gfm),this.tokenizer.rules=t}static get rules(){return{block:Ii,inline:Ai}}static lex(e,t){return new Li(t).lex(e)}static lexInline(e,t){return new Li(t).inlineTokens(e)}lex(e){let t;for(e=e.replace(/\r\n|\r/g,"\n"),this.blockTokens(e,this.tokens);t=this.inlineQueue.shift();)this.inlineTokens(t.src,t.tokens);return this.tokens}blockTokens(e,t=[]){let i,a,r,o;for(e=this.options.pedantic?e.replace(/\t/g,"    ").replace(/^ +$/gm,""):e.replace(/^( *)(\t+)/gm,((e,t,i)=>t+"    ".repeat(i.length)));e;)if(!(this.options.extensions&&this.options.extensions.block&&this.options.extensions.block.some((a=>!!(i=a.call({lexer:this},e,t))&&(e=e.substring(i.raw.length),t.push(i),!0)))))if(i=this.tokenizer.space(e))e=e.substring(i.raw.length),1===i.raw.length&&t.length>0?t[t.length-1].raw+="\n":t.push(i);else if(i=this.tokenizer.code(e))e=e.substring(i.raw.length),a=t[t.length-1],!a||"paragraph"!==a.type&&"text"!==a.type?t.push(i):(a.raw+="\n"+i.raw,a.text+="\n"+i.text,this.inlineQueue[this.inlineQueue.length-1].src=a.text);else if(i=this.tokenizer.fences(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.heading(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.hr(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.blockquote(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.list(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.html(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.def(e))e=e.substring(i.raw.length),a=t[t.length-1],!a||"paragraph"!==a.type&&"text"!==a.type?this.tokens.links[i.tag]||(this.tokens.links[i.tag]={href:i.href,title:i.title}):(a.raw+="\n"+i.raw,a.text+="\n"+i.raw,this.inlineQueue[this.inlineQueue.length-1].src=a.text);else if(i=this.tokenizer.table(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.lheading(e))e=e.substring(i.raw.length),t.push(i);else{if(r=e,this.options.extensions&&this.options.extensions.startBlock){let t=1/0;const i=e.slice(1);let a;this.options.extensions.startBlock.forEach((function(e){a=e.call({lexer:this},i),"number"==typeof a&&a>=0&&(t=Math.min(t,a))})),t<1/0&&t>=0&&(r=e.substring(0,t+1))}if(this.state.top&&(i=this.tokenizer.paragraph(r)))a=t[t.length-1],o&&"paragraph"===a.type?(a.raw+="\n"+i.raw,a.text+="\n"+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=a.text):t.push(i),o=r.length!==e.length,e=e.substring(i.raw.length);else if(i=this.tokenizer.text(e))e=e.substring(i.raw.length),a=t[t.length-1],a&&"text"===a.type?(a.raw+="\n"+i.raw,a.text+="\n"+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=a.text):t.push(i);else if(e){const t="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(t);break}throw new Error(t)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){let i,a,r,o,s,n,l=e;if(this.tokens.links){const e=Object.keys(this.tokens.links);if(e.length>0)for(;null!=(o=this.tokenizer.rules.inline.reflinkSearch.exec(l));)e.includes(o[0].slice(o[0].lastIndexOf("[")+1,-1))&&(l=l.slice(0,o.index)+"["+_i("a",o[0].length-2)+"]"+l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;null!=(o=this.tokenizer.rules.inline.blockSkip.exec(l));)l=l.slice(0,o.index)+"["+_i("a",o[0].length-2)+"]"+l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;null!=(o=this.tokenizer.rules.inline.escapedEmSt.exec(l));)l=l.slice(0,o.index+o[0].length-2)+"++"+l.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;e;)if(s||(n=""),s=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some((a=>!!(i=a.call({lexer:this},e,t))&&(e=e.substring(i.raw.length),t.push(i),!0)))))if(i=this.tokenizer.escape(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.tag(e))e=e.substring(i.raw.length),a=t[t.length-1],a&&"text"===i.type&&"text"===a.type?(a.raw+=i.raw,a.text+=i.text):t.push(i);else if(i=this.tokenizer.link(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.reflink(e,this.tokens.links))e=e.substring(i.raw.length),a=t[t.length-1],a&&"text"===i.type&&"text"===a.type?(a.raw+=i.raw,a.text+=i.text):t.push(i);else if(i=this.tokenizer.emStrong(e,l,n))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.codespan(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.br(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.del(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.autolink(e,Pi))e=e.substring(i.raw.length),t.push(i);else if(this.state.inLink||!(i=this.tokenizer.url(e,Pi))){if(r=e,this.options.extensions&&this.options.extensions.startInline){let t=1/0;const i=e.slice(1);let a;this.options.extensions.startInline.forEach((function(e){a=e.call({lexer:this},i),"number"==typeof a&&a>=0&&(t=Math.min(t,a))})),t<1/0&&t>=0&&(r=e.substring(0,t+1))}if(i=this.tokenizer.inlineText(r,Ui))e=e.substring(i.raw.length),"_"!==i.raw.slice(-1)&&(n=i.raw.slice(-1)),s=!0,a=t[t.length-1],a&&"text"===a.type?(a.raw+=i.raw,a.text+=i.text):t.push(i);else if(e){const t="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(t);break}throw new Error(t)}}else e=e.substring(i.raw.length),t.push(i);return t}}class Di{constructor(e){this.options=e||ai}code(e,t,i){const a=(t||"").match(/\S*/)[0];if(this.options.highlight){const t=this.options.highlight(e,a);null!=t&&t!==e&&(i=!0,e=t)}return e=e.replace(/\n$/,"")+"\n",a?'<pre><code class="'+this.options.langPrefix+di(a)+'">'+(i?e:di(e,!0))+"</code></pre>\n":"<pre><code>"+(i?e:di(e,!0))+"</code></pre>\n"}blockquote(e){return`<blockquote>\n${e}</blockquote>\n`}html(e){return e}heading(e,t,i,a){if(this.options.headerIds){return`<h${t} id="${this.options.headerPrefix+a.slug(i)}">${e}</h${t}>\n`}return`<h${t}>${e}</h${t}>\n`}hr(){return this.options.xhtml?"<hr/>\n":"<hr>\n"}list(e,t,i){const a=t?"ol":"ul";return"<"+a+(t&&1!==i?' start="'+i+'"':"")+">\n"+e+"</"+a+">\n"}listitem(e){return`<li>${e}</li>\n`}checkbox(e){return"<input "+(e?'checked="" ':"")+'disabled="" type="checkbox"'+(this.options.xhtml?" /":"")+"> "}paragraph(e){return`<p>${e}</p>\n`}table(e,t){return t&&(t=`<tbody>${t}</tbody>`),"<table>\n<thead>\n"+e+"</thead>\n"+t+"</table>\n"}tablerow(e){return`<tr>\n${e}</tr>\n`}tablecell(e,t){const i=t.header?"th":"td";return(t.align?`<${i} align="${t.align}">`:`<${i}>`)+e+`</${i}>\n`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(e){return`<del>${e}</del>`}link(e,t,i){if(null===(e=gi(this.options.sanitize,this.options.baseUrl,e)))return i;let a='<a href="'+e+'"';return t&&(a+=' title="'+t+'"'),a+=">"+i+"</a>",a}image(e,t,i){if(null===(e=gi(this.options.sanitize,this.options.baseUrl,e)))return i;let a=`<img src="${e}" alt="${i}"`;return t&&(a+=` title="${t}"`),a+=this.options.xhtml?"/>":">",a}text(e){return e}}class Ei{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,i){return""+i}image(e,t,i){return""+i}br(){return""}}class Ti{constructor(){this.seen={}}serialize(e){return e.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(e,t){let i=e,a=0;if(this.seen.hasOwnProperty(i)){a=this.seen[e];do{a++,i=e+"-"+a}while(this.seen.hasOwnProperty(i))}return t||(this.seen[e]=a,this.seen[i]=0),i}slug(e,t={}){const i=this.serialize(e);return this.getNextSafeSlug(i,t.dryrun)}}class Ri{constructor(e){this.options=e||ai,this.options.renderer=this.options.renderer||new Di,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Ei,this.slugger=new Ti}static parse(e,t){return new Ri(t).parse(e)}static parseInline(e,t){return new Ri(t).parseInline(e)}parse(e,t=!0){let i,a,r,o,s,n,l,c,d,h,p,u,f,b,m,g,v,w,x,k="";const y=e.length;for(i=0;i<y;i++)if(h=e[i],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[h.type]&&(x=this.options.extensions.renderers[h.type].call({parser:this},h),!1!==x||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(h.type)))k+=x||"";else switch(h.type){case"space":continue;case"hr":k+=this.renderer.hr();continue;case"heading":k+=this.renderer.heading(this.parseInline(h.tokens),h.depth,pi(this.parseInline(h.tokens,this.textRenderer)),this.slugger);continue;case"code":k+=this.renderer.code(h.text,h.lang,h.escaped);continue;case"table":for(c="",l="",o=h.header.length,a=0;a<o;a++)l+=this.renderer.tablecell(this.parseInline(h.header[a].tokens),{header:!0,align:h.align[a]});for(c+=this.renderer.tablerow(l),d="",o=h.rows.length,a=0;a<o;a++){for(n=h.rows[a],l="",s=n.length,r=0;r<s;r++)l+=this.renderer.tablecell(this.parseInline(n[r].tokens),{header:!1,align:h.align[r]});d+=this.renderer.tablerow(l)}k+=this.renderer.table(c,d);continue;case"blockquote":d=this.parse(h.tokens),k+=this.renderer.blockquote(d);continue;case"list":for(p=h.ordered,u=h.start,f=h.loose,o=h.items.length,d="",a=0;a<o;a++)m=h.items[a],g=m.checked,v=m.task,b="",m.task&&(w=this.renderer.checkbox(g),f?m.tokens.length>0&&"paragraph"===m.tokens[0].type?(m.tokens[0].text=w+" "+m.tokens[0].text,m.tokens[0].tokens&&m.tokens[0].tokens.length>0&&"text"===m.tokens[0].tokens[0].type&&(m.tokens[0].tokens[0].text=w+" "+m.tokens[0].tokens[0].text)):m.tokens.unshift({type:"text",text:w}):b+=w),b+=this.parse(m.tokens,f),d+=this.renderer.listitem(b,v,g);k+=this.renderer.list(d,p,u);continue;case"html":k+=this.renderer.html(h.text);continue;case"paragraph":k+=this.renderer.paragraph(this.parseInline(h.tokens));continue;case"text":for(d=h.tokens?this.parseInline(h.tokens):h.text;i+1<y&&"text"===e[i+1].type;)h=e[++i],d+="\n"+(h.tokens?this.parseInline(h.tokens):h.text);k+=t?this.renderer.paragraph(d):d;continue;default:{const e='Token with "'+h.type+'" type was not found.';if(this.options.silent)return void console.error(e);throw new Error(e)}}return k}parseInline(e,t){t=t||this.renderer;let i,a,r,o="";const s=e.length;for(i=0;i<s;i++)if(a=e[i],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[a.type]&&(r=this.options.extensions.renderers[a.type].call({parser:this},a),!1!==r||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(a.type)))o+=r||"";else switch(a.type){case"escape":case"text":o+=t.text(a.text);break;case"html":o+=t.html(a.text);break;case"link":o+=t.link(a.href,a.title,this.parseInline(a.tokens,t));break;case"image":o+=t.image(a.href,a.title,a.text);break;case"strong":o+=t.strong(this.parseInline(a.tokens,t));break;case"em":o+=t.em(this.parseInline(a.tokens,t));break;case"codespan":o+=t.codespan(a.text);break;case"br":o+=t.br();break;case"del":o+=t.del(this.parseInline(a.tokens,t));break;default:{const e='Token with "'+a.type+'" type was not found.';if(this.options.silent)return void console.error(e);throw new Error(e)}}return o}}class Oi{constructor(e){this.options=e||ai}static passThroughHooks=new Set(["preprocess","postprocess"]);preprocess(e){return e}postprocess(e){return e}}function qi(e,t){return(i,a,r)=>{"function"==typeof a&&(r=a,a=null);const o={...a},s=function(e,t,i){return a=>{if(a.message+="\nPlease report this to https://github.com/markedjs/marked.",e){const e="<p>An error occurred:</p><pre>"+di(a.message+"",!0)+"</pre>";return t?Promise.resolve(e):i?void i(null,e):e}if(t)return Promise.reject(a);if(!i)throw a;i(a)}}((a={...Ni.defaults,...o}).silent,a.async,r);if(null==i)return s(new Error("marked(): input parameter is undefined or null"));if("string"!=typeof i)return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(i)+", string expected"));if(function(e){e&&e.sanitize&&!e.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}(a),a.hooks&&(a.hooks.options=a),r){const o=a.highlight;let n;try{a.hooks&&(i=a.hooks.preprocess(i)),n=e(i,a)}catch(e){return s(e)}const l=function(e){let i;if(!e)try{a.walkTokens&&Ni.walkTokens(n,a.walkTokens),i=t(n,a),a.hooks&&(i=a.hooks.postprocess(i))}catch(t){e=t}return a.highlight=o,e?s(e):r(null,i)};if(!o||o.length<3)return l();if(delete a.highlight,!n.length)return l();let c=0;return Ni.walkTokens(n,(function(e){"code"===e.type&&(c++,setTimeout((()=>{o(e.text,e.lang,(function(t,i){if(t)return l(t);null!=i&&i!==e.text&&(e.text=i,e.escaped=!0),c--,0===c&&l()}))}),0))})),void(0===c&&l())}if(a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(i):i).then((t=>e(t,a))).then((e=>a.walkTokens?Promise.all(Ni.walkTokens(e,a.walkTokens)).then((()=>e)):e)).then((e=>t(e,a))).then((e=>a.hooks?a.hooks.postprocess(e):e)).catch(s);try{a.hooks&&(i=a.hooks.preprocess(i));const r=e(i,a);a.walkTokens&&Ni.walkTokens(r,a.walkTokens);let o=t(r,a);return a.hooks&&(o=a.hooks.postprocess(o)),o}catch(e){return s(e)}}}function Ni(e,t,i){return qi(Li.lex,Ri.parse)(e,t,i)}Ni.options=Ni.setOptions=function(e){var t;return Ni.defaults={...Ni.defaults,...e},t=Ni.defaults,ai=t,Ni},Ni.getDefaults=ii,Ni.defaults=ai,Ni.use=function(...e){const t=Ni.defaults.extensions||{renderers:{},childTokens:{}};e.forEach((e=>{const i={...e};if(i.async=Ni.defaults.async||i.async||!1,e.extensions&&(e.extensions.forEach((e=>{if(!e.name)throw new Error("extension name required");if(e.renderer){const i=t.renderers[e.name];t.renderers[e.name]=i?function(...t){let a=e.renderer.apply(this,t);return!1===a&&(a=i.apply(this,t)),a}:e.renderer}if(e.tokenizer){if(!e.level||"block"!==e.level&&"inline"!==e.level)throw new Error("extension level must be 'block' or 'inline'");t[e.level]?t[e.level].unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&("block"===e.level?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:"inline"===e.level&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}e.childTokens&&(t.childTokens[e.name]=e.childTokens)})),i.extensions=t),e.renderer){const t=Ni.defaults.renderer||new Di;for(const i in e.renderer){const a=t[i];t[i]=(...r)=>{let o=e.renderer[i].apply(t,r);return!1===o&&(o=a.apply(t,r)),o}}i.renderer=t}if(e.tokenizer){const t=Ni.defaults.tokenizer||new Ci;for(const i in e.tokenizer){const a=t[i];t[i]=(...r)=>{let o=e.tokenizer[i].apply(t,r);return!1===o&&(o=a.apply(t,r)),o}}i.tokenizer=t}if(e.hooks){const t=Ni.defaults.hooks||new Oi;for(const i in e.hooks){const a=t[i];Oi.passThroughHooks.has(i)?t[i]=r=>{if(Ni.defaults.async)return Promise.resolve(e.hooks[i].call(t,r)).then((e=>a.call(t,e)));const o=e.hooks[i].call(t,r);return a.call(t,o)}:t[i]=(...r)=>{let o=e.hooks[i].apply(t,r);return!1===o&&(o=a.apply(t,r)),o}}i.hooks=t}if(e.walkTokens){const t=Ni.defaults.walkTokens;i.walkTokens=function(i){let a=[];return a.push(e.walkTokens.call(this,i)),t&&(a=a.concat(t.call(this,i))),a}}Ni.setOptions(i)}))},Ni.walkTokens=function(e,t){let i=[];for(const a of e)switch(i=i.concat(t.call(Ni,a)),a.type){case"table":for(const e of a.header)i=i.concat(Ni.walkTokens(e.tokens,t));for(const e of a.rows)for(const a of e)i=i.concat(Ni.walkTokens(a.tokens,t));break;case"list":i=i.concat(Ni.walkTokens(a.items,t));break;default:Ni.defaults.extensions&&Ni.defaults.extensions.childTokens&&Ni.defaults.extensions.childTokens[a.type]?Ni.defaults.extensions.childTokens[a.type].forEach((function(e){i=i.concat(Ni.walkTokens(a[e],t))})):a.tokens&&(i=i.concat(Ni.walkTokens(a.tokens,t)))}return i},Ni.parseInline=qi(Li.lexInline,Ri.parseInline),Ni.Parser=Ri,Ni.parser=Ri.parse,Ni.Renderer=Di,Ni.TextRenderer=Ei,Ni.Lexer=Li,Ni.lexer=Li.lex,Ni.Tokenizer=Ci,Ni.Slugger=Ti,Ni.Hooks=Oi,Ni.parse=Ni;Ni.options,Ni.setOptions,Ni.use,Ni.walkTokens,Ni.parseInline;class Mi extends oe{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e=>{this.recalcSplitter(e[0].contentRect.width)})),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=Xt([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const e of this.collInfo.curatedPages){this.curatedPageMap[e.list]||(this.curatedPageMap[e.list]=[]);const t=e,i=t.url,a=t.ts,r=t.title||t.url,o=e.desc;this.curatedPageMap[e.list].push({url:i,ts:a,title:r,desc:o})}this.scrollToList()}static get styles(){return ye(s`
      :host {
        width: 100%;
        height: 100%;
        display: flex;
      ...
      ${Mi.sidebarStyles(o(":host(.sidebar)"))}
    ...
    `)}static sidebarStyles(e=s``){return s`
      ${e} .columns {
        position: relative;
      }
      ...
      <div class="columns">
          ...
          <aside class="menu">
            <ul class="menu-list">
              <li>
                ...
                >
                <ul class="menu-list">
                  ${this.collInfo.lists.map((t=>N` <li>
                        <a
                          @click=${this.onClickScroll}
                          href="#list-${t.id}"
                          data-list="${t.id}"
        ...
        <div @scroll=${this.onScroll} class="column main-content main-scroll">
          <section id="list-0" class="desc">
            ...
            ${this.collInfo.desc?pe(Ni(this.collInfo.desc)):""}
          </section>
          ${this.renderLists()}
        </div>
      </div>
    `}renderLists(){return N` ${this.collInfo.lists.map((e=>N`
      ...
      `))}`}renderCPage(e){const t=new Date(e.ts),i=it(t.toISOString());return N` <li>
      <div class="content">
        <a
          @click="${this.onReplay}"
          data-url="${e.url}"
    ...
    `}renderContent(){switch(this.state){case"googledrive":return N`<wr-gdrive
          .sourceUrl=${this.sourceUrl}
          @load-ready=${this.onLoadReady}
        ></wr-gdrive>`;case"started":return N` <div class="progress-div">
          <progress
            id="progress"
          ...
          ${this.currentSize&&this.totalSize?N` <div class="loaded-prog">
                Loaded <b>${je()(this.currentSize)}</b> of
                <b>${je()(this.totalSize)}</b>
                ${this.extraMsg&&N` <p class="extra-msg">(${this.extraMsg})</p> `}
              </div>`:N``}
          ${this.embed?"":N` <button @click="${this.onCancel}" class="button is-danger">
                Cancel
              </button>`}
        </div>`;case"errored":return N` <div class="has-text-left">
          <div class="error has-text-danger">${this.error}</div>
          <div>
            ${this.errorAllowRetry?N` <a
                  class="button is-warning"
                  @click=${()=>window.parent.location.reload()}
                  >Try Again</a
                >`:""}
            ${this.embed?N``:N` <a href="/" class="button is-warning">Back</a>`}
          </div>
        </div>`;case"permission_needed":return N` <div class="has-text-left">
          <div class="">
        ...
        <div class="field flex-auto">
          ...
          >
            ...
            <span class="icon is-left"
              ><fa-icon .svg="${Ye()}" aria-hidden="true"></fa-icon
            ></span>
          </div>
        </div>
      </div>
        ...
        >
          ${this.editable&&this.editing?N`
              ...
              `:N` <div
                ...
                ${this.collInfo.description?N`<div
                      class="index-bar-description"
                      @dblclick="${()=>this.editing=!0}"
                    >
                      ${this.collInfo.description}
                    </div>`:N``}`}
          ${this.editable?N`<fa-icon class="editIcon" .svg="${Ji()}"></fa-icon>`:N``}
          ${this.hasExtraPages?N` <span class="check-select">
          ...
          >
          ${this.editable?N` <div class="index-bar-actions">
    ...
    `}renderDownloadMenu(){return N` <div class="dropdown ${this.menuActive?"is-active":""}">
      <div class="dropdown-trigger">
        <button
          @click="${this.onMenu}"
      ...
      ${!this.isSidebar&&this.editable&&this.filteredPages.length?N` <div class="check-select">
            <label class="checkbox">
              <input
    ...
    </wr-modal>`:N``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=it(e.date):"string"==typeof e.ts&&(t=it(e.ts)),t===this.ts}return!1}renderPages(){return N`
      <div class="page-header has-text-weight-bold">
        ${this.renderPageHeader()}
      </div>
      <ul class="scroller" @scroll="${this.onScroll}">
        ${this.sortedPages.length?N` ${this.sortedPages.map(((e,t)=>{const i=this.selectedPages.has(e.id);return N` <li class="page-entry ${i?"selected":""}">
                <wr-page-entry
    ...
    `}onUpdateTitle(e){if(e.preventDefault(),this.editing=!1,!this.editable)return;const t=this.renderRoot.querySelector("#titleEdit");if(!t||!t.value.trim())return;const i=t.value,a=JSON.stringify({title:i});fetch(`${this.collInfo.apiPrefix}/metadata`,{method:"POST",body:a}).then((e=>{200===e.status&&this.dispatchEvent(new CustomEvent("coll-update",{detail:{title:i}}))}))}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",(()=>{this.menuActive=!1}),{once:!0})}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key")||"";t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedPages=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onSelectToggle(e){const{page:t,selected:i}=e.detail;i?this.selectedPages.add(t):this.selectedPages.delete(t),this.allSelected=this.selectedPages.size===this.sortedPages.length,this.requestUpdate()}onSelectAll(e){this.allSelected=e.currentTarget.checked,this.allSelected?this.sortedPages.forEach((e=>{this.selectedPages.add(e.id)})):this.selectedPages.clear(),this.requestUpdate()}async onDownload(e,t){e.preventDefault();const i=this.selectedPages.size>0,a=new URLSearchParams;a.set("pages",i?Array.from(this.selectedPages.keys()).join(","):"all"),a.set("format",t),this.collInfo.filename&&a.set("filename",this.collInfo.filename),window.location.href=`${this.collInfo.apiPrefix}/dl?`+a.toString()}onDeleteConfirm(e){const t=e.currentTarget.page;this.selectedPages.has(t.id)?(this.toDeletePages=this.selectedPages,this.toDeletePage=null):(this.toDeletePages=[t.id],this.toDeletePage=t)}async onDeletePages(){const e={};for(const t of this.toDeletePages){const i=this.renderRoot.querySelector(`wr-page-entry[pid="${t}"]`);i&&(i.deleting=!0,e[t]=i)}for(const t of this.toDeletePages){const i=await fetch(`${this.collInfo.apiPrefix}/page/${t}`,{method:"DELETE"}),a=await i.json();if(a.error){console.warn(a.error);continue}const r=e[t];if(!r)continue;const o=this.collInfo.pages.indexOf(r);o<0||this.collInfo.pages.splice(o,1)}this.toDeletePages=null,this.toDeletePage=null,this.updateTextSearch(),this.requestUpdate()}formatResults(){if(!this.query){const e=this.filteredPages.length;return e===this.sortedPages.length?`${e} Page${1!==e?"s":""}`:`${this.sortedPages.length} of ${e} Pages Shown`}return 1===this.sortedPages.length?"1 Page":`${this.sortedPages.length} Pages`}getNoResultsMessage(){return this.collInfo&&this.collInfo.pages.length?this.updatingSearch?"Initializing Search...":this.loading?"Searching...":this.query?N`<span class="fix-text-wrapping"
      ...
      ${ta.sidebarStyles(o`:host(.sidebar)`)}
    ...
    `}updated(e){(e.has("page")||e.has("query"))&&(this.updateSnippet(),this.iconValid=!!this.page.favIconUrl,this.deleting=!1)}render(){const e=this.page,t=this.page.date,i="number"==typeof e.size,a=this.editable&&!this.isSidebar;return N`
      ${a?N` <div class="check-select">
            <label class="checkbox">
              <input
          ...
          <div class="media">
            ...
            <div class="media-content ${this.isCurrent?"current":""}">
              <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
                ...
                ${this.textSnippet?N` <div class="text">
                      <keyword-mark keywords="${this.query}"
                        >${this.textSnippet}</keyword-mark
                      >
                    </div>`:N``}
              </div>
              ${i?N` <div class="media-right" style="margin-right: 2em">
                    ${je()(e.size)}
                  </div>`:""}
            </div>
          </div>
    ...
    `)}render(){const e=`Replay of ${this.title?`${this.title}:`:""} ${this.url}`;return N` <h1 id="replay-heading" class="is-sr-only">${e}</h1>
    ...
    `)}render(){return N`
      ${this.paramString&&this.hashString&&this.inited?N`
            <iframe
              sandbox="${(e=>null!=e?e:F)(this.sandbox?"allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms":void 0)}"
              @load="${this.onLoad}"
          ...
          `:N``}
      ${this.errorMessage}
    `}onLoad(e){if(this.isCrossOrigin)return;const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get(this.mainElementName))return;const a=i.createElement("script");a.src=na,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",ca)}();var da=__webpack_require__(5111),ha=__webpack_require__.n(da),pa=__webpack_require__(504),ua=__webpack_require__.n(pa),fa=__webpack_require__(6420),ba=__webpack_require__.n(fa);class ma extends ti{constructor(){super(),this._sizeUpdater=null,this.totalSize=0}static get properties(){return{...ti.properties,totalSize:{type:Number},shareOpts:{type:Object}}}static get styles(){return ye(ma.compStyles)}static get compStyles(){return s`
    .rec-button {
      display: flex;
      flex-direction: row;
      margin: 0 1px;
    ...
    `}updated(e){e.has("embed")&&this.embed&&!this._sizeUpdater&&(this._sizeUpdater=this.runSizeUpdater()),super.updated(e)}async runSizeUpdater(){try{for(;this.embed;){if(this.coll){const e=await fetch(`./w/api/c/${this.coll}`),t=await e.json();this.totalSize=t.size||0}await new Promise((e=>setTimeout(e,3e3)))}}finally{this._sizeUpdater=null}}renderExtraToolbar(e=!1){return this.embed?e?N`
        <a href="${xe}/c/${this.coll}/dl?format=wacz&pages=all" role="button" class="dropdown-item" @keyup="${_e}">
          <span class="icon is-small">
        ...
        <span class="rec-button" title="Archiving">
          <span class="icon is-small" title="Archiving">
            <fa-icon size="1.2em" aria-hidden="true" .svg="${ba()}"></fa-icon>
          </span>
          <span class="size-label">${je()(this.totalSize)}</span>
        </span>
        `:e?"":N`
    <a href="#" role="button"
    class="${e?"dropdown-item is-hidden-tablet":"button narrow is-borderless"}"
      ...
      @click="${this.onShowStart}" @keyup="${_e}">
      <span class="icon is-small">
        <fa-icon size="1.2em" aria-hidden="true" .svg="${ba()}"></fa-icon>
      </span>
    </a>`}renderCollInfo(){return console.log(this.collInfo),N`
    <div class="info-bg">
      <wr-rec-coll-info
      class="is-list"
      .coll="${this.collInfo}"
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){if(this.embed)return;const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}customElements.define("wr-rec-coll",ma);var ga=__webpack_require__(7050),va=__webpack_require__.n(ga),wa=__webpack_require__(1294),xa=__webpack_require__.n(wa),ka=__webpack_require__(4688),ya=__webpack_require__.n(ka),$a=__webpack_require__(7087),Sa=__webpack_require__.n($a),_a=__webpack_require__(9671),za=__webpack_require__.n(_a),Ca=__webpack_require__(9696),Ia=__webpack_require__.n(Ca);class Aa extends Xe{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgressSize=0,this.shareProgressTotalSize=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgressSize:{type:Number},shareProgressTotalSize:{type:Number},isUploadNeeded:{type:Boolean},shareOpts:{type:Object},btrixOpts:{type:Object},ipfsOpts:{type:Object}}}static get styles(){return ye(Aa.compStyles)}static get compStyles(){return s`
    :host {
      overflow: visible;
    }
    ...
    ${Xe.compStyles}
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1)),this.isUploadNeeded=this.coll&&this.coll.uploadTime&&this.coll.mtime>this.coll.uploadTime}updated(e){if(e.has("shareOpts")&&this.shareOpts){const{ipfsOpts:e,btrixOpts:t}=this.shareOpts;this.ipfsOpts=e,this.btrixOpts=t}e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url),this.isUploadNeeded=this.coll&&this.coll.uploadTime&&this.coll.mtime>this.coll.uploadTime)}render(){const e=this.coll,t=this.detailed,i=!!this.btrixOpts,a=!!this.ipfsOpts&&this.ipfsOpts.daemonUrl;return N`
      <div class="columns">
        <div class="column is-2">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <a href="${xe}/c/${this.coll.id}/dl?format=wacz&pages=all" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${lt()}"></fa-icon>
              </span>
            </a>
            <button @click="${this.onShowImport}" class="button is-small" title="Import File">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${Fe()}"></fa-icon>
              </span>
            </button>
            <button @click="${this.onShowStart}" class="button is-small" title="Start Archiving">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${ba()}"></fa-icon>
              </span>
            </button>
          </div>
        </div>
      ...
      `}renderIPFSSharing(){return this.ipfsURL?N`
          ...
          <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
            <div class="dropdown-content">
              ...
              <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                <span class="icon is-small">
                  <fa-icon size="0.8em" .svg="${ya()}"></fa-icon>
                </span>
                Copy IPFS URL
              </a>
      ...
      <div class="is-flex is-flex-direction-column">
        <button class="button is-small ${this.shareWait?"is-loading":""}" @click="${this.onPinOrWarn}">
          <span class="icon is-small">
            <fa-icon .svg="${ya()}"></fa-icon>
          </span>
          <span>Start</span>
        </button>
        <progress value="${this.shareProgressSize}" max="${this.shareProgressTotalSize}" class="progress is-small ${this.shareProgressTotalSize?"mini":"is-hidden"}"></progress>
      </div>
    `}renderBtrixUpload(){const{uploadId:e,uploadTime:t}=this.coll;return N`
    <div class="is-flex is-flex-direction-column">
      <button @click="${this.onUpload}" class="button is-small" title="Upload to Cloud">
        <span class="icon">
        ${t&&e?this.isUploadNeeded?N`
          <fa-icon aria-hidden="true" class="has-text-warning-dark" .svg="${vt()}"></fa-icon>
          `:N`
          <fa-icon aria-hidden="true" class="has-text-success" .svg="${va()}"></fa-icon>
          `:N`
          <fa-icon aria-hidden="true" size="2.2em" .svg="${Ia()}"></fa-icon>
          `}
        </span>
      </button>
    </div>
    `}renderShareWarn(){return N`
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${je()(this.deleteConfirm.size)}</b>)</p>
      ...
      title="Upload To Browsertrix">
        <table class="is-size-6" style="margin-left: 3.0rem">
          ...
          <tr class="is-italic">
            ...
            <td>${je()(this.coll.size)}</td>
          </tr>
          ${this.actualSize?N`
          <tr class="is-italic">
            <td class="has-text-right pr-4">Uploaded Size:</td>
            <td>${je()(this.actualSize)}</td>
          </tr>`:""}
          ${e?N`
          <tr class="is-italic">
          ...
          <tr class="is-italic">
            ...
            <fa-icon aria-hidden="true" class="" size="0.7em" .svg="${Ea()}"></fa-icon>
          ...
          <div class="message-body">
            <div class="buttons">
              ...
              <button class="button is-small no-pad-mobile" title="Start Archiving" ?disabled="${!this.colls}" @click="${this.onShowStart}">
                <span class="icon">
                  <fa-icon size="1.0em" aria-hidden="true" .svg="${ba()}"></fa-icon>
                </span>
                <span class="is-hidden-mobile">Start Archiving</span>
              </button>
              <div class="rightbar">
                <div class="infomsg is-hidden-mobile">The ArchiveWeb.page ${$e?"App":"Extension"} allows you to archive webpages directly in your browser!</div>
    ...
    ${super.render()}`}renderColl(){return N`
    <wr-rec-coll 
    .editable="${!0}"
    ...
    @show-import=${this.onShowImport}
    @do-upload=${e=>this.uploadCollOpts=e.detail}
    @about-show=${()=>this.showAbout=!0}></wr-rec-coll>`}renderCollList(e=""){return N`
    <div class="dropdown-row">
      <span>${e}&nbsp;</span>
      <div class="select is-small">
        <select @change="${this.onSelectColl}">
        ${this.colls&&this.colls.map((e=>N`
          <option value="${e.id}"
    ...
    </wr-modal>`}renderNewCollModal(){return N`
    ...
    </wr-modal`}renderImportModal(){return N`
    ...
    </wr-modal`}renderIPFSShareFailedModal(){return N`
    ...
    </wr-modal`}renderBtrixUploadModal(){return N`
      <wr-btrix-upload
      .btrixOpts=${this.btrixOpts}
      .uploadColl=${this.uploadCollOpts}
      >
      </wr-btrix-upload>`}renderDownloadModal(){return N`
    <wr-modal .noBgClose=${!0} style="--modal-width: 740px" @modal-closed="${()=>this.showDownloadProgress=!1}" title="Download Progress">
            ...
            <section class="modal-card-body">
              <div class="container">
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      <fa-icon class="logo" size="48px" .svg="${Pa()}"></fa-icon>
                      <div style="font-size: smaller; margin-bottom: 1em">${this.getDeployType()} v${Sr}</div>
                    </div>
      ...
      </div>`}renderSettingsModal(){return N`
    <wr-modal @modal-closed="${this.onCancelSettings}" title="Settings">
      ...
      <form class="is-flex is-flex-direction-column is-size-7" @submit="${this.onSaveSettings}">
        ...
        ${"browsertrix"===this.settingsTab?N`
        ...
        <fieldset>
          <div class="field has-addons">
            <p class="is-expanded">
              Browsertrix URL:
              <input class="input is-small" type="url"
              name="btrixUrl" id="btrixUrl" value="${this.btrixOpts&&this.btrixOpts.url||zr}"
              placeholder="${zr}">
            </p>
          </div>
          <div class="field has-addons">
