 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function r(e){let t=n.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},n.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const r=e.strings.join(a.f);return i=t.keyString.get(r),void 0===i&&(i=new a.a(e,e.getTemplateElement()),t.keyString.set(r,i)),t.stringsArray.set(e.strings,i),i}const n=new Map},14:function(e,t,i){"use strict";i.d(t,"a",(function(){return o})),i.d(t,"b",(function(){return s}));var a=i(7),r=i(4),n=i(13);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const o=new WeakMap,s=(e,t,i)=>{let s=o.get(t);void 0===s&&(Object(a.b)(t,t.firstChild),o.set(t,s=new r.e(Object.assign({templateFactory:n.b},i))),s.appendInto(t)),s.setValue(e),s.commit()}},15:function(e,t,i){"use strict";i.d(t,"a",(function(){return r})),i.d(t,"b",(function(){return n}));
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const o=new WeakMap,s=Object(n.d)(e=>t=>{if(!(t instanceof n.a)||t instanceof n.c||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=o.get(t);void 0===r&&(a.cssText=i.strings.join(" "),o.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var l=i(218),c=i.n(l),d=i(208),h=i.n(d);const f=Object(a.d)(c.a);function b(e){return[f,e]}const u=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;function p(e){" "==e.key&&(e.preventDefault(),e.target.click())}class m extends a.a{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return a.b`
    :host {
    ...
    <div class="search-bar notification is-marginless">
      ...
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading?"is-loading":""}">
          ...
          <span class="icon is-left"><fa-icon .svg="${D.a}" aria-hidden="true"></fa-icon></span>
        </div>
      </div>
    </div>
    ...
    <button @click=${e=>this.sortDesc=!this.sortDesc} class="button is-small">
      ...
      <span class="icon"><fa-icon aria-hidden="true" .svg=${this.sortDesc?W.a:H.a}></span>
        ...
        <div class="level-item flex-auto">
          ...
          <div class="field flex-auto">
            <div class="control has-icons-left ${this.loading?"is-loading":""}">
              ...
              <span class="icon is-left"><fa-icon .svg="${D.a}"/></span>
            </div>
          </div>
        </div>
      </div>
 ...
 */const J=new WeakMap,Y=Object(n.d)(e=>t=>{if(!(t instanceof n.b))throw new Error("unsafeHTML can only be used in text bindings");const i=J.get(t);if(void 0!==i&&Object(Z.h)(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),J.set(t,{value:e,fragment:r})});var Q=i(225),X=i.n(Q),ee="undefined"!=typeof window?window:null,te=null===ee,ie=te?void 0:ee.document,ae=function(){return!1},re=te?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=ie.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",ne=function(e){return"string"==typeof e||e instanceof String},oe=function(e){if(ne(e)){var t=ie.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},se=function(e,t,i){var a=e[t];return void 0!==a?a:i},le=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},ce=function(e,t){var i=ie.createElement("div");return i.className="gutter gutter-"+t,i},de=function(e,t,i){var a={};return ne(t)?a[e]=t:a[e]=re+"("+t+"% - "+i+"px)",a},he=function(e,t){var i;return(i={})[e]=t+"px",i},fe=function(e,t){if(void 0===t&&(t={}),te)return{};var i,a,r,n,o,s,l=e;Array.from&&(l=Array.from(l));var c=oe(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,f=se(t,"sizes")||l.map((function(){return 100/l.length})),b=se(t,"minSize",100),u=Array.isArray(b)?b:l.map((function(){return b})),p=se(t,"expandToMin",!1),m=se(t,"gutterSize",10),g=se(t,"gutterAlign","center"),v=se(t,"snapOffset",30),w=se(t,"dragInterval",1),x=se(t,"direction","horizontal"),k=se(t,"cursor","horizontal"===x?"col-resize":"row-resize"),y=se(t,"gutter",ce),S=se(t,"elementStyle",de),$=se(t,"gutterStyle",he);function z(e,t,a,r){var n=S(i,t,a,r);Object.keys(n).forEach((function(t){e.style[t]=n[t]}))}function _(){return s.map((function(e){return e.size}))}function C(e){return"touches"in e?e.touches[0][a]:e[a]}function T(e){var t=s[this.a],i=s[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,z(t.element,t.size,this._b,t.i),z(i.element,i.size,this._c,i.i)}function L(e){var i,a=s[this.a],r=s[this.b];this.dragging&&(i=C(e)-this.start+(this._b-this.dragOffset),w>1&&(i=Math.round(i/w)*w),i<=a.minSize+v+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+v+this._c)&&(i=this.size-(r.minSize+this._c)),T.call(this,i),se(t,"onDrag",ae)(_()))}function P(){var e=s[this.a].element,t=s[this.b].element,a=e.getBoundingClientRect(),o=t.getBoundingClientRect();this.size=a[i]+o[i]+this._b+this._c,this.start=a[r],this.end=a[n]}function D(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[o];return 0===i?null:i-="horizontal"===x?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(u.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,n){var o=t*r/100,s=le(m,0===n,n===e.length-1,g),l=u[n]+s;return o<l?(i+=l-o,a.push(0),l):(a.push(o-l),o)}));return 0===i?e:r.map((function(e,r){var n=e;if(i>0&&a[r]-i>0){var o=Math.min(i,a[r]-i);i-=o,n=e-o}return n/t*100}))}function A(){var e=s[this.a].element,i=s[this.b].element;this.dragging&&se(t,"onDragEnd",ae)(_()),this.dragging=!1,ee.removeEventListener("mouseup",this.stop),ee.removeEventListener("touchend",this.stop),ee.removeEventListener("touchcancel",this.stop),ee.removeEventListener("mousemove",this.move),ee.removeEventListener("touchmove",this.move),this.stop=null,this.move=null,e.removeEventListener("selectstart",ae),e.removeEventListener("dragstart",ae),i.removeEventListener("selectstart",ae),i.removeEventListener("dragstart",ae),e.style.userSelect="",e.style.webkitUserSelect="",e.style.MozUserSelect="",e.style.pointerEvents="",i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",this.gutter.style.cursor="",this.parent.style.cursor="",ie.body.style.cursor=""}function E(e){if(!("button"in e&&0!==e.button)){var i=s[this.a].element,a=s[this.b].element;this.dragging||se(t,"onDragStart",ae)(_()),e.preventDefault(),this.dragging=!0,this.move=L.bind(this),this.stop=A.bind(this),ee.addEventListener("mouseup",this.stop),ee.addEventListener("touchend",this.stop),ee.addEventListener("touchcancel",this.stop),ee.addEventListener("mousemove",this.move),ee.addEventListener("touchmove",this.move),i.addEventListener("selectstart",ae),i.addEventListener("dragstart",ae),a.addEventListener("selectstart",ae),a.addEventListener("dragstart",ae),i.style.userSelect="none",i.style.webkitUserSelect="none",i.style.MozUserSelect="none",i.style.pointerEvents="none",a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",this.gutter.style.cursor=k,this.parent.style.cursor=k,ie.body.style.cursor=k,P.call(this),this.dragOffset=C(e)-this.end}}"horizontal"===x?(i="width",a="clientX",r="left",n="right",o="clientWidth"):"vertical"===x&&(i="height",a="clientY",r="top",n="bottom",o="clientHeight"),f=D(f);var I=[];function R(e){var t=e.i===I.length,i=t?I[e.i-1]:I[e.i];P.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;T.call(i,a)}return(s=l.map((function(e,t){var a,r={element:oe(e),size:f[t],minSize:u[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:x,parent:c})._b=le(m,t-1==0,!1,g),a._c=le(m,!1,t===l.length-1,g),"row-reverse"===h||"column-reverse"===h)){var n=a.a;a.a=a.b,a.b=n}if(t>0){var o=y(t,x,r.element);!function(e,t,a){var r=$(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(o,m,t),a._a=E.bind(a),o.addEventListener("mousedown",a._a),o.addEventListener("touchstart",a._a),c.insertBefore(o,r.element),a.gutter=o}return z(r.element,r.size,le(m,0===t,t===l.length-1,g),t),t>0&&I.push(a),r}))).forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(p?R(e):e.minSize=t)})),{setSizes:function(e){var t=D(e);t.forEach((function(e,i){if(i>0){var a=I[i-1],r=s[a.a],n=s[a.b];r.size=t[i-1],n.size=e,z(r.element,r.size,a._b,r.i),z(n.element,n.size,a._c,n.i)}}))},getSizes:_,collapse:function(e){R(s[e])},destroy:function(e,t){I.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=S(i,a.a.size,a._b);Object.keys(r).forEach((function(e){s[a.a].element.style[e]="",s[a.b].element.style[e]=""}))}}))},parent:c,pairs:I}};class be extends a.a{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=fe([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const e of this.collInfo.curatedPages){this.curatedPageMap[e.list]||(this.curatedPageMap[e.list]=[]);const t=e,i=t.url,a=t.ts,r=t.title||t.url,n=e.desc;this.curatedPageMap[e.list].push({url:i,ts:a,title:r,desc:n})}this.scrollToList()}static get styles(){return b(a.b`
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Y(X()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return a.c`
      ...
      <div class="panel is-light">
        ...
        <div class="panel-block sort-header is-small">
          <div class="control has-icons-left">
            ...
            <span class="icon is-left is-small"><fa-icon .svg="${D.a}"/></span>
          </div>
          <wr-sorter id="index"
          sortKey="ctime"
          ?sortDesc="${!0}"
    ...
    `}renderCollInfo(e){return a.c`<wr-coll-info .coll=${e}></wr-coll-info>`}}class ye extends a.a{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return b(a.b`
    .columns {
      width: 100%;
    }
    .column {
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${u?"App":""} v${"0.4.0"}</div>
                    </div>
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${p}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${Ye.a}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"story"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#story" class="is-size-6" aria-label="Story" aria-current="${"story"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${De.a}" aria-hidden="true" title="Story"></fa-icon></span>
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        ...
        <a href="#" role="button" class="button narrow is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" id="refresh" @click="${this.onRefresh}" @keyup="${p}"
          ...
          <span class="icon is-small">
            ${this.isLoading?"":a.c`
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Ge.a}"></fa-icon>
            `}
          </span>
        </a>
          ...
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              ...
              <a href="#" role="button" class="dropdown-item" @click="${this.onAbout}">
                ...
                <span class="menu-version">(${"0.4.0"})</span>
              </a>
            </div>
          </div>
        </div>
    ...
    `}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-replay-target").focus()}onKeyDown(e){"Esc"!==e.key&&"Escape"!==e.key||(e.preventDefault(),e.currentTarget.value=this.url)}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",()=>{this.menuActive=!1},{once:!0})}onFullscreenToggle(e){e.preventDefault(),this.menuActive=!1,this.isFullscreen?document.exitFullscreen():this.requestFullscreen()}onGoBack(e){e.preventDefault(),this.menuActive=!1,window.history.back()}onGoForward(e){e.preventDefault(),this.menuActive=!1,window.history.forward()}onShowPages(e){e.preventDefault(),this.showSidebar||document.documentElement.clientWidth>=769?this.showSidebar=!this.showSidebar:(this.showSidebar=!1,this.updateTabData({url:"",ts:""}))}onFullPageView(e){e.preventDefault(),this.updateTabData({url:"",ts:""})}onHideSidebar(e){e.preventDefault(),this.showSidebar=!1}async onFavIcons(e){for(const t of e.detail.icons){const e=await fetch(t.href);if(200===e.status){const i=e.headers.get("Content-Type");if(i&&!i.startsWith("text/"))return void(this.favIconUrl=t.href)}}this.favIconUrl=""}onPurgeCache(e){e.preventDefault();const t=!e.detail||void 0===e.detail.reload||e.detail.reload;this.deleteFully(t)}async deleteFully(e=!1){const t=this.collInfo.apiPrefix+(e?"?reload=1":""),i=await fetch(t,{method:"DELETE"});200!==i.status&&console.warn("purge failed: "+i.status),e||this.embed?(window.location.hash="",window.location.reload()):window.location.search=""}onSubmit(e){e.preventDefault();const t=this.renderRoot.querySelector("input");return t.value?this.navigateTo(t.value):t.value=this.url,!1}onLostFocus(e){e.currentTarget.value||(e.currentTarget.value=this.url)}navigateTo(e){let t;if(e.startsWith("http://")||e.startsWith("https://")){if(t={url:e},e===this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");return void(e&&e.refresh())}}else t=e.startsWith("search://")?this._stringToParams(e):{query:e,view:"pages"};this.updateTabData(t)}_stringToParams(e){const t=new URLSearchParams(e.slice("search://".length)),i={url:"",ts:""};for(const e of["query","view","currList","currMime","urlSearchType"])t.has(e)&&(i[e]=t.get(e));return i}_paramsToString(e){const t=new URLSearchParams;for(const i of["query","view","currList","currMime","urlSearchType"])i in e&&t.set(i,e[i]);return t.toString()}onRefresh(e){if(e&&e.preventDefault(),this.menuActive=!1,this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.refresh()}else window.location.reload()}onAbout(){this.dispatchEvent(new CustomEvent("about-show"))}}customElements.define("wr-coll",et);var tt=i(238),it=i.n(tt),at=i(109),rt=i.n(at),nt=i(215),ot=i.n(nt),st=i(239),lt=i.n(st),ct=i(110),dt=i.n(ct),ht=i(240),ft=i.n(ht),bt=i(67),ut=i.n(bt);i.d(t,"ArchiveWebApp",(function(){return pt}));class pt extends Le{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[]}get appName(){return"ArchiveWeb.page"}get homeUrl(){return"/replay/index.html"}static get properties(){return{...Le.properties,recordShown:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String}}}initRoute(){this.inited=!0;const e=new URLSearchParams(window.location.search);this.sourceUrl=e.get("source")||""}getLoadInfo(e){return{customColl:e.startsWith("local://")?e.slice("local://".length):e}}static get styles(){return b(pt.appStyles)}static get appStyles(){return b(a.b`
      ...
      ${Le.appStyles}
    `)}get mainLogo(){return ft.a}renderNavEnd(){return a.c``}renderNavBrand(){return a.c`
      <span id="home" class="logo-text has-text-weight-bold is-size-6 has-allcaps wide-only">
    ...
    <div class="recorder modal is-active">
      <div class="modal-background" @click="${e=>this.recordShown=!1}"></div>
      <div class="modal-card">
        <header class="modal-card-head">
          <p class="modal-card-title is-3">Start Recording</p>
          <button class="delete" aria-label="close" @click="${e=>this.recordShown=!1}"></button>
        </header>
        <section class="modal-card-body" @click="${e=>this.showCollDrop=!1}">
            ...
            <div class="field has-addons">
              ...
              <div class="control">
                <button type="submit" class="button is-hidden-mobile is-outlined is-link">
                  <span class="icon">
                    <fa-icon size="1.0em" aria-hidden="true" .svg="${ut.a}"></fa-icon>
                  </span>
                  <span>Go!</span>
                </button>
              </div>
    ...
    </div>`}async onShowDrop(e){const t=await fetch("./wabac/api/index"),i=await t.json();this.colls=i.colls,this.showCollDrop=!0,e.stopPropagation()}async onNewColl(e){const t=this.renderRoot.querySelector("#new-name").value,i=JSON.stringify({metadata:{title:t}}),a=await fetch("./wabac/api/create",{method:"POST",body:i}),r=await a.json();console.log(r)}onSelectColl(e){this.selCollId=e.currentTarget.getAttribute("data-id"),this.selCollTitle=e.currentTarget.getAttribute("data-title"),this.showCollDrop=!1}onShowStart(e){this.selCollId=e.detail.coll,this.selCollTitle=e.detail.title,this.recordShown=!0}onStartRecord(e){e.preventDefault();const t=this.renderRoot.querySelector("#url").value;return this.recordShown=!1,self.chrome&&self.chrome.runtime?chrome.runtime.sendMessage({msg:"startNew",url:t,collId:this.selCollId}):window.webrecorder&&window.webrecorder.record&&window.webrecorder.record(t),!1}}class mt extends a.a{constructor(){super(),this.detailed=!1,this.ipfsURL=null}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String}}}static get styles(){return b(a.b`
    .columns {
      width: 100%;
    }
    .column {
    ...
    `)}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed;return a.c`
        ...
        <div class="column is-1">
          ...
          <div class="button-row is-flex">
            <button @click="${this.onShowStart}" class="button is-small" title="Start Recording...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${ut.a}"></fa-icon>
              </span>
              <span>Start...</span>
            </button>
          </div>
        ...
        <div class="column is-size-7">
          ...
          <div class="button-row is-flex">
            ...
            <button class="button is-small" @click="${this.onPin}">
              <span class="icon is-small">
                <fa-icon .svg="${this.ipfsURL?lt.a:ot.a}"></fa-icon>
              </span>
      ...
      `}onShowStart(e){const t=this.coll.id,i=this.coll.title;this.dispatchEvent(new CustomEvent("show-start",{bubbles:!0,composed:!0,detail:{coll:t,title:i}}))}async onPin(){const e=await fetch(`./wabac/api/${this.coll.id}/ipfs/pin`,{method:"POST"}),t=await e.json();t.ipfsURL&&(this.ipfsURL=t.ipfsURL),this.onCopyLink(event)}async onUnpin(){const e=await fetch(`./wabac/api/${this.coll.id}/ipfs/unpin`,{method:"POST"});(await e.json()).removed&&(this.ipfsURL=null)}onCopyLink(e){e.preventDefault(),e.stopPropagation();const t=new URLSearchParams;t.set("source",this.ipfsURL);const i="https://replayweb.page/?"+t.toString();navigator.clipboard.writeText(i)}}customElements.define("wr-rec-coll",class extends et{renderExtraToolbar(e=!1){return e?"":a.c`
    <a href="#" role="button"
    class="${e?"dropdown-item is-hidden-tablet":"button narrow is-borderless"}"
      ...
      <span class="icon is-small">
        <fa-icon size="1.2em" aria-hidden="true" .svg="${ut.a}"></fa-icon>
      </span>
    ...
    <div class="info-bg">
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){const e=this.coll,t=this.collInfo.title;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t}}))}}),customElements.define("wr-rec-coll-index",class extends ke{renderCollInfo(e){return a.c`<wr-rec-coll-info .coll=${e}></wr-rec-coll-info>`}}),customElements.define("wr-rec-coll-info",mt),customElements.define("archive-web-page-app",pt)},3:function(e,t,i){"use strict";i.d(t,"f",(function(){return a})),i.d(t,"g",(function(){return r})),i.d(t,"b",(function(){return o})),i.d(t,"a",(function(){return s})),i.d(t,"d",(function(){return c})),i.d(t,"c",(function(){return d})),i.d(t,"e",(function(){return h}));
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const o=new WeakMap,s=Object(n.d)(e=>t=>{if(!(t instanceof n.b))throw new Error("unsafeSVG can only be used in text bindings");const i=o.get(t);if(void 0!==i&&Object(r.h)(e)&&e===i.value&&t.value===i.fragment)return;const s=document.createElement("template");s.innerHTML=`<svg>${e}</svg>`;const l=s.content,c=l.firstChild;l.removeChild(c),Object(a.c)(l,c.firstChild);const d=document.importNode(l,!0);t.setValue(d),o.set(t,{value:e,fragment:d})})},6:function(e,t,i){"use strict";i.d(t,"a",(function(){return a})),i.d(t,"b",(function(){return r}));
/**
 * @license
 * Copyright (c) 2018 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
