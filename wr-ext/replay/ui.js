...
const s=Object(n.c)(class extends n.a{constructor(e){var t;if(super(e),e.type!==n.b.ATTRIBUTE||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ut){this.ut=new Set;for(const e in t)this.ut.add(e);return this.render(t)}this.ut.forEach(e=>{null==t[e]&&(this.ut.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")});for(const e in t){const a=t[e];null!=a&&(this.ut.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return o.b}});var l=i(211),c=i.n(l),d=i(167),u=i.n(d);const h=Object(a.d)(c.a);function f(e){return[h,e]}const b=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,p=__VERSION__;function m(e){" "==e.key&&(e.preventDefault(),e.target.click())}class g extends a.a{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return a.b`
    ...
    </div>`}onClose(){this.dispatchEvent(new CustomEvent("modal-closed"))}}customElements.define("fa-icon",g),customElements.define("wr-anim-logo",class extends g{constructor(){super(),this.svg=u.a}static get styles(){return a.b`
    #wrlogo #stop5687 {
    ...
    `}}),customElements.define("wr-modal",v);var w;function x(e,t){void 0===t&&(t={});var i=t.registrationOptions;void 0===i&&(i={}),delete t.registrationOptions;var a=function(e){for(var i=[],a=arguments.length-1;a-- >0;)i[a]=arguments[a+1];t&&t[e]&&t[e].apply(t,i)};"serviceWorker"in navigator&&w.then((function(){Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))?(!function(e,t,i){fetch(e).then((function(a){404===a.status?(t("error",new Error("Service worker not found at "+e)),D()):-1===a.headers.get("content-type").indexOf("javascript")?(t("error",new Error("Expected "+e+" to have javascript content-type, but received "+a.headers.get("content-type"))),D()):y(e,t,i)})).catch((function(e){return k(t,e)}))}(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return k(a,e)}))):(y(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return k(a,e)})))}))}function k(e,t){navigator.onLine||e("offline"),e("error",t)}function y(e,t,i){navigator.serviceWorker.register(e,i).then((function(e){t("registered",e),e.waiting?t("updated",e):e.onupdatefound=function(){t("updatefound",e);var i=e.installing;i.onstatechange=function(){"installed"===i.state&&(navigator.serviceWorker.controller?t("updated",e):t("cached",e))}}})).catch((function(e){return k(t,e)}))}function D(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then((function(e){e.unregister()})).catch((function(e){return k(emit,e)}))}function $(e="sw.js",t="./"){let i,a;const r=new Promise((e,t)=>{i=e,a=t});if(!navigator.serviceWorker){const e="Sorry, ReplayWeb.page won't work in this browser as Service Workers are not supported.\nPlease try a different browser.\n(Service Workers are disabled in Firefox in Private Mode. If Using Private Mode in Firefox, try regular mode)";console.error(e),a(e)}return x(t+e,{registrationOptions:{scope:t},registered(){console.log("Service worker is registered"),i()},error(e){console.error("Error during service worker registration:",e),a("ReplayWeb.page could not be loaded due to the following error:\n"+e.toString())}}),r}"undefined"!=typeof window&&(w="undefined"!=typeof Promise?new Promise((function(e){return window.addEventListener("load",e)})):{then:function(e){return window.addEventListener("load",e)}});function S(e){let t=null;try{t=new Date(e.ts||e.date)}catch(e){}const i=t&&!isNaN(t)?C(t.toISOString()):"";return{date:t,timestamp:i}}function C(e){return e.replace(/[-:T]/g,"").slice(0,14)}function A(e,t,i){const a=new URLSearchParams;return a.set("view",e),a.set("url",t),a.set("ts",i),"#"+a.toString()}async function z(e){return{url:e,coll:"id-"+(await async function(e,t){const i=(new TextEncoder).encode(e),a=await crypto.subtle.digest(t,i);return Array.from(new Uint8Array(a)).map(e=>e.toString(16).padStart(2,"0")).join("")}(e,"SHA-256")).slice(0,12)}}var E=i(104),F=i.n(E),_=i(97),B=i.n(_),I=i(98),L=i.n(I);class T extends a.a{constructor(e="sw.js"){super(),this.sourceUrl=null,this.collTitle=null,this.showAbout=!1,this.pageParams=new URLSearchParams,this.inited=!1,this.navMenuShown=!1,this.collPageUrl="",this.pageTitle="",this.pageReplay=!1,this.loadInfo=null,e&&$(e),this.safariKeyframes()}get appName(){return"ReplayWeb.page"}get homeUrl(){return window.location.pathname}static get properties(){return{inited:{type:Boolean},pageParams:{type:Object},sourceUrl:{type:String},navMenuShown:{type:Boolean},showAbout:{type:Boolean},collTitle:{type:String},loadInfo:{type:Object},embed:{type:String},collPageUrl:{type:String},pageTitle:{type:String},pageReplay:{type:Boolean},source:{type:String}}}static get styles(){return f(T.appStyles)}static get appStyles(){return a.b`
    #wrlogo {
      max-height: 1.0rem;
    }
    .navbar {
    ...
    <nav class="navbar has-background-info" aria-label="main">
      <div class="navbar-brand">
        ...
        `:a.c`
          ...
          `:""}
          `}
        <a href="#" role="button" id="menu-button" @click="${this.onNavMenu}" @keyup="${m}"
      ...
      <div class="navbar-menu ${this.navMenuShown?"is-active":""}">
        <div class="navbar-start">
          ${b?a.c`
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Back" @click="${()=>window.history.back()}" @keyup="${m}">
              <fa-icon size="1.0rem" .svg="${B.a}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Back</span>
            </a>
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${m}">
              <fa-icon size="1.0rem" .svg="${L.a}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?a.c``:a.c`
    ...
    <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return a.c`
      ...
      <fa-icon .svg="${F.a}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
    </a>
    <!--
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${b?"App":""} v${p}</div>
                    </div>
  ...
  `)}render(){return a.c`
            ...
            <label class="file-label">
              ...
              <span class="file-cta" @click="${this.onChooseNativeFile}">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${R.a} aria-hidden="true"></fa-icon>
                </span>
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        ...
        <button @click=${()=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?W.a:q.a}></span>
    ...
    `}renderCollInfo(e){return a.c`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return a.c`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Y extends a.a{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return f(Y.compStyles)}static get compStyles(){return a.b`
    .columns {
      width: 100%;
    }
    .column {
    ...
    `}render(){const e=this.coll,t=this.detailed;return a.c`
      <div class="columns">
        ...
        <div class="column is-4">
          ...
          ${e.sourceUrl&&(e.sourceUrl.startsWith("http://")||e.sourceUrl.startsWith("https://"))?a.c`
          <a href="${e.sourceUrl}">${e.sourceUrl}&nbsp;</a>`:a.c`
          ${e.sourceUrl}&nbsp;`}
          </span>
        ...
        <div class="column is-2"><p class="minihead">Total Size</p>${j()(Number(e.size||0))}</div>
      ...
      </div>`}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}onPurge(e){const t={reload:e};this.dispatchEvent(new CustomEvent("coll-purge",{detail:t}))}}customElements.define("wr-coll-info",Y),customElements.define("wr-coll-index",Z);var Q=i(214),J=i.n(Q),X=i(106),ee=i.n(X),te=i(168),ie=i.n(te),ae=i(215),re=i.n(ae),oe=i(216),ne=i.n(oe),se=i(217),le=i.n(se),ce=i(218),de=i.n(ce),ue=i(169),he=i.n(ue),fe=i(170),be=i.n(fe),pe=i(171),me=i.n(pe),ge=i(219),ve=i.n(ge),we=i(220),xe=i.n(we),ke=i(221),ye=i.n(ke),De="undefined"!=typeof window?window:null,$e=null===De,Se=$e?void 0:De.document,Ce=function(){return!1},Ae=$e?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=Se.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",ze=function(e){return"string"==typeof e||e instanceof String},Ee=function(e){if(ze(e)){var t=Se.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},Fe=function(e,t,i){var a=e[t];return void 0!==a?a:i},_e=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},Be=function(e,t){var i=Se.createElement("div");return i.className="gutter gutter-"+t,i},Ie=function(e,t,i){var a={};return ze(t)?a[e]=t:a[e]=Ae+"("+t+"% - "+i+"px)",a},Le=function(e,t){var i;return(i={})[e]=t+"px",i},Te=function(e,t){if(void 0===t&&(t={}),$e)return{};var i,a,r,o,n,s,l=e;Array.from&&(l=Array.from(l));var c=Ee(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,u=d?d.flexDirection:null,h=Fe(t,"sizes")||l.map((function(){return 100/l.length})),f=Fe(t,"minSize",100),b=Array.isArray(f)?f:l.map((function(){return f})),p=Fe(t,"maxSize",1/0),m=Array.isArray(p)?p:l.map((function(){return p})),g=Fe(t,"expandToMin",!1),v=Fe(t,"gutterSize",10),w=Fe(t,"gutterAlign","center"),x=Fe(t,"snapOffset",30),k=Fe(t,"dragInterval",1),y=Fe(t,"direction","horizontal"),D=Fe(t,"cursor","horizontal"===y?"col-resize":"row-resize"),$=Fe(t,"gutter",Be),S=Fe(t,"elementStyle",Ie),C=Fe(t,"gutterStyle",Le);function A(e,t,a,r){var o=S(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function z(){return s.map((function(e){return e.size}))}function E(e){return"touches"in e?e.touches[0][a]:e[a]}function F(e){var t=s[this.a],i=s[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,A(t.element,t.size,this._b,t.i),A(i.element,i.size,this._c,i.i)}function _(e){var i,a=s[this.a],r=s[this.b];this.dragging&&(i=E(e)-this.start+(this._b-this.dragOffset),k>1&&(i=Math.round(i/k)*k),i<=a.minSize+x+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+x+this._c)&&(i=this.size-(r.minSize+this._c)),i>=a.maxSize-x+this._b?i=a.maxSize+this._b:i<=this.size-(r.maxSize-x+this._c)&&(i=this.size-(r.maxSize+this._c)),F.call(this,i),Fe(t,"onDrag",Ce)(z()))}function B(){var e=s[this.a].element,t=s[this.b].element,a=e.getBoundingClientRect(),n=t.getBoundingClientRect();this.size=a[i]+n[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function I(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[n];return 0===i?null:i-="horizontal"===y?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(b.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var n=t*r/100,s=_e(v,0===o,o===e.length-1,w),l=b[o]+s;return n<l?(i+=l-n,a.push(0),l):(a.push(n-l),n)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var n=Math.min(i,a[r]-i);i-=n,o=e-n}return o/t*100}))}function L(){var e=s[this.a].element,i=s[this.b].element;this.dragging&&Fe(t,"onDragEnd",Ce)(z()),this.dragging=!1,De.removeEventListener("mouseup",this.stop),De.removeEventListener("touchend",this.stop),De.removeEventListener("touchcancel",this.stop),De.removeEventListener("mousemove",this.move),De.removeEventListener("touchmove",this.move),this.stop=null,this.move=null,e.removeEventListener("selectstart",Ce),e.removeEventListener("dragstart",Ce),i.removeEventListener("selectstart",Ce),i.removeEventListener("dragstart",Ce),e.style.userSelect="",e.style.webkitUserSelect="",e.style.MozUserSelect="",e.style.pointerEvents="",i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",this.gutter.style.cursor="",this.parent.style.cursor="",Se.body.style.cursor=""}function T(e){if(!("button"in e)||0===e.button){var i=s[this.a].element,a=s[this.b].element;this.dragging||Fe(t,"onDragStart",Ce)(z()),e.preventDefault(),this.dragging=!0,this.move=_.bind(this),this.stop=L.bind(this),De.addEventListener("mouseup",this.stop),De.addEventListener("touchend",this.stop),De.addEventListener("touchcancel",this.stop),De.addEventListener("mousemove",this.move),De.addEventListener("touchmove",this.move),i.addEventListener("selectstart",Ce),i.addEventListener("dragstart",Ce),a.addEventListener("selectstart",Ce),a.addEventListener("dragstart",Ce),i.style.userSelect="none",i.style.webkitUserSelect="none",i.style.MozUserSelect="none",i.style.pointerEvents="none",a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",this.gutter.style.cursor=D,this.parent.style.cursor=D,Se.body.style.cursor=D,B.call(this),this.dragOffset=E(e)-this.end}}"horizontal"===y?(i="width",a="clientX",r="left",o="right",n="clientWidth"):"vertical"===y&&(i="height",a="clientY",r="top",o="bottom",n="clientHeight"),h=I(h);var P=[];function R(e){var t=e.i===P.length,i=t?P[e.i-1]:P[e.i];B.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;F.call(i,a)}return(s=l.map((function(e,t){var a,r={element:Ee(e),size:h[t],minSize:b[t],maxSize:m[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:y,parent:c})._b=_e(v,t-1==0,!1,w),a._c=_e(v,!1,t===l.length-1,w),"row-reverse"===u||"column-reverse"===u)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var n=$(t,y,r.element);!function(e,t,a){var r=C(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(n,v,t),a._a=T.bind(a),n.addEventListener("mousedown",a._a),n.addEventListener("touchstart",a._a),c.insertBefore(n,r.element),a.gutter=n}return A(r.element,r.size,_e(v,0===t,t===l.length-1,w),t),t>0&&P.push(a),r}))).forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(g?R(e):e.minSize=t)})),{setSizes:function(e){var t=I(e);t.forEach((function(e,i){if(i>0){var a=P[i-1],r=s[a.a],o=s[a.b];r.size=t[i-1],o.size=e,A(r.element,r.size,a._b,r.i),A(o.element,o.size,a._c,o.i)}}))},getSizes:z,collapse:function(e){R(s[e])},destroy:function(e,t){P.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=S(i,a.a.size,a._b);Object.keys(r).forEach((function(e){s[a.a].element.style[e]="",s[a.b].element.style[e]=""}))}}))},parent:c,pairs:P}};class Pe extends a.a{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources","info"],this.tabLabels={pages:"Pages",story:"Story",resources:"URLs",info:"Archive Info"},this.menuActive=!1,this.hasStory=!1,this.editable=!1,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl="",this.appName="ReplayWeb.page",this.appLogo=u.a}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},editable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String},appName:{type:String},appLogo:{type:String}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",e=>this.onHashChange(e)),this.addEventListener("fullscreenchange",()=>{this.isFullscreen=!!document.fullscreenElement}),this.embed&&(this.observer=new IntersectionObserver(e=>{this.isVisible=e[0].isIntersecting}),this.observer.observe(this))}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&(this.editable?this._pollColl=setInterval(()=>this.doUpdateInfo(!0),1e4):this._pollColl&&clearInterval(this._pollColl)),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach(e=>!this.tabData[e]&&delete this.tabData[e]);const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url="search://"+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=Te([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(e=!1){if(e&&this.tabData.url&&!this.showSidebar)return;let t=this.loadInfo&&this.loadInfo.customColl;if(!t){t=(await z(this.sourceUrl)).coll}this.coll=t;const i="./w/api/c/"+t,a="./w/"+t,r=await fetch(i+"?all=1");if(200!=r.status)return void(this.collInfo={});const o=await r.json();this.collInfo={apiPrefix:i,replayPrefix:a,coll:t,...o},this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"===this.embed&&(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,e.detail.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl),this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(){const e=window.location.hash;if(e&&e!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(e.slice(1)).entries()),this._locationHash=e),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.editable||this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=S(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.detail.reload?this.onRefresh(null,!0):e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return f(a.b`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
      ...
      <nav class="main tabs is-centered ${e?"sidebar":""}" aria-label="tabs">
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${m}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${xe.a}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${"pages"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${ne.a}" aria-hidden="true" title="Pages"></fa-icon></span>
          ...
          <li class="${"info"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#info" class="is-size-6" aria-label="Archive Info" aria-current="${"info"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${le.a}" aria-hidden="true" title="Archive Info"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a role="button" href="#" @click="${this.onFullPageView}" @keyup="${m}" class="is-marginless is-size-6 is-paddingless">
              <span class="nav-hover" aria-hidden="true">Expand</span>
              <span class="is-sr-only">Expand Sidebar to Full View</span>
              <fa-icon title="Expand" .svg="${ye.a}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        <a href="#" role="button" class="button narrow is-borderless is-hidden-touch" id="fullscreen" @click="${this.onFullscreenToggle}" @keyup="${m}"
                title="${this.isFullscreen?"Exit Full Screen":"Full Screen"}" aria-label="${this.isFullscreen?"Exit Fullscreen":"Fullscreen"}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?me.a:be.a}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoBack}" @keyup="${m}"
                title="Back" aria-label="Back">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${B.a}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoForward}" @keyup="${m}"
                title="Forward" aria-label="Forward">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${L.a}"></fa-icon>
          </span>
        </a>
        <a href="#" role="button" class="button narrow is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" id="refresh" @click="${this.onRefresh}" @keyup="${m}"
        ...
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${m}"
        ...
        <div class="dropdown is-right ${this.menuActive?"is-active":""}" @click="${()=>this.menuActive=!1}">
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" aria-expanded="${this.menuActive}" @click="${this.onMenu}"
              ...
              <span class="icon is-small">
                <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${ve.a}"></fa-icon>
              </span>
            </button>
          </div>
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              <a href="#" role="button" class="dropdown-item is-hidden-desktop" @click="${this.onFullscreenToggle}" @keyup="${m}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?me.a:be.a}"></fa-icon>
                </span>
                <span>Full Screen</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${this.onGoBack}" @keyup="${m}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${B.a}"></fa-icon>
                </span>
                <span>Back</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${this.onGoForward}" @keyup="${m}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${L.a}"></fa-icon>
                </span>
                <span>Forward</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet" @click="${this.onRefresh}" @keyup="${m}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${he.a}"></fa-icon>
                </span>
                <span>Reload</span>
              </a>
              <a href="#" role="button" class="dropdown-item is-hidden-tablet ${t?"":"grey-disabled"}" @click="${this.onShowPages}" @keyup="${m}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${ie.a}"></fa-icon>
                </span>
              ...
              <a href="#" role="button" class="dropdown-item" @click="${this.onPurgeCache}" @keyup="${m}">
                <span class="icon is-small">
                  <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${de.a}"></fa-icon>
                </span>
                <span>Purge Cache + Full Reload</span>
              </a>`}
              ${!this.editable&&this.sourceUrl.startsWith("http://")||this.sourceUrl.startsWith("https://")?a.c`
              <hr class="dropdown-divider">
              <a href="${this.sourceUrl}" role="button" class="dropdown-item" @keyup="${m}">
                <span class="icon is-small">
              ...
              <a href="#" role="button" class="dropdown-item" @click="${this.onAbout}">
                ...
                <span class="menu-version">(${p})</span>
              </a>
            </div>
          </div>
        </div>
    ...
    ${je.sidebarStyles(Object(a.d)(":host(.sidebar)"))}
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Object(Re.b)(Me()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return a.c`
    ...
    `}renderContent(){switch(this.state){case"googledrive":return a.c`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return a.c`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?a.c`
              <div class="loaded-prog">Loaded <b>${j()(this.currentSize)}</b> of <b>${j()(this.totalSize)}</b>
              ${this.extraMsg&&a.c`
    ...
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?a.c`<fa-icon class="editIcon" .svg="${Qe.a}"></fa-icon>`:a.c``}
    ...
    <div class="header columns is-hidden-mobile">
      ${this.query?a.c`
      <a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="" class="column is-1 ${""===this.sortKey?this.sortDesc?"desc":"asc":""}">Match</a>`:""}

      <a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="date" class="column is-2 ${"date"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a>
      <a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="title" class="column is-6 pagetitle ${"title"===this.sortKey?this.sortDesc?"desc":"asc":""}">Page Title</a>
    </div>
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${j()(this.toDeletePage.size)}</b>)</p>`:a.c`
    ...
    </wr-modal>`:a.c``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=C(e.date):"string"==typeof e.ts&&(t=C(e.ts)),t===this.ts}return!1}renderPages(){return a.c`
        ...
        <div class="media">
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @dblclick="${this.onReload}" @click="${this.onReplay}" href="${A("pages",this.page.url,this.page.timestamp)}">
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      <thead>
        <tr class="columns results-head has-text-weight-bold">
          <th scope="col" class="column col-url is-6 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="url" class="${"url"===this.sortKey?this.sortDesc?"desc":"asc":""}">URL</a></th>
          <th scope="col" class="column col-ts is-2 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="ts" class="${"ts"===this.sortKey?this.sortDesc?"desc":"asc":""}">Date</a></th>
          <th scope="col" class="column col-mime is-3 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="mime" class="${"mime"===this.sortKey?this.sortDesc?"desc":"asc":""}">Mime Type</a></th>
          <th scope="col" class="column col-status is-1 is-hidden-mobile"><a role="button" href="#" @click="${this.onSort}" @keyup="${m}" data-key="status" class="${"status"===this.sortKey?this.sortDesc?"desc":"asc":""}">Status</a></th>
        </tr>
      </thead>
      ...
      ${this.sortedResults.length?this.sortedResults.map(e=>a.c`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${A("resources",e.url,e.ts)}">
    ...
    `:""}`;var e}onLoad(e){const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout(()=>t.location.reload(),100);if(this.reloadCount=0,t.customElements.get("replay-app-main"))return;const a=i.createElement("script");a.src=dt,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",ut)}();var ht=i(93),ft=i.n(ht),bt=i(230),pt=i.n(bt),mt=i(107),gt=i.n(mt),vt=i(231),wt=i.n(vt),xt=i(94),kt=i.n(xt),yt=i(27),Dt=i.n(yt);class $t extends Y{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgress=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgress:{type:Number}}}static get styles(){return f($t.compStyles)}static get compStyles(){return a.b`
    :host {
      overflow: visible;
    }
    ...
    `}firstUpdated(){this.renderRoot.addEventListener("click",()=>this.showShareMenu=!1)}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed,i=localStorage.getItem("ipfsLocalURL");return a.c`
      <div class="columns">
                  ...
                  <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
                    <div class="dropdown-content">
                      ...
                      <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                        <span class="icon is-small">
                          <fa-icon size="0.8em" .svg="${gt.a}"></fa-icon>
                        </span>
                        Copy IPFS URL
                      </a>
        ...
        ${e.loadUrl}
        <a @click="${t=>this.onCopy(t,e.loadUrl)}" class="copy"><fa-icon .svg="${O.a}"/></a>
        </div>`:""}
      </div>
    ...
    class="${e?"dropdown-item is-hidden-tablet":"button narrow is-borderless"}"
      ...
      @click="${this.onShowStart}" @keyup="${m}">
      <span class="icon is-small">
        <fa-icon size="1.2em" aria-hidden="true" .svg="${Dt.a}"></fa-icon>
      </span>
    ...
    <div class="info-bg">
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}),customElements.define("wr-rec-coll-info",$t);customElements.define("wr-rec-coll-index",class extends Z{constructor(){super(),this.deleteConfirm=null,this.ipfsSharePending=0}get sortKeys(){return[{key:"title",name:"Title"},{key:"ctime",name:this.dateName},{key:"mtime",name:"Date Modified"},{key:"size",name:"Total Size"},{key:"loadUrl",name:"Source"}]}firstUpdated(){this.loadColls(),this._poll=setInterval(()=>{this.ipfsSharePending||this.loadColls()},1e4)}updated(e){super.updated(e),e.has("sortedColls")&&this.dispatchEvent(new CustomEvent("colls-updated",{detail:{colls:this.sortedColls}}))}static get properties(){return{...Z.properties,deleteConfirm:{type:Object}}}renderCollInfo(e){return a.c`
    <wr-rec-coll-info
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${j()(this.deleteConfirm.size)}</b>)</p>
    ...
    <fa-icon .svg="${F.a}" aria-hidden="true"></fa-icon><span>&nbsp;User Guide</span>
          ...
          <div class="message-body">
            <div class="buttons">
              ...
              <button class="button is-small no-pad-mobile" title="Start Recording..." ?disabled="${!this.colls}" @click="${this.onShowStart}">
                <span class="icon">
                  <fa-icon size="1.0em" aria-hidden="true" .svg="${Dt.a}"></fa-icon>
                </span>
                ...
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${b?"App":"Extension"} v${"0.7.5"}</div>
                    </div>
