 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const S=` ${n} `;class ${constructor(e,t,i,a){this.strings=e,this.values=t,this.type=i,this.processor=a}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let a=0;a<e;a++){const e=this.strings[a],r=e.lastIndexOf("\x3c!--");i=(r>-1||i)&&-1===e.indexOf("--\x3e",r+1);const o=u.exec(e);t+=null===o?e+(i?S:s):e.substr(0,o.index)+o[1]+o[2]+"$lit$"+o[3]+n}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,a){const r=t[0];if("."===r){return new I(e,t.slice(1),i).parts}if("@"===r)return[new E(e,t.slice(1),a.eventContext)];if("?"===r)return[new D(e,t.slice(1),i)];return new C(e,t,i).parts}handleTextExpression(e){return new L(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const oe=new WeakMap,ne=v(e=>t=>{if(!(t instanceof L))throw new Error("unsafeSVG can only be used in text bindings");const i=oe.get(t);if(void 0!==i&&z(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=`<svg>${e}</svg>`;const o=a.content,n=o.firstChild;o.removeChild(n),r(o,n.firstChild);const s=document.importNode(o,!0);t.setValue(s),oe.set(t,{value:e,fragment:s})}),se=new WeakMap,le=v(e=>t=>{if(!(t instanceof P)||t instanceof A||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=se.get(t);void 0===r&&(a.cssText=i.strings.join(" "),se.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var ce=i(358),de=i.n(ce),he=i(287),fe=i.n(he);const ue=te(de.a);function be(e){return[ue,e]}const pe=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;function me(e){" "==e.key&&(e.preventDefault(),e.target.click())}class ge extends re{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return ie`
    :host {
    ...
    `}get mainLogo(){return fe.a}renderNavBrand(){return O`
        ...
        <div class="navbar-start">
          ${pe?O`
            ...
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${me}">
              <fa-icon size="1.0rem" .svg="${Re.a}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?O``:O`
    ...
    `:O``}firstUpdated(){this.initRoute(),window.addEventListener("popstate",()=>{this.initRoute()})}updated(e){e.has("sourceUrl")&&(this.collTitle=null)}onFavIcons(e){const t=document.querySelector("head"),i=document.querySelectorAll("link[rel*='icon']");for(const e of i)t.removeChild(e);for(const i of e.detail.icons){const e=document.createElement("link");e.rel=i.rel,e.href=i.href,t.appendChild(e)}}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-main-target").focus()}onNavMenu(e){e.preventDefault(),e.stopPropagation(),this.navMenuShown=!this.navMenuShown,this.navMenuShown&&(document.addEventListener("click",e=>{e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus()},{once:!0}),document.addEventListener("keypress",e=>{"Escape"==e.key&&(e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus())},{once:!0}))}initRoute(){this.inited=!0,this.pageParams=new URLSearchParams(window.location.search);let e=this.pageParams.get("state");if(e)try{if(e=JSON.parse(e),e.ids instanceof Array&&e.userId&&"open"===e.action)return this.pageParams.set("source","googledrive://"+e.ids[0]),this.pageParams.delete("state"),void(window.location.search=this.pageParams.toString())}catch(e){console.log(e)}if(this.source){this.pageParams.set("source",this.source);const e=new URL(window.location.href);e.search=this.pageParams.toString(),window.history.replaceState({},document.title,e.href)}if(this.sourceUrl=this.pageParams.get("source")||"",this.embed=this.pageParams.get("embed")||"",this.pageParams.has("terms")&&(this.showAbout=!0),this.pageParams.get("config")){this.loadInfo||(this.loadInfo={});try{this.loadInfo.extraConfig=JSON.parse(this.pageParams.get("config"))}catch(e){console.log("invalid config: "+e)}}if(this.pageParams.get("basePageUrl")&&(this.loadInfo||(this.loadInfo={extraConfig:{}}),this.loadInfo.extraConfig||(this.loadInfo.extraConfig={}),this.loadInfo.extraConfig.baseUrl=this.pageParams.get("basePageUrl")),this.pageParams.get("customColl")&&(this.loadInfo||(this.loadInfo={}),this.loadInfo.customColl=this.pageParams.get("customColl")),pe&&this.sourceUrl.startsWith("file://")){const e=new URL(__APP_FILE_SERVE_PREFIX__);e.searchParams.set("filename",this.sourceUrl.slice("file://".length)),this.loadInfo={sourceUrl:this.sourceUrl,loadUrl:e.href}}}onStartLoad(e){this.pageParams.set("source",e.detail.sourceUrl);const t=new URL(window.location.href);t.search=this.pageParams.toString(),this.collPageUrl=t.toString(),e.detail.isFile?(window.history.pushState({},"",this.collPageUrl),this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail):window.location.search=this.pageParams.toString()}onCollLoaded(e){this.loadInfo=null,e.detail.collInfo&&(this.collTitle=e.detail.collInfo.title),e.detail.alreadyLoaded||e.detail.sourceUrl!==this.sourceUrl&&(this.pageParams.set("source",e.detail.sourceUrl),window.location.search=this.pageParams.toString())}onTitle(e){e.detail.title&&(this.pageTitle=e.detail.title,this.pageReplay=e.detail.replayTitle,document.title=(e.detail.replayTitle?"Archive of ":"")+this.pageTitle+" | ReplayWeb.page")}safariKeyframes(){const e=document.createElement("style");document.head.appendChild(e),e.appendChild(document.createTextNode("\n    @keyframes spinAround {\n      from {\n        transform: rotate(0deg);\n      }\n      to {\n        transform: rotate(359deg);\n      }\n    }\n    "))}renderAbout(){return O`
      <div class="modal is-active">
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${pe?"App":""} v${"0.6.4"}</div>
                    </div>
  ...
  `)}render(){return O`
      ...
      <div class="panel">
        ...
        ${this.renderSearchHeader()}
          <div class="control has-icons-left has-addons">
            ...
            <span class="icon is-left is-small"><fa-icon .svg="${Ge.a}"/></span>
          </div>
          <wr-sorter id="index"
          sortKey="ctime"
          ?sortDesc="${!0}"
    ...
    `}renderCollInfo(e){return O`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return O`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Ke extends re{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return be(Ke.compStyles)}static get compStyles(){return ie`
    .columns {
      width: 100%;
    }
    .column {
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${me}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${mt.a}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"info"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#info" class="is-size-6" aria-label="Archive Info" aria-current="${"info"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${rt.a}" aria-hidden="true" title="Archive Info"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a role="button" href="#" @click="${this.onFullPageView}" @keyup="${me}" class="is-marginless is-size-6 is-paddingless">
              ...
              <fa-icon title="Expand" .svg="${vt.a}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
      ...
      <div class="field has-addons">
        <a href="#" role="button" class="button narrow is-borderless is-hidden-touch" id="fullscreen" @click="${this.onFullscreenToggle}" @keyup="${me}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?ft.a:dt.a}"></fa-icon>
          </span>
        </a>
        ...
        <a href="#" role="button" class="button narrow is-borderless ${this.isLoading?"is-loading":"is-hidden-mobile"}" id="refresh" @click="${this.onRefresh}" @keyup="${me}"
          ...
          <span class="icon is-small">
            ${this.isLoading?"":O`
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${lt.a}"></fa-icon>
            `}
          </span>
        </a>
          ...
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              ...
              <a href="#" role="button" class="dropdown-item" @click="${this.onAbout}">
                ...
                <span class="menu-version">(${"0.6.4"})</span>
              </a>
            </div>
          </div>
        </div>
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Rt=new WeakMap,Et=v(e=>t=>{if(!(t instanceof L))throw new Error("unsafeHTML can only be used in text bindings");const i=Rt.get(t);if(void 0!==i&&z(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Rt.set(t,{value:e,fragment:r})});var Tt=i(372),Ut=i.n(Tt);class Mt extends re{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver(e=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=It([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const e of this.collInfo.curatedPages){this.curatedPageMap[e.list]||(this.curatedPageMap[e.list]=[]);const t=e,i=t.url,a=t.ts,r=t.title||t.url,o=e.desc;this.curatedPageMap[e.list].push({url:i,ts:a,title:r,desc:o})}this.scrollToList()}static get styles(){return be(ie`
    :host {
      width: 100%;
      height: 100%;
      display: flex;
    ...
    ${Mt.sidebarStyles(te(":host(.sidebar)"))}
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?Et(Ut()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return O`
    ...
    `)}`}renderCPage(e){const t=new Date(e.ts),i=ze(t.toISOString());return O`
    <li>
      <div class="content">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return O`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return O`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?O`
              <p class="loaded-prog">Loaded <b>${Ne()(this.currentSize)}</b> of <b>${Ne()(this.totalSize)}</b></p>`:O``}
      ...
      ${Zt.sidebarStyles(te`:host(.sidebar)`)}
    ...
    <div class="search-bar notification is-marginless">
      ...
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading?"is-loading":""}">
          ...
          <span class="icon is-left"><fa-icon .svg="${Ge.a}" aria-hidden="true"></fa-icon></span>
        </div>
      </div>
    </div>
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?O`<fa-icon class="editIcon" .svg="${Kt.a}"></fa-icon>`:O``}
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${Ne()(this.toDeletePage.size)}</b>)</p>`:O`
    ...
    </wr-modal>`:O``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=ze(e.date):"string"==typeof e.ts&&(t=ze(e.ts)),t===this.ts}return!1}renderPages(){return O`
    ...
    `}onUpdateTitle(e){if(e.preventDefault(),this.editing=!1,!this.editable)return;const t=this.renderRoot.querySelector("#titleEdit");if(!t||!t.value.trim())return;const i=t.value,a=JSON.stringify({title:i});fetch(this.collInfo.apiPrefix+"/metadata",{method:"POST",body:a}).then(e=>{200===e.status&&this.dispatchEvent(new CustomEvent("coll-update",{detail:{title:i}}))})}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",()=>{this.menuActive=!1},{once:!0})}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key")||"";t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedPages=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onSelectToggle(e){const{page:t,selected:i}=e.detail;i?this.selectedPages.add(t):this.selectedPages.delete(t),this.allSelected=this.selectedPages.size===this.sortedPages.length,this.requestUpdate()}onSelectAll(e){this.allSelected=e.currentTarget.checked,this.allSelected?this.sortedPages.forEach(e=>{this.selectedPages.add(e.id)}):this.selectedPages.clear(),this.requestUpdate()}async onDownload(e,t,i){e.preventDefault();const a=new URLSearchParams;a.set("pages",i?Array.from(this.selectedPages.keys()).join(","):"all"),a.set("format",t),this.collInfo.filename&&a.set("filename",this.collInfo.filename),window.location.href=this.collInfo.apiPrefix+"/dl?"+a.toString()}onDeleteConfirm(e){const t=e.currentTarget.page;this.selectedPages.has(t.id)?(this.toDeletePages=this.selectedPages,this.toDeletePage=null):(this.toDeletePages=[t.id],this.toDeletePage=t)}async onDeletePages(){const e={};for(const t of this.toDeletePages){const i=this.renderRoot.querySelector(`wr-page-entry[pid="${t}"]`);i&&(i.deleting=!0,e[t]=i)}for(const t of this.toDeletePages){const i=await fetch(`${this.collInfo.apiPrefix}/page/${t}`,{method:"DELETE"}),a=await i.json();if(a.error){console.warn(a.error);continue}const r=e[t];if(!r)continue;const o=this.collInfo.pages.indexOf(r);o<0||this.collInfo.pages.splice(o,1)}this.toDeletePages=null,this.toDeletePage=null,this.updateTextSearch(),this.requestUpdate()}formatResults(){return 1===this.sortedPages.length?"1 Page Found":this.sortedPages.length+" Pages Found"}getNoResultsMessage(){return this.collInfo&&this.collInfo.pages.length?this.updatingSearch?"Initializing Search...":this.loading?"Searching...":this.query?O`<span class="fix-text-wrapping">No matching pages found. Try changing the search query, or <a href="#view=resources">browse by URL</a>.</span>`:"No Pages Found":O`<span class="fix-text-wrapping">No Pages are defined in this archive. The archive may be empty. <a href="#view=resources">Try browsing by URL</a>.</span>`}onScroll(e){const t=e.currentTarget;if(t.scrollHeight-t.scrollTop-t.clientHeight<40){const e=this.renderRoot.querySelector("wr-sorter");e&&e.getMore()}}}customElements.define("wr-page-view",Zt);const Yt=new RegExp(`[${["-","[","]","/","{","}","(",")","*","+","?",".","\\","^","$","|"].join("\\")}]`,"g"),Jt=e=>e.replace(Yt,"\\$&");class Qt extends HTMLElement{static get observedAttributes(){return["keywords"]}get keywords(){return this.getAttribute("keywords")||""}set keywords(e){this.setAttribute("keywords",e)}constructor(){super(),this.attachShadow({mode:"open"})}attributeChangedCallback(e,t,i){"keywords"===e&&i!==t&&this._render()}connectedCallback(){this._render(),this.__observer=new MutationObserver(()=>{this._render()}),this.__observer.observe(this,{childList:!0,characterData:!0,subtree:!0})}disconnectedCallback(){this.__observer&&(this.__observer.disconnect(),this.__observer=void 0)}_render(){if(!this.shadowRoot)return;const e=this.textContent||"",t=this.getAttribute("keywords");if(!t)return void(this.shadowRoot.textContent=e);const i=e.toLowerCase(),a=t.toLowerCase().split(/\s+/),r=new RegExp(""+a.map(Jt).join("|"),"gi"),o=e.split(r),n=document.createElement("div");let s=0;for(const t of o)if(n.appendChild(document.createTextNode(t)),s+=t.length,s<i.length){const t=i.substring(s),r=a.find(e=>t.startsWith(e));if(r){const t=document.createElement("mark");t.textContent=e.substr(s,r.length),n.appendChild(t),s+=r.length}}this.shadowRoot.innerHTML=`\n      <style>\n        mark {\n          color: var(--keyword-mark-color);\n          background: var(--keyword-mark-background, yellow);\n        }\n      </style>\n      ${n.innerHTML}\n    `}}customElements.define("keyword-mark",Qt);class Xt extends re{constructor(){super(),this.query="",this.textSnippet="",this.page=null,this.replayPrefix="",this.deleting=!1,this.editable=!1,this.iconValid=!1,this.index=0,this.isCurrent=!1,this.isSidebar=!1}static get properties(){return{query:{type:String},textSnippet:{type:String},page:{type:Object},replayPrefix:{type:String},deleting:{type:Boolean},selected:{type:Boolean},editable:{type:Boolean},iconValid:{type:Boolean},index:{type:Number},isCurrent:{type:Boolean},isSidebar:{type:Boolean}}}static get styles(){return be(ie`
      ...
      ${Xt.sidebarStyles(te`:host(.sidebar)`)}
        ...
        <div class="level-item flex-auto">
          ...
          <div class="field flex-auto">
            <div class="control has-icons-left ${this.loading?"is-loading":""}">
              ...
              <span class="icon is-left"><fa-icon .svg="${Ge.a}"/></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      ...
      `}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key");t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedResults=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onReplay(e){e.preventDefault();const t={url:e.currentTarget.getAttribute("data-url"),ts:e.currentTarget.getAttribute("data-ts")};return this.dispatchEvent(new CustomEvent("coll-tab-nav",{detail:{data:t}})),!1}}customElements.define("wr-coll-resources",ri);
/**
 * @license
...
const oi=new WeakMap,ni=v(e=>t=>{const i=oi.get(t);if(void 0===e&&t instanceof P){if(void 0!==i||!oi.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==i&&t.setValue(e);oi.set(t,e)});var si=document.currentScript&&document.currentScript.src;class li extends re{constructor(){super(),this.replaybase="./replay/",this.swName="sw.js",this.view="replay",this.ts="",this.url="",this.query="",this.config="",this.coll="",this.paramString=null,this.deepLink=!1,this.swInited=!1,this.embed=null,this.reloadCount=0,this.noSandbox=!1}static get properties(){return{url:{type:String},ts:{type:String},query:{type:String},source:{type:String},view:{type:String},embed:{type:String},replaybase:{type:String},swName:{type:String},title:{type:String},coll:{type:String},config:{type:String},swInited:{type:Boolean},paramString:{type:String},hashString:{type:String},deepLink:{type:Boolean},noSW:{type:Boolean},noSandbox:{type:Boolean}}}async doRegister(){try{await Se(this.swName,this.replaybase),console.log("done"),this.swInited=!0}catch(e){console.log(e),this.noSW=!0}}firstUpdated(){this.doRegister(),window.addEventListener("message",e=>{const t=this.renderRoot.querySelector("iframe");if(t&&e.source===t.contentWindow){if(e.data.title&&(this.title=e.data.title),!this.deepLink)return;const t=new URLSearchParams(e.data),i=new URL(window.location.href);i.hash="#"+t.toString(),window.history.replaceState({},"",i)}}),this.deepLink&&(this.updateFromHash(),window.addEventListener("hashchange",()=>this.updateFromHash()))}updateFromHash(){const e=new URLSearchParams(window.location.hash.slice(1));e.has("url")&&(this.url=e.get("url")),e.has("ts")&&(this.ts=e.get("ts")),e.has("query")&&(this.query=e.get("query")),e.has("view")&&(this.view=e.get("view"))}updated(e){if(e.has("url")||e.has("ts")||e.has("query")||e.has("view")||e.has("source")){this.embed=this.embed||"default";const e=new URL(this.source,document.baseURI);this.paramString=new URLSearchParams({source:e,customColl:this.coll,config:this.config,basePageUrl:window.location.href.split("#")[0],embed:this.embed}).toString(),this.hashString=new URLSearchParams({url:this.url,ts:this.ts,query:this.query,view:this.view}).toString()}}static get styles(){return be(ie`
    ...
    ${this.paramString&&this.hashString&&this.swInited?O`
      <iframe sandbox="${ni(this.noSandbox?void 0:"allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms")}"
...
(Service Workers are disabled in Firefox in Private Mode. If Using Private Mode in Firefox, try regular mode).
    ...
    `:""}`}onLoad(e){const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout(()=>t.location.reload(),100);if(this.reloadCount=0,t.customElements.get("replay-app-main"))return;const a=i.createElement("script");a.src=si,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",li)}();var ci=i(78),di=i.n(ci),hi=i(148),fi=i.n(hi),ui=i(380),bi=i.n(ui),pi=(i(160),i(381)),mi=i.n(pi),gi=i(161),vi=i.n(gi),wi=i(382),xi=i.n(wi),ki=i(149),yi=i.n(ki),Si=i(383),$i=i.n(Si),zi=i(293),_i=i.n(zi),Ci=i(56),Pi=i.n(Ci);class Li extends Ee{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[],this.autorun="1"===localStorage.getItem("autorunBehaviors")}get appName(){return"ArchiveWeb.page"}static get properties(){return{...Ee.properties,recordShown:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String},recordUrl:{type:String},autorun:{type:Boolean}}}initRoute(){this.inited=!0;const e=new URLSearchParams(window.location.search);this.sourceUrl=e.get("source")||""}getLoadInfo(e){return{customColl:e.startsWith("local://")?e.slice("local://".length):e}}static get styles(){return be(Li.appStyles)}static get appStyles(){return be(ie`
      :host {
        font-size: initial;
        overflow: auto;
      }
      ...
      ${Ee.appStyles}
    `)}get mainLogo(){return _i.a}renderNavEnd(){return O`
    ...
    </a>`}renderNavBrand(){return O`
      <span id="home" class="logo-text has-text-weight-bold is-size-6 has-allcaps wide-only">
      <span class="" style="color: #8878c3">archive</span>
      <span class="has-text-link">web.page</span>
      <span class="is-sr-only">Home</span>
    </span>`}renderHomeIndex(){return O`
          ...
          <div class="column is-3 is-hidden-mobile">
            <div class="message is-small">
              <div class="message-body">
                The ArchiveWeb.page ${pe?"App":"Chrome extension"} allows you to create web archives directly in your browser!  
              </div>
            </div>
          </div>
        </div>
    ...
    ${super.render()}`}renderColl(){return O`
    <wr-rec-coll 
    .editable="${!0}"
    ...
    @coll-loaded=${this.onCollLoaded}
    @show-start=${this.onShowStart}
    @about-show=${e=>this.showAbout=!0}></wr-rec-coll>`}renderStartModal(){return O`
    <wr-modal @modal-closed="${e=>this.recordShown=!1}" title="Start Recording">
        ...
        <div class="field has-addons">
          ...
          <div class="control">
            <button type="submit" class="button is-hidden-mobile is-outlined is-link">
              <span class="icon">
                <fa-icon size="1.0em" aria-hidden="true" .svg="${Pi.a}"></fa-icon>
              </span>
              <span>Go!</span>
            </button>
          </div>
    ...
    </wr-modal>`}renderAbout(){return O`
      <div class="modal is-active">
        <div class="modal-background" @click="${this.onAboutClose}"></div>
          <div class="modal-card">
            <header class="modal-card-head">
              <p class="modal-card-title">About ArchiveWeb.page ${pe?"App":"Extension"}</p>
              <button class="delete" aria-label="close" @click="${this.onAboutClose}"></button>
            </header>
            <section class="modal-card-body">
              <div class="container">
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      <fa-icon class="logo" size="48px" .svg="${_i.a}"></fa-icon>
                      <div style="font-size: smaller; margin-bottom: 1em">${pe?"App":"Extension"} v${"0.6.4"}</div>
                    </div>
      ...
      </div>`}async onNewColl(e){const t=this.renderRoot.querySelector("#new-name").value,i=JSON.stringify({metadata:{title:t}}),a=await fetch("./w/api/c/create",{method:"POST",body:i}),r=await a.json();console.log(r)}onSelectColl(e){this.selCollId=e.currentTarget.value}async onShowStart(e){this.selCollId=e.detail.coll,this.recordUrl=e.detail.url||"https://example.com/",this.recordShown=!0;const t=await fetch("./w/api/coll-index"),i=await t.json();this.colls=i.colls}onStartRecord(e){e.preventDefault();const t=this.renderRoot.querySelector("#url").value;this.recordShown=!1;const i=this.autorun,a=this.selCollId;if(localStorage.setItem("autorunBehaviors",i?"1":"0"),self.chrome&&self.chrome.runtime)chrome.runtime.sendMessage({msg:"startNew",url:t,collId:a,autorun:i});else if(window.archivewebpage&&window.archivewebpage.record){const e=this.renderRoot.querySelector("#preview"),r=!(e&&e.checked);window.archivewebpage.record({url:t,collId:a,startRec:r,autorun:i})}return!1}}customElements.define("wr-rec-coll",class extends At{renderExtraToolbar(e=!1){return e?"":O`
    <a href="#" role="button"
    class="${e?"dropdown-item is-hidden-tablet":"button narrow is-borderless"}"
      ...
      @click="${this.onShowStart}" @keyup="${me}">
      <span class="icon is-small">
        <fa-icon size="1.2em" aria-hidden="true" .svg="${Pi.a}"></fa-icon>
      </span>
    </a>`}renderCollInfo(){return O`
    <div class="info-bg">
      <wr-rec-coll-info
      class="is-list"
      .coll="${this.collInfo}"
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}),customElements.define("wr-rec-coll-index",class extends Ve{constructor(){super(),this.deleteConfirm=null}firstUpdated(){this.loadColls(),this._poll=setInterval(()=>this.loadColls(),1e4)}static get properties(){return{...Ve.properties,deleteConfirm:{type:Object}}}renderCollInfo(e){return O`
    <wr-rec-coll-info
      style="overflow: visible" data-coll="${e.id}" .coll=${e}>
    </wr-rec-coll-info>`}render(){return O`
    ${super.render()}
    ${this.renderDeleteConfirm()}
    `}renderDeleteConfirm(){return this.deleteConfirm?O`
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${e=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${di()(this.deleteConfirm.size)}</b>)</p>
    ...
    </wr-modal>`:null}onDeleteColl(e){if(e.preventDefault(),e.stopPropagation(),!this.sortedColls)return;const t=Number(e.currentTarget.getAttribute("data-coll-index"));this.deleteConfirm=this.sortedColls[t]}async doDelete(){if(!this.deleteConfirm)return;this._deleting[this.deleteConfirm.sourceUrl]=!0,this.requestUpdate();const e=this.renderRoot.querySelector(`wr-rec-coll-info[data-coll="${this.deleteConfirm.id}"]`);e&&await e.doDelete(),this.deleteConfirm=null}renderEmpty(){return O`No Archives. Click "Create New" above to create a new archive and start recording!`}}),customElements.define("wr-rec-coll-info",class extends re{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgress=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgress:{type:Number}}}static get styles(){return be(ie`
    :host {
      overflow: visible;
    }
    ...
    `)}firstUpdated(){this.renderRoot.addEventListener("click",()=>this.showShareMenu=!1)}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed,i=localStorage.getItem("ipfsLocalURL");return O`
      <div class="columns">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <button @click="${this.onDownload}" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${bi.a}"></fa-icon>
              </span>
            </button>
            <button @click="${this.onShowStart}" class="button is-small" title="Start Recording...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${Pi.a}"></fa-icon>
              </span>
            </button>
          </div>
        </div>
                  ...
                  <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
                    <div class="dropdown-content">
                      ...
                      <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                        <span class="icon is-small">
                          <fa-icon size="0.8em" .svg="${vi.a}"></fa-icon>
                        </span>
                        Copy IPFS URL
                      </a>
