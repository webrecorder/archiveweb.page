...
class se extends oe{}se.directiveName="unsafeSVG",se.resultType=2;const le=ae(se),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return P}});var de=__webpack_require__(4915),ue=__webpack_require__(4841),he=__webpack_require__.n(ue);const fe=r(de.Z);function pe(e){return[fe,e]}const be=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,me="0.7.9";function ge(e){" "==e.key&&(e.preventDefault(),e.target.click())}class ve extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    ...
    `}render(){if(!this.svg)return L``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),L`<svg style="${ce(e)}"><g>${le(this.svg)}</g></svg>`}}customElements.define("fa-icon",ve),customElements.define("wr-anim-logo",class extends ve{constructor(){super(),this.svg=he()}static get styles(){return o`
    #wrlogo #stop5687 {
    ...
    `}get mainLogo(){return he()}renderNavBrand(){return L`
        ...
        <div class="navbar-start">
          ${be?L`
            ...
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${ge}">
              <fa-icon size="1.0rem" .svg="${Le()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?L``:L`
    ...
    `:L``}firstUpdated(){this.initRoute(),window.addEventListener("popstate",(()=>{this.initRoute()}))}updated(e){e.has("sourceUrl")&&(this.collTitle=null)}onFavIcons(e){const t=document.querySelector("head"),i=document.querySelectorAll("link[rel*='icon']");for(const e of i)t.removeChild(e);for(const i of e.detail.icons){const e=document.createElement("link");e.rel=i.rel,e.href=i.href,t.appendChild(e)}}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-main-target").focus()}onNavMenu(e){e.preventDefault(),e.stopPropagation(),this.navMenuShown=!this.navMenuShown,this.navMenuShown&&(document.addEventListener("click",(e=>{e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus()}),{once:!0}),document.addEventListener("keypress",(e=>{"Escape"==e.key&&(e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus())}),{once:!0}))}initRoute(){this.inited=!0,this.pageParams=new URLSearchParams(window.location.search);let e=this.pageParams.get("state");if(e)try{if(e=JSON.parse(e),e.ids instanceof Array&&e.userId&&"open"===e.action)return this.pageParams.set("source","googledrive://"+e.ids[0]),this.pageParams.delete("state"),void(window.location.search=this.pageParams.toString())}catch(e){console.log(e)}if(this.source){this.pageParams.set("source",this.source);const e=new URL(window.location.href);e.search=this.pageParams.toString(),window.history.replaceState({},document.title,e.href)}if(this.sourceUrl=this.pageParams.get("source")||"",this.embed=this.pageParams.get("embed")||"",this.pageParams.has("terms")&&(this.showAbout=!0),this.pageParams.get("config")){this.loadInfo||(this.loadInfo={});try{this.loadInfo.extraConfig=JSON.parse(this.pageParams.get("config"))}catch(e){console.log("invalid config: "+e)}}if(this.pageParams.get("basePageUrl")&&(this.loadInfo||(this.loadInfo={extraConfig:{}}),this.loadInfo.extraConfig||(this.loadInfo.extraConfig={}),this.loadInfo.extraConfig.baseUrl=this.pageParams.get("basePageUrl")),this.pageParams.get("customColl")&&(this.loadInfo||(this.loadInfo={}),this.loadInfo.customColl=this.pageParams.get("customColl")),be&&this.sourceUrl.startsWith("file://")){const e=new URL("http://files.archiveweb.page/");e.searchParams.set("filename",this.sourceUrl.slice("file://".length)),this.loadInfo={sourceUrl:this.sourceUrl,loadUrl:e.href}}}onStartLoad(e){this.pageParams.set("source",e.detail.sourceUrl);const t=new URL(window.location.href);t.search=this.pageParams.toString(),this.collPageUrl=t.toString(),e.detail.isFile?(window.history.pushState({},"",this.collPageUrl),this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail):window.location.search=this.pageParams.toString()}onCollLoaded(e){this.loadInfo=null,e.detail.collInfo&&(this.collTitle=e.detail.collInfo.title),e.detail.alreadyLoaded||e.detail.sourceUrl!==this.sourceUrl&&(this.pageParams.set("source",e.detail.sourceUrl),window.location.search=this.pageParams.toString())}onTitle(e){e.detail.title&&(this.pageTitle=e.detail.title,this.pageReplay=e.detail.replayTitle,document.title=(e.detail.replayTitle?"Archive of ":"")+this.pageTitle+" | "+this.appName)}safariKeyframes(){const e=document.createElement("style");document.head.appendChild(e),e.appendChild(document.createTextNode("\n    @keyframes spinAround {\n      from {\n        transform: rotate(0deg);\n      }\n      to {\n        transform: rotate(359deg);\n      }\n    }\n    "))}renderAbout(){return L`
      <div class="modal is-active">
  ...
  `)}render(){return L`
            ...
            <label class="file-label">
              ...
              <span class="file-cta" @click="${this.onChooseNativeFile}">
                <span class="file-icon">
                  <fa-icon size="0.9em" .svg=${Re()} aria-hidden="true"></fa-icon>
                </span>
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        ...
        <button @click=${()=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?Ge():He()}></span>
      ...
      <div class="panel">
        ...
        ${this.renderSearchHeader()}
          <div class="control has-icons-left has-addons">
            ...
            <span class="icon is-left is-small"><fa-icon .svg="${Ke()}"/></span>
          </div>
          <wr-sorter id="index"
          sortKey="ctime"
          ?sortDesc="${!0}"
    ...
    `}renderCollInfo(e){return L`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return L`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Ze extends X{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return pe(Ze.compStyles)}static get compStyles(){return o`
    .columns {
      width: 100%;
    }
    .column {
    ...
    `}render(){const e=this.coll,t=this.detailed;return L`
      <div class="columns">
        ...
        <div class="column is-4">
          ...
          <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy"><fa-icon .svg="${je()}"/></a>
        ...
        <div class="column is-2"><p class="minihead">Total Size</p>${qe()(Number(e.size||0))}</div>
      ...
      </div>`}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}onPurge(e){const t={reload:e};this.dispatchEvent(new CustomEvent("coll-purge",{detail:t}))}}customElements.define("wr-coll-info",Ze),customElements.define("wr-coll-index",Ve);var Qe=__webpack_require__(5056),Ye=__webpack_require__.n(Qe),Je=__webpack_require__(5732),Xe=__webpack_require__.n(Je),et=__webpack_require__(8561),tt=__webpack_require__.n(et),it=__webpack_require__(9885),at=__webpack_require__.n(it),rt=__webpack_require__(4636),ot=__webpack_require__.n(rt),nt=__webpack_require__(1615),st=__webpack_require__.n(nt),lt=__webpack_require__(2302),ct=__webpack_require__.n(lt),dt=__webpack_require__(6368),ut=__webpack_require__.n(dt),ht=__webpack_require__(9125),ft=__webpack_require__.n(ht),pt=__webpack_require__(9998),bt=__webpack_require__.n(pt),mt=__webpack_require__(2164),gt=__webpack_require__.n(mt),vt=__webpack_require__(426),wt=__webpack_require__.n(vt),xt=__webpack_require__(430),kt=__webpack_require__.n(xt),yt="undefined"!=typeof window?window:null,Dt=null===yt,$t=Dt?void 0:yt.document,_t="horizontal",St=function(){return!1},Ct=Dt?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=$t.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",At=function(e){return"string"==typeof e||e instanceof String},zt=function(e){if(At(e)){var t=$t.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},Et=function(e,t,i){var a=e[t];return void 0!==a?a:i},Ft=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},Bt=function(e,t){var i=$t.createElement("div");return i.className="gutter gutter-"+t,i},It=function(e,t,i){var a={};return At(t)?a[e]=t:a[e]=Ct+"("+t+"% - "+i+"px)",a},Lt=function(e,t){var i;return(i={})[e]=t+"px",i};const Pt=function(e,t){if(void 0===t&&(t={}),Dt)return{};var i,a,r,o,n,s,l=e;Array.from&&(l=Array.from(l));var c=zt(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,u=d?d.flexDirection:null,h=Et(t,"sizes")||l.map((function(){return 100/l.length})),f=Et(t,"minSize",100),p=Array.isArray(f)?f:l.map((function(){return f})),b=Et(t,"maxSize",1/0),m=Array.isArray(b)?b:l.map((function(){return b})),g=Et(t,"expandToMin",!1),v=Et(t,"gutterSize",10),w=Et(t,"gutterAlign","center"),x=Et(t,"snapOffset",30),k=Et(t,"dragInterval",1),y=Et(t,"direction",_t),D=Et(t,"cursor",y===_t?"col-resize":"row-resize"),$=Et(t,"gutter",Bt),_=Et(t,"elementStyle",It),S=Et(t,"gutterStyle",Lt);function C(e,t,a,r){var o=_(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function A(){return s.map((function(e){return e.size}))}function z(e){return"touches"in e?e.touches[0][a]:e[a]}function E(e){var t=s[this.a],i=s[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,C(t.element,t.size,this._b,t.i),C(i.element,i.size,this._c,i.i)}function F(e){var i,a=s[this.a],r=s[this.b];this.dragging&&(i=z(e)-this.start+(this._b-this.dragOffset),k>1&&(i=Math.round(i/k)*k),i<=a.minSize+x+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+x+this._c)&&(i=this.size-(r.minSize+this._c)),i>=a.maxSize-x+this._b?i=a.maxSize+this._b:i<=this.size-(r.maxSize-x+this._c)&&(i=this.size-(r.maxSize+this._c)),E.call(this,i),Et(t,"onDrag",St)(A()))}function B(){var e=s[this.a].element,t=s[this.b].element,a=e.getBoundingClientRect(),n=t.getBoundingClientRect();this.size=a[i]+n[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function I(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[n];return 0===i?null:i-=y===_t?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(p.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var n=t*r/100,s=Ft(v,0===o,o===e.length-1,w),l=p[o]+s;return n<l?(i+=l-n,a.push(0),l):(a.push(n-l),n)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var n=Math.min(i,a[r]-i);i-=n,o=e-n}return o/t*100}))}function L(){var e=this,i=s[e.a].element,a=s[e.b].element;e.dragging&&Et(t,"onDragEnd",St)(A()),e.dragging=!1,yt.removeEventListener("mouseup",e.stop),yt.removeEventListener("touchend",e.stop),yt.removeEventListener("touchcancel",e.stop),yt.removeEventListener("mousemove",e.move),yt.removeEventListener("touchmove",e.move),e.stop=null,e.move=null,i.removeEventListener("selectstart",St),i.removeEventListener("dragstart",St),a.removeEventListener("selectstart",St),a.removeEventListener("dragstart",St),i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",a.style.userSelect="",a.style.webkitUserSelect="",a.style.MozUserSelect="",a.style.pointerEvents="",e.gutter.style.cursor="",e.parent.style.cursor="",$t.body.style.cursor=""}function P(e){if(!("button"in e)||0===e.button){var i=this,a=s[i.a].element,r=s[i.b].element;i.dragging||Et(t,"onDragStart",St)(A()),e.preventDefault(),i.dragging=!0,i.move=F.bind(i),i.stop=L.bind(i),yt.addEventListener("mouseup",i.stop),yt.addEventListener("touchend",i.stop),yt.addEventListener("touchcancel",i.stop),yt.addEventListener("mousemove",i.move),yt.addEventListener("touchmove",i.move),a.addEventListener("selectstart",St),a.addEventListener("dragstart",St),r.addEventListener("selectstart",St),r.addEventListener("dragstart",St),a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",r.style.userSelect="none",r.style.webkitUserSelect="none",r.style.MozUserSelect="none",r.style.pointerEvents="none",i.gutter.style.cursor=D,i.parent.style.cursor=D,$t.body.style.cursor=D,B.call(i),i.dragOffset=z(e)-i.end}}y===_t?(i="width",a="clientX",r="left",o="right",n="clientWidth"):"vertical"===y&&(i="height",a="clientY",r="top",o="bottom",n="clientHeight"),h=I(h);var U=[];function R(e){var t=e.i===U.length,i=t?U[e.i-1]:U[e.i];B.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;E.call(i,a)}return s=l.map((function(e,t){var a,r={element:zt(e),size:h[t],minSize:p[t],maxSize:m[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:y,parent:c})._b=Ft(v,t-1==0,!1,w),a._c=Ft(v,!1,t===l.length-1,w),"row-reverse"===u||"column-reverse"===u)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var n=$(t,y,r.element);!function(e,t,a){var r=S(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(n,v,t),a._a=P.bind(a),n.addEventListener("mousedown",a._a),n.addEventListener("touchstart",a._a),c.insertBefore(n,r.element),a.gutter=n}return C(r.element,r.size,Ft(v,0===t,t===l.length-1,w),t),t>0&&U.push(a),r})),s.forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(g?R(e):e.minSize=t)})),{setSizes:function(e){var t=I(e);t.forEach((function(e,i){if(i>0){var a=U[i-1],r=s[a.a],o=s[a.b];r.size=t[i-1],o.size=e,C(r.element,r.size,a._b,r.i),C(o.element,o.size,a._c,o.i)}}))},getSizes:A,collapse:function(e){R(s[e])},destroy:function(e,t){U.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=_(i,a.a.size,a._b);Object.keys(r).forEach((function(e){s[a.a].element.style[e]="",s[a.b].element.style[e]=""}))}}))},parent:c,pairs:U}},Ut="search://";class Rt extends X{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources","info"],this.tabLabels={pages:"Pages",story:"Story",resources:"URLs",info:"Archive Info"},this.menuActive=!1,this.hasStory=!1,this.editable=!1,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl="",this.appName="ReplayWeb.page",this.appLogo=he()}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},editable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String},appName:{type:String},appLogo:{type:String}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",(e=>this.onHashChange(e))),this.addEventListener("fullscreenchange",(()=>{this.isFullscreen=!!document.fullscreenElement})),this.embed&&(this.observer=new IntersectionObserver((e=>{this.isVisible=e[0].isIntersecting})),this.observer.observe(this))}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&(this.editable?this._pollColl=setInterval((()=>this.doUpdateInfo(!0)),1e4):this._pollColl&&clearInterval(this._pollColl)),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach((e=>!this.tabData[e]&&delete this.tabData[e]));const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url=Ut+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=Pt([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(e=!1){if(e&&this.tabData.url&&!this.showSidebar)return;let t=this.loadInfo&&this.loadInfo.customColl;if(!t){t=(await Ae(this.sourceUrl)).coll}this.coll=t;const i="./w/api/c/"+t,a="./w/"+t,r=await fetch(i+"?all=1");if(200!=r.status)return void(this.collInfo={});const o=await r.json();this.collInfo={apiPrefix:i,replayPrefix:a,coll:t,...o},this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"===this.embed&&(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,e.detail.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl),this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(){const e=window.location.hash;if(e&&e!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(e.slice(1)).entries()),this._locationHash=e),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.editable||this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=_e(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.detail.reload?this.onRefresh(null,!0):e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return pe(o`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${ge}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${wt()}" aria-hidden="true"></fa-icon>
          ...
          <li class="${"pages"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#pages" class="is-size-6" aria-label="Pages" aria-current="${"pages"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${ot()}" aria-hidden="true" title="Pages"></fa-icon></span>
          ...
          <li class="${"resources"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#resources" class="is-size-6" aria-label="URLs" aria-current="${"resources"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${at()}" aria-hidden="true" title="URLs"></fa-icon></span>
          ...
          <li class="${"info"===this.tabData.view?"is-active":""}">
            <a @click="${this.onTabClick}" href="#info" class="is-size-6" aria-label="Archive Info" aria-current="${"info"===this.tabData.view?"location":""}">
              <span class="icon"><fa-icon .svg="${st()}" aria-hidden="true" title="Archive Info"></fa-icon></span>
          ...
          <li class="sidebar-nav right">
            <a role="button" href="#" @click="${this.onFullPageView}" @keyup="${ge}" class="is-marginless is-size-6 is-paddingless">
              ...
              <fa-icon title="Expand" .svg="${kt()}" aria-hidden="true"></fa-icon>
            </a>
          </li>`:""}
        </ul>
      ...
      <div class="field has-addons">
        <a href="#" role="button" class="button narrow is-borderless is-hidden-touch" id="fullscreen" @click="${this.onFullscreenToggle}" @keyup="${ge}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${this.isFullscreen?bt():ft()}"></fa-icon>
          </span>
        </a>
        ...
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoForward}" @keyup="${ge}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Le()}"></fa-icon>
          </span>
        </a>
        ...
        <div class="dropdown is-right ${this.menuActive?"is-active":""}" @click="${()=>this.menuActive=!1}">
          <div class="dropdown-trigger">
            <button class="button is-borderless" aria-haspopup="true" aria-controls="menu-dropdown" aria-expanded="${this.menuActive}" @click="${this.onMenu}"
              ...
              <span class="icon is-small">
                <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${gt()}"></fa-icon>
              </span>
            </button>
          </div>
    ...
    ${Mt.sidebarStyles(r(":host(.sidebar)"))}
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?ne(qt()(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return L`
    ...
    `))}`}renderCPage(e){const t=new Date(e.ts),i=Se(t.toISOString());return L`
    <li>
      <div class="content">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return L`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return L`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?L`
              <div class="loaded-prog">Loaded <b>${qe()(this.currentSize)}</b> of <b>${qe()(this.totalSize)}</b>
              ${this.extraMsg&&L`
    ...
    <div class="search-bar notification is-marginless">
      ...
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading?"is-loading":""}">
          ...
          <span class="icon is-left"><fa-icon .svg="${Ke()}" aria-hidden="true"></fa-icon></span>
        </div>
      </div>
    </div>
    <div class="main columns">
      <div class="column index-bar is-one-fifth is-hidden-mobile">
        ...
        ${this.editable?L`<fa-icon class="editIcon" .svg="${Qt()}"></fa-icon>`:L``}
      ...
      <div class="dropdown ${this.menuActive?"is-active":""}">
        <div class="dropdown-trigger">
          <button @click="${this.onMenu}" class="button is-small" aria-haspopup="true" aria-expanded="${this.menuActive}" aria-controls="dropdown-menu">
            <span>Download</span>
            <span class="icon is-small">
              <fa-icon .svg="${Vt()} aria-hidden="true"></fa-icon>
            </span>
          </button>
        </div>
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${qe()(this.toDeletePage.size)}</b>)</p>`:L`
    ...
    </wr-modal>`:L``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=Se(e.date):"string"==typeof e.ts&&(t=Se(e.ts)),t===this.ts}return!1}renderPages(){return L`
        ...
        <div class="level-item flex-auto">
          ...
          <div class="field flex-auto">
            <div class="control has-icons-left ${this.loading?"is-loading":""}">
              ...
              <span class="icon is-left"><fa-icon .svg="${Ke()}"/></span>
            </div>
          </div>
        </div>
      </div>
    ...
    `:""}`}onLoad(e){const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get("replay-app-main"))return;const a=i.createElement("script");a.src=si,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",li)}();var ci=__webpack_require__(7589),di=__webpack_require__.n(ci),ui=__webpack_require__(4771),hi=__webpack_require__.n(ui),fi=__webpack_require__(6696),pi=__webpack_require__.n(fi),bi=__webpack_require__(5361),mi=__webpack_require__.n(bi),gi=__webpack_require__(7848),vi=__webpack_require__.n(gi),wi=__webpack_require__(252),xi=__webpack_require__.n(wi);class ki extends Ze{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgress=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgress:{type:Number}}}static get styles(){return pe(ki.compStyles)}static get compStyles(){return o`
    :host {
      overflow: visible;
    }
    ...
    ${Ze.compStyles}
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1))}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed,i=localStorage.getItem("ipfsLocalURL");return L`
      <div class="columns">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <button @click="${this.onDownload}" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${Xe()}"></fa-icon>
              </span>
            </button>
            <button @click="${this.onShowImport}" class="button is-small" title="Import Archive...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${Re()}"></fa-icon>
              </span>
            </button>
                  ...
                  <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
                    <div class="dropdown-content">
                      ...
                      <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                        <span class="icon is-small">
                          <fa-icon size="0.8em" .svg="${pi()}"></fa-icon>
                        </span>
                        Copy IPFS URL
                      </a>
    ...
    <div class="info-bg">
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}),customElements.define("wr-rec-coll-info",ki);customElements.define("wr-rec-coll-index",class extends Ve{constructor(){super(),this.deleteConfirm=null,this.ipfsSharePending=0}get sortKeys(){return[{key:"title",name:"Title"},{key:"ctime",name:this.dateName},{key:"mtime",name:"Date Modified"},{key:"size",name:"Total Size"},{key:"loadUrl",name:"Source"}]}firstUpdated(){this.loadColls(),this._poll=setInterval((()=>{this.ipfsSharePending||this.loadColls()}),1e4)}updated(e){super.updated(e),e.has("sortedColls")&&this.dispatchEvent(new CustomEvent("colls-updated",{detail:{colls:this.sortedColls}}))}static get properties(){return{...Ve.properties,deleteConfirm:{type:Object}}}renderCollInfo(e){return L`
    <wr-rec-coll-info
      style="overflow: visible" data-coll="${e.id}" .coll=${e} @ipfs-share="${this.onIpfsShare}">
    </wr-rec-coll-info>`}render(){return L`
    ${super.render()}
    ${this.renderDeleteConfirm()}
    `}renderDeleteConfirm(){return this.deleteConfirm?L`
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${qe()(this.deleteConfirm.size)}</b>)</p>
      ...
      ${Pe.appStyles}
    `)}get mainLogo(){return Di()}renderNavEnd(){return L`
    ...
    </a>`}renderNavBrand(){return L`
      <span id="home" class="logo-text has-text-weight-bold is-size-6 has-allcaps wide-only">
      <span class="" style="color: #8878c3">archive</span>
      <span class="has-text-link">web.page</span>
      <span class="is-sr-only">Home</span>
    </span>`}renderHomeIndex(){return L`
    ...
    ${super.render()}`}renderColl(){return L`
    <wr-rec-coll 
    .editable="${!0}"
    ...
    @show-start=${this.onShowStart}
    @show-import=${this.onShowImport}
    @about-show=${()=>this.showAbout=!0}></wr-rec-coll>`}renderCollList(e=""){return L`
    <div class="dropdown-row">
      <span>${e}&nbsp;</span>
      <div class="select is-small">
        <select @change="${this.onSelectColl}">
        ${this.colls&&this.colls.map((e=>L`
          <option value="${e.id}"
    ...
    </wr-modal>`}renderNewCollModal(){return L`
    ...
    </wr-modal`}renderImportModal(){return L`
                ...
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${be?"App":"Extension"} v${"0.7.9"}</div>
                    </div>
