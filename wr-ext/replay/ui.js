 ...
 * http://polymer.github.io/PATENTS.txt
 */
const n=new WeakMap,s=Object(o.d)(e=>t=>{if(!(t instanceof o.a)||t instanceof o.c||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=n.get(t);void 0===r&&(a.cssText=i.strings.join(" "),n.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var l=i(225),c=i.n(l),d=i(215),h=i.n(d);const f=Object(a.d)(c.a);function u(e){return[f,e]}const b=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;function p(e){" "==e.key&&(e.preventDefault(),e.target.click())}class m extends a.a{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return a.b`
    :host {
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${b?"App":""} v${"0.4.10"}</div>
                    </div>
    ...
    <section class="section no-top-padding">
      <div class="sort-header is-small">
        ...
        <button @click=${e=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?F.a:W.a}></span>
          ...
          <div class="dropdown-menu" id="menu-dropdown">
            <div class="dropdown-content">
              ...
              <a href="#" role="button" class="dropdown-item" @click="${this.onAbout}">
                ...
                <span class="menu-version">(${"0.4.10"})</span>
              </a>
            </div>
          </div>
        </div>
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Re=new WeakMap,Ie=Object(o.d)(e=>t=>{if(!(t instanceof o.b))throw new Error("unsafeHTML can only be used in text bindings");const i=Re.get(t);if(void 0!==i&&Object(Ee.h)(e)&&e===i.value&&t.value===i.fragment)return;const a=document.createElement("template");a.innerHTML=e;const r=document.importNode(a.content,!0);t.setValue(r),Re.set(t,{value:e,fragment:r})});var Ue=i(238),je=i.n(Ue);class Ne extends a.a{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e,t)=>{this.recalcSplitter(e[0].contentRect.width)}),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=Ae([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const e of this.collInfo.curatedPages){this.curatedPageMap[e.list]||(this.curatedPageMap[e.list]=[]);const t=e,i=t.url,a=t.ts,r=t.title||t.url,o=e.desc;this.curatedPageMap[e.list].push({url:i,ts:a,title:r,desc:o})}this.scrollToList()}static get styles(){return u(a.b`
    :host {
      width: 100%;
      height: 100%;
      display: flex;
...
(Service Workers are disabled in Firefox in Private Mode. If Using Private Mode in Firefox, try regular mode).
    ...
    `:""}`}onLoad(e){const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout(()=>t.location.reload(),100);if(this.reloadCount=0,t.customElements.get("replay-app-main"))return;const a=i.createElement("script");a.src=ct,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",dt)}();var ht=i(112),ft=i.n(ht),ut=i(246),bt=i.n(ut),pt=i(113),mt=i.n(pt),gt=i(247),vt=i.n(gt),wt=i(118),xt=i.n(wt),kt=i(248),yt=i.n(kt),St=i(114),$t=i.n(St),zt=i(222),_t=i.n(zt),Ct=i(49),Lt=i.n(Ct);i.d(t,"ArchiveWebApp",(function(){return Pt})),i.d(t,"Loader",(function(){return We})),i.d(t,"Embed",(function(){return dt}));class Pt extends E{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[]}get appName(){return"ArchiveWeb.page"}static get properties(){return{...E.properties,recordShown:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String}}}initRoute(){this.inited=!0;const e=new URLSearchParams(window.location.search);this.sourceUrl=e.get("source")||""}getLoadInfo(e){return{customColl:e.startsWith("local://")?e.slice("local://".length):e}}static get styles(){return u(Pt.appStyles)}static get appStyles(){return u(a.b`
      ...
      ${E.appStyles}
    `)}get mainLogo(){return _t.a}renderNavEnd(){return a.c`
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${b?"App":"Extension"} v${"0.4.10"}</div>
                    </div>
    ...
    </div>`}onClose(){this.dispatchEvent(new CustomEvent("modal-closed"))}}customElements.define("wr-modal",At),customElements.define("wr-rec-coll",class extends De{renderExtraToolbar(e=!1){return e?"":a.c`
    <a href="#" role="button"
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const a={},r={}},65:function(e,t,i){"use strict";i.d(t,"a",(function(){return s}));var a=i(8),r=i(4),o=i(9);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const n=new WeakMap,s=Object(o.d)(e=>t=>{if(!(t instanceof o.b))throw new Error("unsafeSVG can only be used in text bindings");const i=n.get(t);if(void 0!==i&&Object(r.h)(e)&&e===i.value&&t.value===i.fragment)return;const s=document.createElement("template");s.innerHTML=`<svg>${e}</svg>`;const l=s.content,c=l.firstChild;l.removeChild(c),Object(a.c)(l,c.firstChild);const d=document.importNode(l,!0);t.setValue(d),n.set(t,{value:e,fragment:d})})},66:function(e,t){e.exports='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path></svg>'},8:function(e,t,i){"use strict";i.d(t,"a",(function(){return a})),i.d(t,"c",(function(){return r})),i.d(t,"b",(function(){return o}));
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
