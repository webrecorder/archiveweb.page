...
const n=new WeakMap,s=Object(o.d)(e=>t=>{if(!(t instanceof o.a)||t instanceof o.c||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=t,{style:a}=i.element;let r=n.get(t);void 0===r&&(a.cssText=i.strings.join(" "),n.set(t,r=new Set)),r.forEach(t=>{t in e||(r.delete(t),-1===t.indexOf("-")?a[t]=null:a.removeProperty(t))});for(const t in e)r.add(t),-1===t.indexOf("-")?a[t]=e[t]:a.setProperty(t,e[t])});var l=i(264),c=i.n(l),d=i(202),h=i.n(d);const f=Object(a.d)(c.a);function u(e){return[f,e]}const p=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches;function b(e){" "==e.key&&(e.preventDefault(),e.target.click())}class m extends a.a{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return a.b`
    ...
    <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return a.c`
      ...
      <fa-icon .svg="${I.a}" aria-hidden="true"></fa-icon><span>&nbsp;User Docs</span>
    </a>
    <!--
...
const dt=new WeakMap,ht=Object(o.d)(e=>t=>{const i=dt.get(t);if(void 0===e&&t instanceof o.a){if(void 0!==i||!dt.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==i&&t.setValue(e);dt.set(t,e)});var ft=document.currentScript&&document.currentScript.src;class ut extends a.a{constructor(){super(),this.replaybase="./replay/",this.swName="sw.js",this.view="replay",this.ts="",this.url="",this.query="",this.config="",this.coll="",this.paramString=null,this.deepLink=!1,this.swInited=!1,this.embed=null,this.reloadCount=0,this.noSandbox=!1}static get properties(){return{url:{type:String},ts:{type:String},query:{type:String},source:{type:String},view:{type:String},embed:{type:String},replaybase:{type:String},swName:{type:String},title:{type:String},coll:{type:String},config:{type:String},swInited:{type:Boolean},paramString:{type:String},hashString:{type:String},deepLink:{type:Boolean},noSandbox:{type:Boolean},errorMessage:{type:String}}}async doRegister(){try{await S(this.swName,this.replaybase),this.swInited=!0}catch(e){this.errorMessage=e}}firstUpdated(){this.doRegister(),window.addEventListener("message",e=>{const t=this.renderRoot.querySelector("iframe");if(t&&e.source===t.contentWindow){if(e.data.title&&(this.title=e.data.title),!this.deepLink)return;const t=new URLSearchParams(e.data),i=new URL(window.location.href);i.hash="#"+t.toString(),window.history.replaceState({},"",i)}}),this.deepLink&&(this.updateFromHash(),window.addEventListener("hashchange",()=>this.updateFromHash()))}updateFromHash(){const e=new URLSearchParams(window.location.hash.slice(1));e.has("url")&&(this.url=e.get("url")),e.has("ts")&&(this.ts=e.get("ts")),e.has("query")&&(this.query=e.get("query")),e.has("view")&&(this.view=e.get("view"))}updated(e){if(e.has("url")||e.has("ts")||e.has("query")||e.has("view")||e.has("source")){this.embed=this.embed||"default";const e=new URL(this.source,document.baseURI);this.paramString=new URLSearchParams({source:e,customColl:this.coll,config:this.config,basePageUrl:window.location.href.split("#")[0],embed:this.embed}).toString(),this.hashString=new URLSearchParams({url:this.url,ts:this.ts,query:this.query,view:this.view}).toString()}}static get styles(){return u(a.b`
    ...
    <div class="info-bg">
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}),customElements.define("wr-rec-coll-info",Pt);customElements.define("wr-rec-coll-index",class extends K{constructor(){super(),this.deleteConfirm=null,this.ipfsSharePending=0}firstUpdated(){this.loadColls(),this._poll=setInterval(()=>{this.ipfsSharePending||this.loadColls()},1e4)}updated(e){super.updated(e),e.has("sortedColls")&&this.dispatchEvent(new CustomEvent("colls-updated",{detail:{colls:this.sortedColls}}))}static get properties(){return{...K.properties,deleteConfirm:{type:Object}}}renderCollInfo(e){return a.c`
    <wr-rec-coll-info
    ...
    </wr-modal>`:null}onIpfsShare(e){e.detail.pending?this.ipfsSharePending++:this.ipfsSharePending--}onDeleteColl(e){if(e.preventDefault(),e.stopPropagation(),!this.sortedColls)return;const t=Number(e.currentTarget.getAttribute("data-coll-index"));this.deleteConfirm=this.sortedColls[t]}async doDelete(){if(!this.deleteConfirm)return;this._deleting[this.deleteConfirm.sourceUrl]=!0,this.requestUpdate();const e=this.renderRoot.querySelector(`wr-rec-coll-info[data-coll="${this.deleteConfirm.id}"]`);e&&await e.doDelete(),this.deleteConfirm=null}renderEmpty(){return a.c`No Archives. Click "Create New" above to create a new archive and start recording!`}});var It=i(207),Lt=i.n(It);class At extends D{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[],this.autorun="1"===localStorage.getItem("autorunBehaviors")}get appName(){return"ArchiveWeb.page"}static get properties(){return{...D.properties,showStartRecord:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String},recordUrl:{type:String},autorun:{type:Boolean},showNew:{type:String},showImport:{type:Boolean}}}initRoute(){this.inited=!0;const e=new URLSearchParams(window.location.search);this.sourceUrl=e.get("source")||""}onStartLoad(e){this.showImport=!1,this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail}onCollLoaded(e){this.loadInfo=null,e.detail.sourceUrl&&e.detail.sourceUrl!==this.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl,this.pageParams.set("source",this.sourceUrl),window.location.search=this.pageParams.toString())}getLoadInfo(e){if(this.loadInfo)return this.loadInfo;return{customColl:e.startsWith("local://")?e.slice("local://".length):e}}static get styles(){return u(At.appStyles)}static get appStyles(){return u(a.b`
      :host {
        font-size: initial;
        overflow: auto;
      }
    ...
    <fa-icon .svg="${I.a}" aria-hidden="true"></fa-icon><span>&nbsp;User Guide</span>
